  ...
  chapters: [
    {
      ...
      exercises: [
        ...
        {
          id: 104, type: 'sort', title: 'Die sechs Stufen des Verkaufsplanungskonzepts (Abb. 1-2)',
          q: 'Bringen Sie die sechs Stufen des Verkaufsplanungskonzepts in die richtige Reihenfolge, von der ersten bis zur letzten.',
          items: ['Situationsanalyse (SWOT-Fazit)', 'Verkaufsziele', 'Verkaufsstrategie', 'Verkaufspläne (Aktionspläne)', 'Verkaufsbudget', 'Verkaufskontrolle'],
          tips: ['Am Anfang steht immer die Analyse: Erst wissen, wo man steht.', 'Ziele kommen vor der Strategie, denn die Strategie ist der Weg zum Ziel.', 'Das Budget entsteht erst, wenn die Massnahmen feststehen, denn erst dann sind die Kosten bekannt.', 'Die Kontrolle steht am Schluss, wird aber bereits zu Beginn geplant.'],
          reveal: [
            'Reihenfolge: Situationsanalyse, Verkaufsziele, Verkaufsstrategie, Verkaufspläne, Verkaufsbudget, Verkaufskontrolle.',
            'Warum diese Reihenfolge? Jede Stufe braucht das Ergebnis der vorherigen. Ohne SWOT-Fazit keine sinnvollen Ziele, ohne Ziele keine Strategie, ohne Massnahmen keine Kosten und damit kein Budget.',
            'Die Verkaufskontrolle steht formal am Schluss, wird aber aus den Zielen und Umsatzplänen abgeleitet. Das heisst: Was Sie in Stufe 2 nicht messbar formuliert haben, können Sie in Stufe 6 nicht kontrollieren.',
            'Prüfungstipp: Diese sechs Stufen sind das Gerüst für jede Fallstudienaufgabe zur Verkaufsplanung. Wer sie auswendig kann, hat immer eine Gliederung.'
          ]
        },
        {
          id: 105, type: 'match', title: 'Verkaufsplanungskonzept: Welche Stufe? (Abb. 1-3)',
          q: 'Ordnen Sie jedes Element der Stufe des Verkaufsplanungskonzepts zu, in der es bearbeitet wird.',
          pairs: [
            { l: 'Kernkompetenzen und Kundenstamm des eigenen Unternehmens', r: 'Situationsanalyse' },
            { l: 'Mitbewerber, Vertriebspartner und Markttrends', r: 'Situationsanalyse' },
            { l: 'Image, Kundenzufriedenheit und Servicequalität als Sollwerte', r: 'Verkaufsziele' },
            { l: 'Umsatz, Absatz und Deckungsbeitrag als Sollwerte', r: 'Verkaufsziele' },
            { l: 'Zielmarktstrategie: lokal, regional oder international ausrichten', r: 'Verkaufsstrategie' },
            { l: 'Festlegen, wie viele Kundenkontakte pro Periode nötig sind', r: 'Verkaufsstrategie' },
            { l: 'Reise- und Gliederungspläne für den Aussendienst', r: 'Verkaufspläne' },
            { l: 'Ausbildungs- und Motivationspläne für die Verkaufsmannschaft', r: 'Verkaufspläne' },
            { l: 'Spesen, Distribution und Kommunikationsmittel beziffern', r: 'Verkaufsbudget' },
            { l: 'Löhne, Sozialkosten und Fahrzeuge beziffern', r: 'Verkaufsbudget' },
            { l: 'Erreichte Kundenzufriedenheit mit dem Sollwert vergleichen', r: 'Verkaufskontrolle' },
            { l: 'Erreichten Deckungsbeitrag mit dem Sollwert vergleichen', r: 'Verkaufskontrolle' }
          ],
          options: ['Situationsanalyse', 'Verkaufsziele', 'Verkaufsstrategie', 'Verkaufspläne', 'Verkaufsbudget', 'Verkaufskontrolle'],
          tips: ['Achten Sie auf das Verb: analysieren, festlegen, planen, beziffern oder vergleichen.', 'Ziele nennen einen Sollwert, die Kontrolle vergleicht Ist und Soll. Dieselbe Kennzahl kann also in zwei Stufen vorkommen.', 'Das Budget beziffert Kosten in Franken, die Pläne legen die Massnahmen fest.', 'Auf jede Stufe entfallen genau zwei Elemente.'],
          reveal: [
            'Situationsanalyse: Interne Analyse (Organisation, Mitarbeitende, Finanzlage, Marktleistungen, Kernkompetenzen, Kundenstamm, Handelspartner, Logistik) und externe Analyse (Marktsystem, Mitbewerber, Vertriebspartner, externe Beeinflusser, Käufer und deren Bedürfnisse, Markttrends, Umweltfaktoren).',
            'Verkaufsziele: vorökonomisch und qualitativ (Image, Wissen, Einstellung, Verhalten, Kundenzufriedenheit, Servicequalität) sowie ökonomisch und quantitativ (Umsatz, Absatz, DB, Kosten, Gewinn). Die Hierarchieebene ist der Bereich.',
            'Verkaufsstrategie: die sechs Subvariablen. Produktselektion (was), Kundenselektion (wem), Feldgrösse (wo) sowie die Kontaktstrategie (wie) mit Kontaktqualität, Kontaktquantität, Kontaktperiodizität und der Berechnung des Personalbedarfs.',
            'Verkaufspläne: primär als Ressourcenplanung (Umsatz- und Einsatzpläne), sekundär als Infrastrukturplanung (Organisations-, Personal- und Verkaufshilfenpläne).',
            'Verkaufsbudget: Erlös sowie Vertriebs-, Personal- und Betriebskosten. Hier wird alles in Franken übersetzt.',
            'Verkaufskontrolle: vorökonomische und ökonomische Verkaufskennzahlen, abgeleitet von den Zielen und Umsatzplänen. Der Soll-Ist-Vergleich schliesst den Kreis zur zweiten Stufe.'
          ]
        },
        {
          id: 106, type: 'match', title: 'Primäre oder sekundäre Verkaufspläne? (Abb. 1-3)',
          q: 'Die Verkaufspläne teilen sich in primäre Pläne (Ressourcenplanung) und sekundäre Pläne (Infrastrukturplanung). Ordnen Sie jeden Planinhalt der richtigen Planart zu.',
          pairs: [
            { l: 'Umsatz nach Produkten, Regionen und Branchen aufteilen', r: 'Umsatzpläne' },
            { l: 'Umsatz nach Kundenklassen und Aussendienstgebieten aufteilen', r: 'Umsatzpläne' },
            { l: 'Reisepläne und Zeitpläne für den Aussendienst festlegen', r: 'Einsatzpläne' },
            { l: 'Gliederungs- und Verkaufsstufenpläne erstellen', r: 'Einsatzpläne' },
            { l: 'Aufbau- und Ablauforganisation des Verkaufs festlegen', r: 'Organisationspläne' },
            { l: 'Informationswesen gegen innen und aussen regeln', r: 'Organisationspläne' },
            { l: 'Selektion, Einführung und Ausbildung der Verkaufenden planen', r: 'Personalpläne' },
            { l: 'Motivation und Entlöhnung der Verkaufsmannschaft festlegen', r: 'Personalpläne' },
            { l: 'Präsentations- und Informationshilfsmittel bereitstellen', r: 'Verkaufshilfenpläne' },
            { l: 'Transportmittel und persönliche Hilfsmittel bereitstellen', r: 'Verkaufshilfenpläne' }
          ],
          options: ['Umsatzpläne', 'Einsatzpläne', 'Organisationspläne', 'Personalpläne', 'Verkaufshilfenpläne'],
          tips: ['Primäre Verkaufspläne sind Ressourcenplanung: Umsatzpläne und Einsatzpläne. Sie beantworten, wer wann wie viel verkaufen soll.', 'Sekundäre Verkaufspläne sind Infrastrukturplanung: Organisations-, Personal- und Verkaufshilfenpläne. Sie schaffen die Voraussetzungen dafür.', 'Umsatzpläne teilen eine Zahl auf (nach Produkten, Kunden, Gebieten), Einsatzpläne teilen Zeit und Wege ein.', 'Auf jede Planart entfallen genau zwei Inhalte.'],
          reveal: [
            'Umsatzpläne (primär): Der Gesamtumsatz wird heruntergebrochen auf Produkte, Kunden und Kundenklassen, Aussendienstgebiete, Regionen, Zeiteinheiten und Branchen. So wird aus einer Jahreszahl eine Vorgabe pro Person und Monat.',
            'Einsatzpläne (primär): Gliederungspläne, Zeitpläne, Reisepläne und Verkaufsstufenpläne. Sie regeln, wer wann wo im Einsatz ist.',
            'Organisationspläne (sekundär): Aufbauorganisation, Ablauforganisation und Informationswesen gegen innen und aussen.',
            'Personalpläne (sekundär): Selektionspläne, Einführungspläne, Motivationspläne mit der Entlöhnung sowie Ausbildungspläne.',
            'Verkaufshilfenpläne (sekundär): Präsentationshilfsmittel, Informationshilfsmittel, Transporthilfsmittel und persönliche Hilfsmittel.',
            'Merkhilfe für die Prüfung: Primär ist, was direkt Umsatz erzeugt (verkaufen und unterwegs sein). Sekundär ist, was das Verkaufen erst möglich macht (Struktur, Personal, Hilfsmittel).'
          ]
        },
        {
          id: 107, type: 'match', title: 'Verkaufsbudget: Welche Position? (Abb. 1-3)',
          q: 'Das Verkaufsbudget besteht aus dem Erlös und drei Kostenblöcken. Ordnen Sie jede Position dem richtigen Block zu.',
          pairs: [
            { l: 'Wird aus den Verkaufszielen und den Umsatzplänen abgeleitet', r: 'Erlös' },
            { l: 'Kosten für Kommunikation und Verkaufsförderung', r: 'Vertriebskosten' },
            { l: 'Spesen der Aussendienstmitarbeitenden', r: 'Vertriebskosten' },
            { l: 'Kosten der Distribution und der Verkaufshilfsmittel', r: 'Vertriebskosten' },
            { l: 'Löhne und Gehälter der Verkaufsmannschaft', r: 'Personalkosten' },
            { l: 'Sozialkosten und Firmenfahrzeuge', r: 'Personalkosten' },
            { l: 'Miete und Energie der Verkaufsräume', r: 'Betriebskosten' },
            { l: 'Einrichtung, Verwaltung und Zinsen', r: 'Betriebskosten' }
          ],
          options: ['Erlös', 'Vertriebskosten', 'Personalkosten', 'Betriebskosten'],
          tips: ['Der Erlös ist die einzige Position, die Geld einbringt. Alles andere sind Kosten.', 'Vertriebskosten entstehen durch das Verkaufen selbst: Kommunikation, Spesen, Distribution, Hilfsmittel.', 'Personalkosten hängen an den Menschen: Löhne, Sozialkosten, Fahrzeuge.', 'Betriebskosten fallen unabhängig vom einzelnen Verkaufsvorgang an: Einrichtung, Energie, Miete, Verwaltung, Zinsen.'],
          reveal: [
            'Erlös: abgeleitet von den Zielen und Umsatzplänen. Er ist der Gegenwert, an dem sich die drei Kostenblöcke messen lassen müssen.',
            'Vertriebskosten: Kommunikation, Spesen, Distribution und Hilfsmittel. Diese Kosten steigen tendenziell mit der Verkaufsaktivität.',
            'Personalkosten: Löhne und Gehälter, Sozialkosten und Fahrzeuge. In personalintensiven Verkaufsorganisationen ist das der grösste Block.',
            'Betriebskosten: Einrichtung, Energie, Miete, Verwaltung und Zinsen. Sie fallen weitgehend unabhängig von der Verkaufsmenge an und sind damit fix.',
            'Prüfungstipp: Achten Sie auf die Abgrenzung Fahrzeuge gegen Distribution. Das Firmenauto der Verkaufenden gehört zu den Personalkosten, der Warentransport zum Kunden zu den Vertriebskosten.'
          ]
        }
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Aufbau des Verkaufsplanungskonzepts (Abb. 1-2)',
            svg: '<svg viewBox="0 0 760 600" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="v" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0 L8 4 L0 8 Z" fill="#3730a3"/></marker></defs><rect x="8" y="18" width="744" height="96" fill="#eef2ff"/><text x="16" y="36" fill="#3730a3" font-size="10" font-weight="600">1. Analyse der</text><text x="16" y="48" fill="#3730a3" font-size="10" font-weight="600">Ausgangslage</text><rect x="210" y="26" width="210" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="315" y="44" text-anchor="middle" fill="#1e1b4b" font-size="11" font-weight="bold">Vorgaben Unternehmen</text><rect x="450" y="26" width="210" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="555" y="44" text-anchor="middle" fill="#1e1b4b" font-size="11" font-weight="bold">Marktanalyse</text><line x1="315" y1="54" x2="315" y2="68" stroke="#3730a3" stroke-width="1.3"/><line x1="555" y1="54" x2="555" y2="68" stroke="#3730a3" stroke-width="1.3"/><line x1="315" y1="68" x2="555" y2="68" stroke="#3730a3" stroke-width="1.3"/><line x1="440" y1="68" x2="440" y2="80" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><rect x="345" y="80" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="440" y="98" text-anchor="middle" fill="#1e1b4b" font-size="10" font-weight="bold">SWOT-Fazit</text><text x="16" y="132" fill="#3730a3" font-size="10" font-weight="600">2. Definition der Ziele</text><line x1="440" y1="108" x2="440" y2="124" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><rect x="345" y="124" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="440" y="142" text-anchor="middle" fill="#1e1b4b" font-size="11" font-weight="bold">Verkaufsziele</text><line x1="440" y1="152" x2="440" y2="166" stroke="#3730a3" stroke-width="1.3"/><line x1="255" y1="166" x2="625" y2="166" stroke="#3730a3" stroke-width="1.3"/><line x1="255" y1="166" x2="255" y2="180" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><line x1="625" y1="166" x2="625" y2="180" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><rect x="150" y="180" width="210" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="255" y="198" text-anchor="middle" fill="#1e1b4b" font-size="10">Vorökonomisch (qualitativ)</text><rect x="520" y="180" width="210" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="625" y="198" text-anchor="middle" fill="#1e1b4b" font-size="10">Ökonomisch (quantitativ)</text><rect x="8" y="222" width="744" height="140" fill="#eef2ff"/><text x="16" y="240" fill="#3730a3" font-size="10" font-weight="600">3. Entwicklung</text><text x="16" y="252" fill="#3730a3" font-size="10" font-weight="600">der Strategien</text><line x1="255" y1="208" x2="255" y2="216" stroke="#3730a3" stroke-width="1.3"/><line x1="625" y1="208" x2="625" y2="216" stroke="#3730a3" stroke-width="1.3"/><line x1="255" y1="216" x2="625" y2="216" stroke="#3730a3" stroke-width="1.3"/><line x1="440" y1="216" x2="440" y2="230" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><rect x="345" y="230" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="440" y="248" text-anchor="middle" fill="#1e1b4b" font-size="11" font-weight="bold">Verkaufsstrategie</text><line x1="440" y1="258" x2="440" y2="268" stroke="#3730a3" stroke-width="1.3"/><rect x="150" y="274" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="159" y="293" fill="#1e1b4b" font-size="11" font-weight="bold">①</text><text x="176" y="293" fill="#1e1b4b" font-size="9.5">Produktselektion – was</text><rect x="348" y="274" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="357" y="293" fill="#1e1b4b" font-size="11" font-weight="bold">②</text><text x="374" y="293" fill="#1e1b4b" font-size="9.5">Kundenselektion – wem</text><rect x="546" y="274" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="555" y="293" fill="#1e1b4b" font-size="11" font-weight="bold">③</text><text x="572" y="293" fill="#1e1b4b" font-size="9.5">Feldgrösse – wo</text><rect x="150" y="308" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="159" y="327" fill="#1e1b4b" font-size="11" font-weight="bold">④</text><text x="176" y="327" fill="#1e1b4b" font-size="9.5">Kontaktqualität – wie</text><rect x="348" y="308" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="357" y="327" fill="#1e1b4b" font-size="11" font-weight="bold">⑤</text><text x="374" y="327" fill="#1e1b4b" font-size="9.5">Kontaktquantität – wie viel</text><rect x="546" y="308" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="555" y="327" fill="#1e1b4b" font-size="11" font-weight="bold">⑥</text><text x="572" y="327" fill="#1e1b4b" font-size="9.5">Kontaktperiodizität – wann</text><line x1="245" y1="268" x2="635" y2="268" stroke="#3730a3" stroke-width="1.3"/><line x1="245" y1="268" x2="245" y2="274" stroke="#3730a3" stroke-width="1.3"/><line x1="635" y1="268" x2="635" y2="274" stroke="#3730a3" stroke-width="1.3"/><text x="16" y="378" fill="#3730a3" font-size="10" font-weight="600">4. Erarbeitung der</text><text x="16" y="390" fill="#3730a3" font-size="10" font-weight="600">Aktionspläne</text><line x1="440" y1="336" x2="440" y2="348" stroke="#3730a3" stroke-width="1.3"/><line x1="265" y1="348" x2="615" y2="348" stroke="#3730a3" stroke-width="1.3"/><line x1="265" y1="348" x2="265" y2="362" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><line x1="615" y1="348" x2="615" y2="362" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><rect x="160" y="362" width="210" height="34" rx="3" fill="#a5b4fc" stroke="#3730a3" stroke-width="1.4"/><text x="265" y="376.5" text-anchor="middle" fill="#1e1b4b" font-size="10" font-weight="bold">Primäre Verkaufspläne</text><text x="265" y="389.5" text-anchor="middle" fill="#1e1b4b" font-size="10" font-weight="bold">(Ressourcenplanung)</text><rect x="160" y="396" width="210" height="44" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.4"/><text x="170" y="415" fill="#1e1b4b" font-size="10">• Umsatz / Absatz</text><text x="170" y="430" fill="#1e1b4b" font-size="10">• Einsatz-/Gliederungsplan</text><rect x="510" y="362" width="210" height="34" rx="3" fill="#a5b4fc" stroke="#3730a3" stroke-width="1.4"/><text x="615" y="376.5" text-anchor="middle" fill="#1e1b4b" font-size="10" font-weight="bold">Sekundäre Verkaufspläne</text><text x="615" y="389.5" text-anchor="middle" fill="#1e1b4b" font-size="10" font-weight="bold">(Infrastrukturplanung)</text><rect x="510" y="396" width="210" height="59" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.4"/><text x="520" y="415" fill="#1e1b4b" font-size="10">• Organisation</text><text x="520" y="430" fill="#1e1b4b" font-size="10">• Motivation / Löhne</text><text x="520" y="445" fill="#1e1b4b" font-size="10">• Verkaufshilfen</text><rect x="8" y="470" width="744" height="52" fill="#eef2ff"/><text x="16" y="492" fill="#3730a3" font-size="10" font-weight="600">5. Zusammenstellung</text><text x="16" y="504" fill="#3730a3" font-size="10" font-weight="600">des Budgets</text><line x1="265" y1="441" x2="265" y2="462" stroke="#3730a3" stroke-width="1.3"/><line x1="615" y1="459" x2="615" y2="462" stroke="#3730a3" stroke-width="1.3"/><line x1="265" y1="462" x2="615" y2="462" stroke="#3730a3" stroke-width="1.3"/><line x1="440" y1="462" x2="440" y2="478" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><rect x="345" y="478" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="440" y="496" text-anchor="middle" fill="#1e1b4b" font-size="11" font-weight="bold">Verkaufsbudget</text><text x="16" y="546" fill="#3730a3" font-size="10" font-weight="600">6. Erarbeitung</text><text x="16" y="558" fill="#3730a3" font-size="10" font-weight="600">der Kontrollpläne</text><line x1="440" y1="506" x2="440" y2="532" stroke="#3730a3" stroke-width="1.3" marker-end="url(#v)"/><rect x="345" y="532" width="190" height="28" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.4"/><text x="440" y="550" text-anchor="middle" fill="#1e1b4b" font-size="11" font-weight="bold">Verkaufskontrolle</text></svg>'
          },
          {
            type: 'svg',
            title: 'Verkaufsplanungskonzept im Detail (Abb. 1-3)',
            svg: '<svg viewBox="0 0 900 1017" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><rect x="14" y="10" width="872" height="139" rx="5" fill="none" stroke="#3730a3" stroke-width="1.6"/><rect x="14" y="10" width="872" height="0" rx="3" fill="none" stroke="#3730a3" stroke-width="1.3"/><rect x="24" y="20" width="852" height="24" rx="3" fill="#818cf8" stroke="#3730a3" stroke-width="1.3"/><text x="450" y="36" text-anchor="middle" fill="#ffffff" font-size="11" font-weight="bold">Situationsanalyse (Ist-Situation als Grundlage jedes Konzepts)</text><rect x="24" y="50" width="420" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="234" y="65" text-anchor="middle" fill="#1e1b4b" font-size="10">Interne Analyse (Stärken und Schwächen)</text><rect x="456" y="50" width="420" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="666" y="65" text-anchor="middle" fill="#1e1b4b" font-size="10">Externe Analyse (Chancen und Risiken)</text><rect x="24" y="72" width="420" height="67" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="32" y="85" text-anchor="start" fill="#1e1b4b" font-size="9.5">Eigenes Unternehmen:</text><text x="32" y="98" text-anchor="start" fill="#1e1b4b" font-size="9.5">z.B. Organisation, Mitarbeitende, Finanzlage,</text><text x="32" y="111" text-anchor="start" fill="#1e1b4b" font-size="9.5">Marktleistungen, Kernkompetenzen, Kundenstamm,</text><text x="32" y="124" text-anchor="start" fill="#1e1b4b" font-size="9.5">Handelspartner, Logistik etc.</text><rect x="456" y="72" width="420" height="67" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="464" y="85" text-anchor="start" fill="#1e1b4b" font-size="9.5">Umfeld:</text><text x="464" y="98" text-anchor="start" fill="#1e1b4b" font-size="9.5">Marktsystem, Mitbewerber, Vertriebspartner,</text><text x="464" y="111" text-anchor="start" fill="#1e1b4b" font-size="9.5">externe Beeinflusser, Käufer und deren Bedürfnisse,</text><text x="464" y="124" text-anchor="start" fill="#1e1b4b" font-size="9.5">Markttrends sowie Umweltfaktoren etc.</text><rect x="24" y="171" width="852" height="24" rx="3" fill="#818cf8" stroke="#3730a3" stroke-width="1.3"/><text x="450" y="187" text-anchor="middle" fill="#ffffff" font-size="11" font-weight="bold">Verkaufsziele (Definition der Verkaufsziele, Hierarchieebene «Bereich»)</text><rect x="24" y="201" width="420" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="234" y="216" text-anchor="middle" fill="#1e1b4b" font-size="10">Vorökonomische / qualitative Verkaufsziele</text><rect x="456" y="201" width="420" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="666" y="216" text-anchor="middle" fill="#1e1b4b" font-size="10">Ökonomische / quantitative Verkaufsziele</text><rect x="24" y="223" width="420" height="41" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="32" y="236" text-anchor="start" fill="#1e1b4b" font-size="9.5">Beispiele: Image, Wissen, Einstellung, Verhalten,</text><text x="32" y="249" text-anchor="start" fill="#1e1b4b" font-size="9.5">Kundenzufriedenheit, Servicequalität usw.</text><rect x="456" y="223" width="420" height="28" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="464" y="236" text-anchor="start" fill="#1e1b4b" font-size="9.5">Beispiele: Umsatz, Absatz, DB, Kosten, Gewinn usw.</text><rect x="14" y="161" width="872" height="113" rx="5" fill="none" stroke="#3730a3" stroke-width="1.6"/><rect x="24" y="296" width="852" height="24" rx="3" fill="#818cf8" stroke="#3730a3" stroke-width="1.3"/><text x="450" y="312" text-anchor="middle" fill="#ffffff" font-size="11" font-weight="bold">Verkaufsstrategie Strategiedefinition – die 6 Subvariablen der Verkaufsstrategie</text><rect x="24" y="326" width="205.5" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="126.75" y="341" text-anchor="middle" fill="#1e1b4b" font-size="10">Produktselektion  ①</text><rect x="24" y="348" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="32" y="361" text-anchor="start" fill="#1e1b4b" font-size="9.5" font-weight="bold">Was: Teilmarktstrategie –</text><text x="32" y="374" text-anchor="start" fill="#1e1b4b" font-size="9.5">Produkt und / oder</text><text x="32" y="387" text-anchor="start" fill="#1e1b4b" font-size="9.5">Sortimentsstrategie</text><rect x="24" y="402" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="32" y="415" text-anchor="start" fill="#1e1b4b" font-size="9.5">Schwerpunkte im</text><text x="32" y="428" text-anchor="start" fill="#1e1b4b" font-size="9.5">Leistungsmix (Produkt</text><text x="32" y="441" text-anchor="start" fill="#1e1b4b" font-size="9.5">und / oder Dienstleistung)</text><rect x="239.5" y="326" width="205.5" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="342.25" y="341" text-anchor="middle" fill="#1e1b4b" font-size="10">Kundenselektion  ②</text><rect x="239.5" y="348" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="247.5" y="361" text-anchor="start" fill="#1e1b4b" font-size="9.5" font-weight="bold">Wem: Marktsegment-</text><text x="247.5" y="374" text-anchor="start" fill="#1e1b4b" font-size="9.5">strategie – Zielsegment-/</text><text x="247.5" y="387" text-anchor="start" fill="#1e1b4b" font-size="9.5">Zielgruppenstrategie</text><rect x="239.5" y="402" width="205.5" height="67" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="247.5" y="415" text-anchor="start" fill="#1e1b4b" font-size="9.5">•</text><text x="257.5" y="415" text-anchor="start" fill="#1e1b4b" font-size="9.5">Firmenkunden (B2B)</text><text x="247.5" y="428" text-anchor="start" fill="#1e1b4b" font-size="9.5">•</text><text x="257.5" y="428" text-anchor="start" fill="#1e1b4b" font-size="9.5">Privatkunden</text><text x="257.5" y="441" text-anchor="start" fill="#1e1b4b" font-size="9.5">(B2C / D2C*)</text><text x="247.5" y="454" text-anchor="start" fill="#1e1b4b" font-size="9.5">•</text><text x="257.5" y="454" text-anchor="start" fill="#1e1b4b" font-size="9.5">Kundensegmentation</text><rect x="455" y="326" width="205.5" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="557.75" y="341" text-anchor="middle" fill="#1e1b4b" font-size="10">Feldgrösse  ③</text><rect x="455" y="348" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="463" y="361" text-anchor="start" fill="#1e1b4b" font-size="9.5" font-weight="bold">Wo: Zielmarktstrategie –</text><text x="463" y="374" text-anchor="start" fill="#1e1b4b" font-size="9.5">geografischer Zielmarkt</text><text x="463" y="387" text-anchor="start" fill="#1e1b4b" font-size="9.5"></text><rect x="455" y="402" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="463" y="415" text-anchor="start" fill="#1e1b4b" font-size="9.5">Ausrichtung lokal,</text><text x="463" y="428" text-anchor="start" fill="#1e1b4b" font-size="9.5">regional, national,</text><text x="463" y="441" text-anchor="start" fill="#1e1b4b" font-size="9.5">international, global</text><rect x="670.5" y="326" width="205.5" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="773.25" y="341" text-anchor="middle" fill="#1e1b4b" font-size="10">Kontaktstrategie</text><rect x="670.5" y="348" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="678.5" y="361" text-anchor="start" fill="#1e1b4b" font-size="9.5" font-weight="bold">Wie: Kontaktstrategie –</text><text x="678.5" y="374" text-anchor="start" fill="#1e1b4b" font-size="9.5">Art und Menge der</text><text x="678.5" y="387" text-anchor="start" fill="#1e1b4b" font-size="9.5">Verkaufskontakte</text><rect x="670.5" y="402" width="205.5" height="67" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="678.5" y="415" text-anchor="start" fill="#1e1b4b" font-size="9.5">•</text><text x="688.5" y="415" text-anchor="start" fill="#1e1b4b" font-size="9.5">Kontaktqualität   ④</text><text x="678.5" y="428" text-anchor="start" fill="#1e1b4b" font-size="9.5">•</text><text x="688.5" y="428" text-anchor="start" fill="#1e1b4b" font-size="9.5">Kontaktquantität   ⑤</text><text x="678.5" y="441" text-anchor="start" fill="#1e1b4b" font-size="9.5">•</text><text x="688.5" y="441" text-anchor="start" fill="#1e1b4b" font-size="9.5">Kontaktperiodizität   ⑥</text><text x="678.5" y="454" text-anchor="start" fill="#1e1b4b" font-size="9.5">•</text><text x="688.5" y="454" text-anchor="start" fill="#1e1b4b" font-size="9.5">Berechnung Personal</text><rect x="14" y="286" width="872" height="193" rx="5" fill="none" stroke="#3730a3" stroke-width="1.6"/><rect x="24" y="501" width="852" height="24" rx="3" fill="#818cf8" stroke="#3730a3" stroke-width="1.3"/><text x="450" y="517" text-anchor="middle" fill="#ffffff" font-size="11" font-weight="bold">Verkaufspläne (Planung der Ressourcen und der Infrastruktur)</text><rect x="24" y="531" width="420" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="234" y="546" text-anchor="middle" fill="#1e1b4b" font-size="10">Primäre Verkaufspläne (Ressourcenplanung)</text><rect x="456" y="531" width="420" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="666" y="546" text-anchor="middle" fill="#1e1b4b" font-size="10">Sekundäre Verkaufspläne (Infrastrukturplanung)</text><rect x="24" y="559" width="164" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="106" y="574" text-anchor="middle" fill="#1e1b4b" font-size="9.5">Umsatzpläne</text><rect x="24" y="581" width="164" height="93" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="32" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="42" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">Produkte</text><text x="32" y="607" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="42" y="607" text-anchor="start" fill="#1e1b4b" font-size="9">Kunden / K-Klassen</text><text x="32" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="42" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">AD-Gebiete</text><text x="32" y="633" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="42" y="633" text-anchor="start" fill="#1e1b4b" font-size="9">Regionen</text><text x="32" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="42" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">Zeiteinheiten</text><text x="32" y="659" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="42" y="659" text-anchor="start" fill="#1e1b4b" font-size="9">Branchen</text><rect x="196" y="559" width="164" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="278" y="574" text-anchor="middle" fill="#1e1b4b" font-size="9.5">Einsatzpläne</text><rect x="196" y="581" width="164" height="80" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="204" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="214" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">Gliederungspläne</text><text x="204" y="607" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="214" y="607" text-anchor="start" fill="#1e1b4b" font-size="9">Zeitpläne</text><text x="204" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="214" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">Reisepläne</text><text x="204" y="633" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="214" y="633" text-anchor="start" fill="#1e1b4b" font-size="9">Verkaufsstufen-</text><text x="214" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">pläne</text><rect x="368" y="559" width="164" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="450" y="574" text-anchor="middle" fill="#1e1b4b" font-size="9.5">Organisationspläne</text><rect x="368" y="581" width="164" height="106" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="376" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="386" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">Aufbau-</text><text x="386" y="607" text-anchor="start" fill="#1e1b4b" font-size="9">organisation</text><text x="376" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="386" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">Ablauf-</text><text x="386" y="633" text-anchor="start" fill="#1e1b4b" font-size="9">organisation</text><text x="376" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="386" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">Informations-</text><text x="386" y="659" text-anchor="start" fill="#1e1b4b" font-size="9">wesen gegen</text><text x="386" y="672" text-anchor="start" fill="#1e1b4b" font-size="9">innen und aussen</text><rect x="540" y="559" width="164" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="622" y="574" text-anchor="middle" fill="#1e1b4b" font-size="9.5">Personalpläne</text><rect x="540" y="581" width="164" height="93" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="548" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="558" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">Selektionspläne</text><text x="548" y="607" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="558" y="607" text-anchor="start" fill="#1e1b4b" font-size="9">Einführungspläne</text><text x="548" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="558" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">Motivationspläne</text><text x="558" y="633" text-anchor="start" fill="#1e1b4b" font-size="9">(Entlöhnung)</text><text x="548" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="558" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">Ausbildungs-</text><text x="558" y="659" text-anchor="start" fill="#1e1b4b" font-size="9">pläne</text><rect x="712" y="559" width="164" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="794" y="574" text-anchor="middle" fill="#1e1b4b" font-size="9.5">Verkaufshilfenpläne</text><rect x="712" y="581" width="164" height="119" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="720" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="730" y="594" text-anchor="start" fill="#1e1b4b" font-size="9">Präsentations-</text><text x="730" y="607" text-anchor="start" fill="#1e1b4b" font-size="9">hilfsmittel</text><text x="720" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="730" y="620" text-anchor="start" fill="#1e1b4b" font-size="9">Informations-</text><text x="730" y="633" text-anchor="start" fill="#1e1b4b" font-size="9">hilfsmittel</text><text x="720" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="730" y="646" text-anchor="start" fill="#1e1b4b" font-size="9">Transport-</text><text x="730" y="659" text-anchor="start" fill="#1e1b4b" font-size="9">hilfsmittel</text><text x="720" y="672" text-anchor="start" fill="#1e1b4b" font-size="9">•</text><text x="730" y="672" text-anchor="start" fill="#1e1b4b" font-size="9">Persönliche</text><text x="730" y="685" text-anchor="start" fill="#1e1b4b" font-size="9">Hilfsmittel</text><rect x="14" y="491" width="872" height="219" rx="5" fill="none" stroke="#3730a3" stroke-width="1.6"/><rect x="24" y="732" width="852" height="24" rx="3" fill="#818cf8" stroke="#3730a3" stroke-width="1.3"/><text x="450" y="748" text-anchor="middle" fill="#ffffff" font-size="11" font-weight="bold">Verkaufsbudget (Planung der Kosten)</text><rect x="24" y="762" width="205.5" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="126.75" y="777" text-anchor="middle" fill="#1e1b4b" font-size="10">Erlös</text><rect x="24" y="784" width="205.5" height="41" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="32" y="797" text-anchor="start" fill="#1e1b4b" font-size="9.5">Abgeleitet von Zielen</text><text x="32" y="810" text-anchor="start" fill="#1e1b4b" font-size="9.5">und Umsatzplänen</text><rect x="239.5" y="762" width="205.5" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="342.25" y="777" text-anchor="middle" fill="#1e1b4b" font-size="10">Vertriebskosten</text><rect x="239.5" y="784" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="247.5" y="797" text-anchor="start" fill="#1e1b4b" font-size="9.5">Kommunikation, Spesen,</text><text x="247.5" y="810" text-anchor="start" fill="#1e1b4b" font-size="9.5">Distribution, Hilfsmittel</text><text x="247.5" y="823" text-anchor="start" fill="#1e1b4b" font-size="9.5">usw.</text><rect x="455" y="762" width="205.5" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="557.75" y="777" text-anchor="middle" fill="#1e1b4b" font-size="10">Personalkosten</text><rect x="455" y="784" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="463" y="797" text-anchor="start" fill="#1e1b4b" font-size="9.5">Löhne und Gehälter,</text><text x="463" y="810" text-anchor="start" fill="#1e1b4b" font-size="9.5">Sozialkosten, Fahrzeuge</text><text x="463" y="823" text-anchor="start" fill="#1e1b4b" font-size="9.5">usw.</text><rect x="670.5" y="762" width="205.5" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="773.25" y="777" text-anchor="middle" fill="#1e1b4b" font-size="10">Betriebskosten</text><rect x="670.5" y="784" width="205.5" height="54" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="678.5" y="797" text-anchor="start" fill="#1e1b4b" font-size="9.5">Einrichtung, Energie,</text><text x="678.5" y="810" text-anchor="start" fill="#1e1b4b" font-size="9.5">Miete, Verwaltung,</text><text x="678.5" y="823" text-anchor="start" fill="#1e1b4b" font-size="9.5">Zinsen usw.</text><rect x="14" y="722" width="872" height="126" rx="5" fill="none" stroke="#3730a3" stroke-width="1.6"/><rect x="24" y="870" width="852" height="24" rx="3" fill="#818cf8" stroke="#3730a3" stroke-width="1.3"/><text x="450" y="886" text-anchor="middle" fill="#ffffff" font-size="11" font-weight="bold">Verkaufskontrolle (Kontrollplanung – abgeleitet von den Zielen und Umsatzplänen)</text><rect x="24" y="900" width="420" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="234" y="915" text-anchor="middle" fill="#1e1b4b" font-size="10">Vorökonomische Verkaufskennzahlen</text><rect x="456" y="900" width="420" height="22" rx="3" fill="#c7d2fe" stroke="#3730a3" stroke-width="1.3"/><text x="666" y="915" text-anchor="middle" fill="#1e1b4b" font-size="10">Ökonomische Verkaufskennzahlen</text><rect x="24" y="922" width="420" height="41" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="32" y="935" text-anchor="start" fill="#1e1b4b" font-size="9.5">Zum Beispiel Image, Wissen, Einstellung, Verhalten,</text><text x="32" y="948" text-anchor="start" fill="#1e1b4b" font-size="9.5">Kundenzufriedenheit, Servicequalität usw.</text><rect x="456" y="922" width="420" height="28" rx="3" fill="#ffffff" stroke="#3730a3" stroke-width="1.3"/><text x="464" y="935" text-anchor="start" fill="#1e1b4b" font-size="9.5">Zum Beispiel Umsatz, Absatz, DB, Kosten, Gewinn usw.</text><rect x="14" y="860" width="872" height="113" rx="5" fill="none" stroke="#3730a3" stroke-width="1.6"/><text x="14" y="995" text-anchor="start" fill="#4338ca" font-size="8">* D2C steht für Direct-to-Customer oder Direct-to-Consumer: Der Produzent verkauft ohne Vermittlung an die Endkundschaft,</text><text x="14" y="1006" text-anchor="start" fill="#4338ca" font-size="8">  zum Beispiel über den eigenen Onlineshop.</text></svg>'
          },
          {
            type: 'concept',
        ...
        sections: [
          ...
          },
          {
            ...
            terms: [
              ...
              {term: 'Streuplanung', def: 'Räumliche Verteilung der Verkaufs-Operationsräume auf die einzelnen Verkäufer nach Art, Anzahl und Ort der zu betreuenden Kontakte (Streu- oder Gliederungsplanung, S. 73).'}
            ]
          }
        ]
      }
        ...
        sections: [
          ...
          },
          {
            ...
            terms: [
              ...
              {term: 'Motivation', def: 'Die Gesamtheit der Beweggründe und Einflüsse, die eine Entscheidung, Handlung oder Ähnliches beeinflussen oder anregen (S. 116). Umfasst intrinsische und extrinsische Faktoren.'},
          ...
          generator: function() {
            ...
            return {
              ...
              fields: [
                ...
                {label: 'S1 L: Endkonsumentenpreis (CHF)', answer: pL, tolerance: 1},
                {label: 'S1 L: Deckungsbeitrag (CHF)', answer: dbL, tolerance: 1}
              ],
              reveal: [
          ...
          generator: function() {
            ...
            return {
              ...
              fields: [
                ...
                {label: 'S1 S: DB KLAFS (CHF)', answer: dbS, tolerance: 1},
                {label: 'S1 L: Herstellerpreis (CHF)', answer: hL, tolerance: 1},
                {label: 'S1 L: Endkonsumentenpreis (CHF)', answer: eL, tolerance: 1},
        ...
        sections: [
          ...
          },
          {
            ...
            terms: [
              ...
              {term: 'Sandwichtechnik', def: 'Technik, um eine unangenehme (negative) Botschaft «wie ein Sandwich» zu verpacken. Ablauf: einleuchtender Vorteil, gute Idee, die eigentliche negative Botschaft, dann ein Vorteil bzw. eine positive Idee (Abb. 9-5, S. 176). Nicht auf den Preis beschränkt.'},
