    ...
    // ============================================================
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          keywords: ['gesamten','Nettörfolg','variablen','Deckungsbeitrag','Selbstkosten','vollen'],
          solution: 'Vollkostenrechnung: die gesamten (vollen) Kosten \u2192 Ergebnis: Nettörfolg (Selbstkosten) pro Kostentr\u00e4ger.\nTeilkostenrechnung: die variablen Kosten \u2192 Ergebnis: Deckungsbeitrag pro Kostentr\u00e4ger.',
          tips: [], reveal: []
        },
        {
          id: 114, type: 'text',
        ...
        {
          id: 123, type: 'text',
          title: 'Nettörfolg vs. Deckungsbeitrag',
      ...
      exercises: [
        ...
        },
        {
          ...
          pairs: [
            ...
            { l: '3: Herstellkosten', r: 'F: = Materialkosten + Fertigungskosten.' },
            { l: '4: Handelsmarge in %', r: 'B: Bruttogewinn in Prozenten des Warenertrags (oder: Nettörls).' },
        ...
        },
        {
          ...
          keywords: ['Nettobarerls','Nettörl\u00f6s','Nettoverkauf'],
          solution: 'Nettobarerls (oder: Nettörl\u00f6s).',
          tips: [], reveal: []
        },
        {
        ...
        {
          id: 134, type: 'text', title: 'Nettörl\u00f6s \u2013 Handelsmarge',
          q: '\u00abNettörl\u00f6s \u2013 Handelsmarge.\u00bb Was wird umschrieben? (Stichwort.)',
          keywords: ['Einstand','Warenaufwand','Wareneinsatz'],
          solution: 'Einstand (Warenaufwand, Wareneinsatz).',
          tips: [], reveal: []
        },
        {
          id: 135, type: 'text', title: 'Nettörl\u00f6s \u2013 Reingewinnzuschlag',
          q: '\u00abNettörl\u00f6s \u2013 kalkulatorischer Gewinnzuschlag.\u00bb Was wird umschrieben? (Stichwort.)',
        ...
        },
        {
          ...
          keywords: ['aufbaünd','unten','Einstand','Nettörls','aufbaünd','oben'],
      ...
      learningData: {
        sections: [
          ...
          { type: 'keyterms', title: 'Schlüsselbegriffe', terms: [
            ...
            { term: 'Verkaufskalkulation', def: 'Ermittlung des Bruttoverkaufspreises ausgehend vom Nettörlös über Verkaufssonderkosten, Rabatte und Skonti.' },
          ...
          { type: 'summary', title: 'Zusammenfassung', items: [
            ...
            'Verkaufskalkulation: [Nettörlös] + Verkaufssonderkosten + Skonto + Rabatt = Bruttokreditverkauf.',
    ...
    // ============================================================
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          keywords: ['Absatz','Werte','Totalkosten','Nettörls','Fixkosten','Variable','Gewinn','Verlust','Nutzschwelle'],
          solution: 'X-Achse: Absatz (Verkaufsmenge). Y-Achse: Werte (Erl\u00f6s, Kosten, DB). Linien: Nettörls, Totalkosten (Selbstkosten), Fixkosten, Variable Kosten. Schnittpunkt Erls/Totalkosten = Break-even-Punkt (Nutzschwelle).',
          tips: [], reveal: []
        },
        {
          id: 147, type: 'check',
      ...
      learningData: {
        sections: [
          ...
          { type: 'summary', title: 'Zusammenfassung', items: [
            ...
            'An der Nutzschwelle sind zwei Bedingungen erfüllt: Nettörlös = Selbstkosten und Deckungsbeitrag = Fixe Kosten.',
