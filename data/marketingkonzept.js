    ...
    // ================================================================
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          q: 'Ordnen Sie die vier Strategietypen den nummerierten Feldern der SWOT-Matrix zu.',
          ...
          pairs: [
            { l: 'SO-Strategien: Stärken einsetzen, um Chancen zu nutzen', r: '1' },
            { l: 'ST-Strategien: Stärken einsetzen, um Gefahren zu verringern', r: '2' },
            { l: 'WO-Strategien: Schwächen minimieren, um Chancen zu nutzen', r: '3' },
            { l: 'WT-Strategien: Schwächen minimieren, um Gefahren abzuwenden', r: '4' }
          ],
          options: ['1', '2', '3', '4'],
          tips: ['Die Zeilen kommen aus der Unternehmensanalyse (Stärken oben, Schwächen unten).', 'Die Spalten kommen aus der Umweltanalyse (Chancen links, Gefahren rechts).', 'Der Name der Strategie verrät die Kombination: der erste Buchstabe ist die Zeile, der zweite die Spalte.'],
          reveal: ['Feld 1 = SO: Stärke trifft auf Chance. Die beste Konstellation. Diese Kombination muss man nutzen und multiplizieren.', 'Feld 2 = ST: Stärke trifft auf Gefahr. Das kann eine Versicherung sein, weil das Unternehmen den widrigen Umständen wirksam entgegentreten kann. Es kann aber auch eine Fehlallokation von Ressourcen sein, wenn sich die Stärke nicht in Erfolg umwandeln lässt.', 'Feld 3 = WO: Schwäche trifft auf Chance. Hier liegt das grösste Verbesserungspotenzial. Gelingt es, die Schwäche in eine Stärke zu verwandeln, kann die Chance genutzt werden.', 'Feld 4 = WT: Schwäche trifft auf Gefahr. Hier hat das Unternehmen keinerlei Vorteile. Unter Umständen muss es sich aus diesem Markt zurückziehen.', 'Merkhilfe: Der Name sagt die Position. Der erste Buchstabe ist die Zeile (S oben, W unten), der zweite die Spalte (O links, T rechts).']
        },
        {
        ...
        {
          id: 107, type: 'match', title: 'Strategien dem SWOT-Feld zuordnen',
          q: 'Diese Strategien stammen aus der Fallstudie Kieser Training. Ordnen Sie jede dem richtigen Feld der SWOT-Matrix zu.',
          pairs: [
            ...
            { l: 'Die Kunden können mit denselben Maschinen zu Hause trainieren. Zugleich fehlt Kieser der soziale Zusatznutzen, um sie im Center zu halten.', r: 'WT' },
            ...
            { l: 'Andere Fitnesscenter dienen auch als Kontaktcenter. Kieser bietet dies nicht an und verliert damit das wachsende Single-Segment.', r: 'WO' },
          ...
          options: ['SO', 'ST', 'WO', 'WT'],
          tips: ['Prüfen Sie zuerst, ob die interne Seite ein Vorteil (S) oder ein Nachteil (W) ist.', 'Prüfen Sie danach, ob die externe Seite positiv (O) oder negativ (T) ist.', 'Formulierungen wie «wird hervorgehoben» oder «wird eingesetzt» deuten auf eine Stärke, «fehlt» oder «muss erweitert werden» auf eine Schwäche.'],
          reveal: ['SO erkennen Sie daran, dass ein vorhandener Vorteil auf eine günstige Entwicklung trifft und einfach ausgespielt wird. Beispiel: medizinische Ausrichtung trifft auf Überalterung, 30-Minuten-Training trifft auf Zeitdruck der Berufstätigen.', 'ST erkennen Sie daran, dass ein vorhandener Vorteil gegen eine Bedrohung verteidigt wird. Beispiel: die wissenschaftlich belegte Wirkung gegen die Streichung der Krankenkassenbeiträge, die ärztliche Betreuung gegen den Outdoor-Trend.', 'WO erkennen Sie daran, dass eine günstige Entwicklung da ist, das Unternehmen sie aber wegen einer eigenen Lücke nicht nutzen kann. Beispiel: junge Kunden und Singles wären da, aber das Angebot ist zu eng. Hier liegt das grösste Verbesserungspotenzial.', 'WT erkennen Sie daran, dass eine eigene Lücke auf eine Bedrohung trifft und keine Vorteile bleiben. Beispiel: Training zu Hause plus fehlender sozialer Zusatznutzen, oder der Ganzheitlichkeitstrend gegen die mechanistische Philosophie. Hier ist ein Rückzug zu prüfen.', 'Häufiger Fehler: WO und ST verwechseln. Achten Sie darauf, welche Seite negativ ist. Bei WO ist die externe Seite positiv und die interne negativ, bei ST genau umgekehrt.', 'Prüfungstipp: Schreiben Sie in der Prüfung immer beide Faktoren in die Strategie hinein. Eine Strategie, die nur die Massnahme nennt, lässt sich keinem Feld zuordnen und bringt keine Punkte.']
        },
        {
