  ...
  chapters: [
    ...
    // ================================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Das Marktgeschehen als System nach Kühn (Abb. 2-8)',
            svg: '<svg viewBox="0 0 700 470" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="p" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0 L8 4 L0 8 Z" fill="#7e22ce"/></marker></defs><rect x="20" y="24" width="660" height="336" rx="6" fill="none" stroke="#7e22ce" stroke-width="1.8"/><text x="350" y="44" text-anchor="middle" fill="#581c87" font-size="12" font-weight="bold">Marktsystem</text><rect x="200" y="58" width="140" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="270" y="75" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Unser</text><text x="270" y="89" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Unternehmen</text><rect x="390" y="58" width="140" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="460" y="82" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Konkurrenz</text><rect x="230" y="168" width="240" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="350" y="192" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Zwischenhandel</text><rect x="60" y="236" width="150" height="38" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="135" y="252" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Externe</text><text x="135" y="266" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Beeinflusser</text><rect x="240" y="300" width="230" height="44" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="355" y="319" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Endkunden, Käufer und</text><text x="355" y="333" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">interne Beeinflusser</text><line x1="270" y1="98" x2="270" y2="168" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="300" y="126" text-anchor="start" fill="#6b21a8" font-size="9">Marketingmix</text><line x1="460" y1="98" x2="460" y2="168" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="452" y="126" text-anchor="end" fill="#6b21a8" font-size="9">Marketingmix</text><line x1="330" y1="208" x2="330" y2="300" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="325" y="244" text-anchor="end" fill="#6b21a8" font-size="9">Marketingmix</text><text x="325" y="256" text-anchor="end" fill="#6b21a8" font-size="9">des Handels</text><line x1="400" y1="300" x2="400" y2="208" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="408" y="254" text-anchor="start" fill="#6b21a8" font-size="9">Nachfrage</text><line x1="210" y1="258" x2="240" y2="300" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="180" y="292" text-anchor="middle" fill="#6b21a8" font-size="9">Einfluss</text><polyline points="355,344 355,352 650,352 650,78 530,78" fill="none" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="642" y="246" text-anchor="end" fill="#6b21a8" font-size="9">Nachfrage /</text><text x="642" y="258" text-anchor="end" fill="#6b21a8" font-size="9">Information</text><polyline points="245,322 40,322 40,78 200,78" fill="none" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="46" y="170" text-anchor="start" fill="#6b21a8" font-size="9">Nachfrage /</text><text x="46" y="182" text-anchor="start" fill="#6b21a8" font-size="9">Information</text><rect x="20" y="376" width="660" height="66" rx="4" fill="none" stroke="#7e22ce" stroke-width="1.6"/><text x="350" y="393" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Umfeld</text><rect x="30" y="402" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="79" y="420" text-anchor="middle" fill="#581c87" font-size="10">Politik</text><rect x="138" y="402" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="187" y="420" text-anchor="middle" fill="#581c87" font-size="10">Wirtschaft</text><rect x="246" y="402" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="295" y="420" text-anchor="middle" fill="#581c87" font-size="10">Gesellschaft</text><rect x="355" y="402" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="404" y="420" text-anchor="middle" fill="#581c87" font-size="10">Technologie</text><rect x="463" y="402" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="512" y="420" text-anchor="middle" fill="#581c87" font-size="10">Ökologie</text><rect x="571" y="402" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="620" y="420" text-anchor="middle" fill="#581c87" font-size="10">Recht</text></svg>'
          },
          {
            type: 'concept',
          ...
          {
            type: 'svg',
            title: 'Marktsystem für Investitionsgüter (Abb. 2-9)',
            svg: '<svg viewBox="0 0 700 400" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="p" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0 L8 4 L0 8 Z" fill="#7e22ce"/></marker></defs><rect x="20" y="24" width="660" height="266" rx="6" fill="none" stroke="#7e22ce" stroke-width="1.8"/><text x="350" y="44" text-anchor="middle" fill="#581c87" font-size="12" font-weight="bold">Marktsystem</text><rect x="90" y="58" width="150" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="165" y="75" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Unser</text><text x="165" y="89" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Unternehmen</text><rect x="460" y="58" width="150" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="535" y="82" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Konkurrenz</text><rect x="90" y="138" width="150" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="165" y="155" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Externe</text><text x="165" y="169" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Beeinflusser</text><rect x="300" y="138" width="150" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="375" y="162" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Kunde</text><polyline points="240,78 330,78 330,138" fill="none" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><polyline points="460,78 400,78 400,138" fill="none" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><line x1="300" y1="158" x2="240" y2="158" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)" marker-start="url(#p)"/><line x1="375" y1="178" x2="375" y2="196" stroke="#7e22ce" stroke-width="1.4"/><line x1="102" y1="196" x2="598" y2="196" stroke="#7e22ce" stroke-width="1.4"/><line x1="102" y1="196" x2="102" y2="212" stroke="#7e22ce" stroke-width="1.4"/><rect x="47" y="212" width="110" height="34" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="102" y="226" text-anchor="middle" fill="#581c87" font-size="9">Interner</text><text x="102" y="240" text-anchor="middle" fill="#581c87" font-size="9">Beeinflusser</text><line x1="226" y1="196" x2="226" y2="212" stroke="#7e22ce" stroke-width="1.4"/><rect x="171" y="212" width="110" height="34" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="226" y="233" text-anchor="middle" fill="#581c87" font-size="9">Entscheider</text><line x1="350" y1="196" x2="350" y2="212" stroke="#7e22ce" stroke-width="1.4"/><rect x="295" y="212" width="110" height="34" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="350" y="233" text-anchor="middle" fill="#581c87" font-size="9">Verwender</text><line x1="474" y1="196" x2="474" y2="212" stroke="#7e22ce" stroke-width="1.4"/><rect x="419" y="212" width="110" height="34" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="474" y="233" text-anchor="middle" fill="#581c87" font-size="9">Gatekeeper</text><line x1="598" y1="196" x2="598" y2="212" stroke="#7e22ce" stroke-width="1.4"/><rect x="543" y="212" width="110" height="34" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="598" y="233" text-anchor="middle" fill="#581c87" font-size="9">Einkäufer</text><text x="350" y="272" text-anchor="middle" fill="#6b21a8" font-size="9" font-style="italic">Buying Center: fünf Rollen beim Kunden</text><rect x="20" y="306" width="660" height="66" rx="4" fill="none" stroke="#7e22ce" stroke-width="1.6"/><text x="350" y="323" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Umfeld</text><rect x="30" y="332" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="79" y="350" text-anchor="middle" fill="#581c87" font-size="10">Politik</text><rect x="138" y="332" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="187" y="350" text-anchor="middle" fill="#581c87" font-size="10">Wirtschaft</text><rect x="246" y="332" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="295" y="350" text-anchor="middle" fill="#581c87" font-size="10">Gesellschaft</text><rect x="355" y="332" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="404" y="350" text-anchor="middle" fill="#581c87" font-size="10">Technologie</text><rect x="463" y="332" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="512" y="350" text-anchor="middle" fill="#581c87" font-size="10">Ökologie</text><rect x="571" y="332" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="620" y="350" text-anchor="middle" fill="#581c87" font-size="10">Recht</text></svg>'
          },
          {
            type: 'concept',
          ...
          {
            type: 'svg',
            title: 'Marktsystem für personalintensive Dienstleistungen (Abb. 2-10)',
            svg: '<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="p" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0 L8 4 L0 8 Z" fill="#7e22ce"/></marker></defs><rect x="20" y="24" width="660" height="286" rx="6" fill="none" stroke="#7e22ce" stroke-width="1.8"/><text x="350" y="44" text-anchor="middle" fill="#581c87" font-size="12" font-weight="bold">Marktsystem</text><rect x="150" y="58" width="150" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="225" y="75" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Unser</text><text x="225" y="89" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Unternehmen</text><rect x="420" y="58" width="150" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="495" y="82" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Konkurrenz</text><rect x="40" y="170" width="140" height="42" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="110" y="188" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Unsere</text><text x="110" y="202" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Mitarbeitenden</text><rect x="255" y="170" width="190" height="42" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="350" y="188" text-anchor="middle" fill="#581c87" font-size="9" font-weight="bold">Endkunden, Käufer und</text><text x="350" y="202" text-anchor="middle" fill="#581c87" font-size="9" font-weight="bold">interne Beeinflusser</text><rect x="520" y="170" width="150" height="42" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="595" y="188" text-anchor="middle" fill="#581c87" font-size="9" font-weight="bold">Mitarbeitende</text><text x="595" y="202" text-anchor="middle" fill="#581c87" font-size="9" font-weight="bold">des Konkurrenten</text><line x1="180" y1="98" x2="110" y2="170" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="96" y="128" text-anchor="middle" fill="#6b21a8" font-size="9">Internes</text><text x="96" y="140" text-anchor="middle" fill="#6b21a8" font-size="9">Marketing</text><line x1="265" y1="98" x2="320" y2="170" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><text x="348" y="128" text-anchor="middle" fill="#6b21a8" font-size="9">Externes</text><text x="348" y="140" text-anchor="middle" fill="#6b21a8" font-size="9">Marketing</text><line x1="180" y1="191" x2="255" y2="191" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)" marker-start="url(#p)"/><text x="218" y="182" text-anchor="middle" fill="#6b21a8" font-size="9">Interaktives</text><text x="218" y="206" text-anchor="middle" fill="#6b21a8" font-size="9">Marketing</text><line x1="495" y1="98" x2="570" y2="170" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)"/><line x1="520" y1="191" x2="445" y2="191" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)" marker-start="url(#p)"/><rect x="255" y="248" width="190" height="40" rx="5" fill="#e9d5ff" stroke="#7e22ce" stroke-width="1.6"/><text x="350" y="272" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Externe Beeinflusser</text><line x1="350" y1="212" x2="350" y2="248" stroke="#7e22ce" stroke-width="1.4" marker-end="url(#p)" marker-start="url(#p)"/><rect x="20" y="326" width="660" height="66" rx="4" fill="none" stroke="#7e22ce" stroke-width="1.6"/><text x="350" y="343" text-anchor="middle" fill="#581c87" font-size="11" font-weight="bold">Umfeld</text><rect x="30" y="352" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="79" y="370" text-anchor="middle" fill="#581c87" font-size="10">Politik</text><rect x="138" y="352" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="187" y="370" text-anchor="middle" fill="#581c87" font-size="10">Wirtschaft</text><rect x="246" y="352" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="295" y="370" text-anchor="middle" fill="#581c87" font-size="10">Gesellschaft</text><rect x="355" y="352" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="404" y="370" text-anchor="middle" fill="#581c87" font-size="10">Technologie</text><rect x="463" y="352" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="512" y="370" text-anchor="middle" fill="#581c87" font-size="10">Ökologie</text><rect x="571" y="352" width="98" height="28" rx="5" fill="#f3e8ff" stroke="#7e22ce" stroke-width="1.6"/><text x="620" y="370" text-anchor="middle" fill="#581c87" font-size="10">Recht</text></svg>'
          },
          {
            type: 'merke',
            title: 'Merke dir!',
    ...
    // ================================================================
    {
      ...
      exercises: [
        ...
        {
          id: 110, type: 'match', title: 'Persona segmentieren: Welches Kriterium?',
          q: 'Ein Sportfachgeschäft hat für seine Zielgruppenarbeit die Persona «Nadia, 34» erstellt. Ordnen Sie jedes Merkmal dem richtigen Segmentierungskriterium zu. Auf jedes Kriterium entfallen genau drei Merkmale.',
          pairs: [
            { l: 'Wohnt in einer Berggemeinde mit rund 1800 Einwohnerinnen und Einwohnern.', r: 'Geografisch' },
            { l: 'Lebt in der französischsprachigen Schweiz.', r: 'Geografisch' },
            { l: 'Das nächste grössere Einkaufszentrum liegt 40 Autominuten entfernt.', r: 'Geografisch' },
            { l: 'Ist 34 Jahre alt und hat zwei Kinder im Vorschulalter.', r: 'Demografisch' },
            { l: 'Das Haushaltseinkommen liegt bei rund CHF 140 000 pro Jahr.', r: 'Demografisch' },
            { l: 'Hat einen Abschluss als diplomierte Pflegefachfrau HF.', r: 'Demografisch' },
            { l: 'Sieht sich selbst als umweltbewusst und will nachhaltig leben.', r: 'Psychografisch' },
            { l: 'Bezeichnet sich als naturverbunden, die Berge sind ihr Ausgleich zum Beruf.', r: 'Psychografisch' },
            { l: 'Ist offen für Neues und probiert gerne aus, bevor andere es tun.', r: 'Psychografisch' },
            { l: 'Kauft seit acht Jahren Ausrüstung derselben Marke.', r: 'Kaufverhalten' },
            { l: 'Vergleicht vor grösseren Anschaffungen die Preise und wartet auf Aktionen.', r: 'Kaufverhalten' },
            { l: 'Bestellt im Schnitt zweimal pro Monat online statt im Laden.', r: 'Kaufverhalten' }
          ],
          options: ['Geografisch', 'Demografisch', 'Psychografisch', 'Kaufverhalten'],
          tips: ['Geografisch beantwortet die Frage: Wo lebt die Person?', 'Demografisch beantwortet die Frage: Wer ist die Person, objektiv und messbar (Alter, Einkommen, Beruf, Familie)?', 'Psychografisch beantwortet die Frage: Wie tickt die Person innerlich (Werte, Lebensstil, Selbstbild, Persönlichkeit)?', 'Kaufverhaltensbezogen beantwortet die Frage: Was tut die Person nachweislich (Kaufhäufigkeit, Markentreue, Preisverhalten, Kanal)?', 'Der schwierigste Unterschied: «Sieht sich als umweltbewusst» ist eine Haltung, «kauft seit Jahren nur Bio» ist ein Verhalten.'],
          reveal: [
            'Geografisch: Berggemeinde mit 1800 Einwohnenden, französischsprachige Schweiz, 40 Autominuten bis zum Einkaufszentrum. Alle drei beschreiben den Ort. Die Distanz zum Einkaufszentrum ist geografisch, nicht kaufverhaltensbezogen, denn sie beschreibt die Lage und nicht das Verhalten.',
            'Demografisch: Alter und Kinder, Haushaltseinkommen, Ausbildungsabschluss. Diese Merkmale sind objektiv erhebbar, jemand kann sie im Fragebogen ankreuzen. Sie sagen aber nichts darüber aus, warum jemand kauft.',
            'Psychografisch: Selbstbild als umweltbewusst, Naturverbundenheit als Ausgleich, Offenheit für Neues. Diese Merkmale erklären die Kaufmotive und sind für die Kommunikation am wertvollsten, aber am aufwendigsten zu erheben (Befragung, Marktforschung).',
            'Kaufverhalten: Markentreue über acht Jahre, Preisvergleich und Warten auf Aktionen, zweimal monatlich online. Diese Merkmale stehen in den eigenen Verkaufs- und Kundendaten und sind deshalb am einfachsten messbar.',
            'Häufigster Fehler: «Offen für Neues» wirkt wie Verhalten, ist aber eine Persönlichkeitseigenschaft und damit psychografisch. Erst «hat die letzten drei Neuheiten sofort gekauft» wäre Kaufverhalten. Fragen Sie sich: Steht das so in den Verkaufsdaten? Wenn nein, ist es psychografisch.',
            'Prüfungstipp: In der Fallstudie reicht es nicht, die vier Kriterien aufzuzählen. Verlangt ist meist, sie auf das konkrete Unternehmen anzuwenden und daraus ein Segment zu beschreiben.'
          ]
        },
        {
          id: 111, type: 'text', title: 'Zielsegment selbst beschreiben (Prüfungsaufgabe)',
          q: 'Die Velowerkstatt Hübscher in Luzern will neu E-Bikes für Pendlerinnen und Pendler verkaufen und braucht dafür eine Segmentbeschreibung. Beschreiben Sie das Zielsegment mit allen vier Segmentierungskriterien. Nennen Sie pro Kriterium mindestens zwei konkrete Merkmale und begründen Sie kurz, warum dieses Merkmal für den Verkauf von Pendler-E-Bikes relevant ist.',
          parts: [
            { label: 'a)', q: 'Geografische Kriterien (wo lebt und pendelt die Zielgruppe?)',
              keywords: ['luzern', 'agglomeration', 'pendel', 'distanz', 'arbeitsweg', 'stadt', 'kilometer', 'topografie'], minKeywords: 3,
              solution: 'Wohnort in der Agglomeration Luzern, Arbeitsweg von rund 5 bis 15 Kilometern in die Stadt, hügelige Topografie der Region. Relevant, weil die Distanz und die Steigungen genau der Bereich sind, in dem ein E-Bike gegenüber Velo und Auto punktet.' },
            { label: 'b)', q: 'Demografische Kriterien (wer ist die Zielgruppe objektiv?)',
              keywords: ['alter', 'jahre', 'einkommen', 'beruf', 'angestellt', 'bildung', 'haushalt'], minKeywords: 3,
              solution: 'Alter 30 bis 55 Jahre, Angestellte mit festem Arbeitsort, mittleres bis gehobenes Einkommen ab etwa CHF 80 000. Relevant, weil ein E-Bike eine Anschaffung von mehreren tausend Franken ist und regelmässiges Pendeln einen festen Arbeitsort voraussetzt.' },
            { label: 'c)', q: 'Psychografische Kriterien (welche Werte und Motive?)',
              keywords: ['umwelt', 'nachhaltig', 'gesundheit', 'fitness', 'lebensstil', 'zeit', 'stau', 'bewusst'], minKeywords: 3,
              solution: 'Umweltbewusste Haltung, Wunsch nach Bewegung und Gesundheit im Alltag, Abneigung gegen Stau und Parkplatzsuche. Relevant, weil diese Motive die Kaufargumente liefern: Das E-Bike wird nicht als Sportgerät verkauft, sondern als tägliche Entlastung.' },
            { label: 'd)', q: 'Kaufverhaltensbezogene Kriterien (was tut die Zielgruppe nachweislich?)',
              keywords: ['service', 'beratung', 'wartung', 'online', 'informier', 'marke', 'preis', 'probefahrt', 'leasing'], minKeywords: 3,
              solution: 'Informiert sich vor dem Kauf online, will aber eine Probefahrt vor Ort, legt Wert auf Service und jährliche Wartung, ist bereit, für Qualität mehr zu zahlen, nutzt teilweise Firmenleasing. Relevant, weil daraus direkt folgt, dass die Werkstatt Probefahrten, ein Serviceabo und eine gute Online-Auffindbarkeit anbieten muss.' }
          ],
          tips: ['Arbeiten Sie die vier Kriterien der Reihe nach ab: wo, wer, wie tickt die Person, was tut sie.', 'Konkret werden: «jüngere Leute» bringt keine Punkte, «30 bis 55 Jahre, angestellt, Arbeitsweg 5 bis 15 Kilometer» schon.', 'Die Begründung ist der Punktebringer. Fragen Sie bei jedem Merkmal: Was folgt daraus für das Angebot, den Preis, den Standort oder die Kommunikation?', 'Denken Sie beim Kaufverhalten an Daten, die das Geschäft tatsächlich sehen kann: Servicetermine, Kaufkanal, Preisbereitschaft.'],
          reveal: [
            'Der Aufbau ist immer gleich: geografisch (wo), demografisch (wer), psychografisch (warum), kaufverhaltensbezogen (was tatsächlich). Wer diese Reihenfolge einhält, vergisst kein Kriterium.',
            'Der häufigste Fehler in der Prüfung ist, beim Demografischen stehen zu bleiben. Alter und Einkommen sagen noch nicht, warum jemand kauft. Erst die psychografischen Merkmale liefern die Argumente für die Kommunikation.',
            'Der zweithäufigste Fehler ist, Merkmale ohne Begründung aufzuzählen. Ein Segment ist erst brauchbar, wenn daraus Konsequenzen für den Marketingmix folgen: Sortiment, Preis, Standort, Kommunikation.',
            'Prüfen Sie Ihr Segment am Schluss auf die drei Anforderungen: Ist es messbar (kann ich die Grösse abschätzen?), erreichbar (komme ich mit Kommunikation und Vertrieb hin?) und wirtschaftlich (lohnt sich der Aufwand)?'
          ]
        }
      ],
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'table',
            title: 'Die vier Segmentierungskriterien bei Privatkunden',
            headers: ['Kriterium', 'Frage dahinter', 'Typische Merkmale'],
            rows: [
              ['Geografisch', 'Wo lebt die Kundin oder der Kunde?', 'Land, Sprachregion, Kanton, Stadt oder Land, Ortsgrösse, Klima, Wohnlage'],
              ['Demografisch', 'Wer ist die Person, objektiv messbar?', 'Alter, Geschlecht, Einkommen, Beruf, Ausbildung, Familienstand, Haushaltsgrösse, Nationalität'],
              ['Psychografisch', 'Wie tickt die Person innerlich?', 'Werte, Lebensstil, Persönlichkeit, Interessen, Einstellungen, Selbstbild, Kaufmotive'],
              ['Kaufverhaltensbezogen', 'Was tut die Person tatsächlich?', 'Kaufhäufigkeit, Kaufmenge, Markentreue, Preissensibilität, Einkaufsstätte, Zahlungsart, Mediennutzung']
            ]
          },
          {
            type: 'merke',
            title: 'Psychografisch oder kaufverhaltensbezogen?',
            content: 'Das ist die häufigste Verwechslung. Psychografische Kriterien beschreiben, wie jemand denkt, fühlt und sich selbst sieht. Kaufverhaltensbezogene Kriterien beschreiben, was jemand nachweislich tut, und lassen sich aus Verkaufs- oder Kundendaten ablesen. Beispiel: «Sieht sich als umweltbewusst» ist psychografisch, «kauft seit drei Jahren nur Bioprodukte» ist kaufverhaltensbezogen. Genau hier klaffen Anspruch und Realität oft auseinander, deshalb ist die Trennung wichtig.'
          },
          {
            type: 'concept',
