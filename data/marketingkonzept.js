    ...
    // ================================================================
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          reveal: ['Es besteht ein starker Trend zu Outdooraktivitäten. → T', 'Fitnesscenter hat optimalen Standort. → S (laut Musterlösung im Buch zusätzlich auch T: ein optimaler Standort bringt oft ungünstige Konkurrenzsituation und hohe Mietpreise mit sich)', 'Wir verfügen über eine gute Kostenstruktur. → S', 'Im Vergleich zur Konkurrenz haben wir eine schlechte Kommunikationspolitik. → W', 'Es gibt einen Trend zu Fitness / Körperbewusstsein. → O', 'Krankenkassen streichen Beiträge für Sport-Abos. → T (laut Musterlösung im Buch zusätzlich auch W: die eigene Abhängigkeit von Krankenkassen-Beiträgen ist eine interne Schwäche)']
        },
        {
