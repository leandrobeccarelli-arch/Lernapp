window.BOOK_DATA = {
  ...
  chapters: [
    ...
    // ============================================================
    {
      id: 'ch1', pageStart: 10, pageEnd: 34, num: 'Teil A – Kapitel 1', title: 'Mediawerbung - Definition und Merkmale',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'AIDA-Modell der Werbewirkung', svg: '<svg viewBox="0 0 550 180" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><defs><marker id="ai-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#9333ea"/></marker></defs><text x="275" y="22" text-anchor="middle" fill="#581c87" font-size="14" font-weight="bold">AIDA-Modell</text><rect x="10" y="40" width="120" height="80" rx="10" fill="#9333ea"/><text x="70" y="65" text-anchor="middle" fill="#fff" font-size="24" font-weight="bold">A</text><text x="70" y="85" text-anchor="middle" fill="#f3e8ff" font-size="11" font-weight="bold">Attention</text><text x="70" y="100" text-anchor="middle" fill="#e9d5ff" font-size="8">Aufmerksamkeit</text><text x="70" y="112" text-anchor="middle" fill="#e9d5ff" font-size="8">erregen</text><line x1="130" y1="80" x2="148" y2="80" stroke="#9333ea" stroke-width="2.5" marker-end="url(#ai-arr)"/><rect x="150" y="40" width="120" height="80" rx="10" fill="#7e22ce"/><text x="210" y="65" text-anchor="middle" fill="#fff" font-size="24" font-weight="bold">I</text><text x="210" y="85" text-anchor="middle" fill="#f3e8ff" font-size="11" font-weight="bold">Interest</text><text x="210" y="100" text-anchor="middle" fill="#e9d5ff" font-size="8">Interesse</text><text x="210" y="112" text-anchor="middle" fill="#e9d5ff" font-size="8">wecken</text><line x1="270" y1="80" x2="288" y2="80" stroke="#9333ea" stroke-width="2.5" marker-end="url(#ai-arr)"/><rect x="290" y="40" width="120" height="80" rx="10" fill="#6b21a8"/><text x="350" y="65" text-anchor="middle" fill="#fff" font-size="24" font-weight="bold">D</text><text x="350" y="85" text-anchor="middle" fill="#f3e8ff" font-size="11" font-weight="bold">Desire</text><text x="350" y="100" text-anchor="middle" fill="#e9d5ff" font-size="8">Wunsch</text><text x="350" y="112" text-anchor="middle" fill="#e9d5ff" font-size="8">ausl\u00f6sen</text><line x1="410" y1="80" x2="428" y2="80" stroke="#9333ea" stroke-width="2.5" marker-end="url(#ai-arr)"/><rect x="430" y="40" width="120" height="80" rx="10" fill="#581c87"/><text x="490" y="65" text-anchor="middle" fill="#fff" font-size="24" font-weight="bold">A</text><text x="490" y="85" text-anchor="middle" fill="#f3e8ff" font-size="11" font-weight="bold">Action</text><text x="490" y="100" text-anchor="middle" fill="#e9d5ff" font-size="8">Handlung</text><text x="490" y="112" text-anchor="middle" fill="#e9d5ff" font-size="8">ausl\u00f6sen</text><rect x="10" y="135" width="540" height="30" rx="6" fill="#faf5ff" stroke="#9333ea" stroke-width="1"/><text x="275" y="155" text-anchor="middle" fill="#78716c" font-size="10">Werbebotschaft f\u00fchrt den Konsumenten stufenweise zur Kaufhandlung</text></svg>' },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      id: 'ch2', pageStart: 35, pageEnd: 60, num: 'Teil A – Kapitel 2', title: 'Werbekonzept',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Mediamix-\u00dcbersicht und Selektionsprozess', svg: '<svg viewBox="0 0 600 320" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><text x="300" y="22" text-anchor="middle" fill="#581c87" font-size="14" font-weight="bold">Mediamix \u2013 \u00dcbersicht</text><rect x="220" y="35" width="160" height="35" rx="8" fill="#9333ea"/><text x="300" y="57" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Mediastrategie</text><line x1="260" y1="70" x2="120" y2="95" stroke="#9333ea" stroke-width="1.5"/><line x1="300" y1="70" x2="300" y2="95" stroke="#9333ea" stroke-width="1.5"/><line x1="340" y1="70" x2="480" y2="95" stroke="#9333ea" stroke-width="1.5"/><rect x="40" y="95" width="150" height="30" rx="6" fill="#f3e8ff" stroke="#9333ea" stroke-width="1.5"/><text x="115" y="115" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Intermedia-Selektion</text><rect x="225" y="95" width="150" height="30" rx="6" fill="#f3e8ff" stroke="#9333ea" stroke-width="1.5"/><text x="300" y="115" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Intramedia-Selektion</text><rect x="410" y="95" width="150" height="30" rx="6" fill="#f3e8ff" stroke="#9333ea" stroke-width="1.5"/><text x="485" y="115" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Mediamix</text><text x="115" y="140" text-anchor="middle" fill="#78716c" font-size="8">Mediengattung w\u00e4hlen</text><text x="300" y="140" text-anchor="middle" fill="#78716c" font-size="8">Innerhalb Gattung w\u00e4hlen</text><text x="485" y="140" text-anchor="middle" fill="#78716c" font-size="8">Kombination festlegen</text><text x="300" y="170" text-anchor="middle" fill="#581c87" font-size="12" font-weight="bold">Mediengattungen</text><rect x="20" y="185" width="80" height="55" rx="6" fill="#9333ea"/><text x="60" y="208" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">TV</text><text x="60" y="225" text-anchor="middle" fill="#e9d5ff" font-size="7">Emotionen</text><text x="60" y="235" text-anchor="middle" fill="#e9d5ff" font-size="7">Reichweite</text><rect x="110" y="185" width="80" height="55" rx="6" fill="#7e22ce"/><text x="150" y="208" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Print</text><text x="150" y="225" text-anchor="middle" fill="#e9d5ff" font-size="7">Information</text><text x="150" y="235" text-anchor="middle" fill="#e9d5ff" font-size="7">Qualit\u00e4t</text><rect x="200" y="185" width="80" height="55" rx="6" fill="#6b21a8"/><text x="240" y="208" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Radio</text><text x="240" y="225" text-anchor="middle" fill="#e9d5ff" font-size="7">G\u00fcnstig</text><text x="240" y="235" text-anchor="middle" fill="#e9d5ff" font-size="7">Begleitmedium</text><rect x="290" y="185" width="80" height="55" rx="6" fill="#581c87"/><text x="330" y="208" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Digital</text><text x="330" y="225" text-anchor="middle" fill="#e9d5ff" font-size="7">Targeting</text><text x="330" y="235" text-anchor="middle" fill="#e9d5ff" font-size="7">Messbar</text><rect x="380" y="185" width="80" height="55" rx="6" fill="#a855f7"/><text x="420" y="208" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Aussen</text><text x="420" y="225" text-anchor="middle" fill="#e9d5ff" font-size="7">Pr\u00e4senz</text><text x="420" y="235" text-anchor="middle" fill="#e9d5ff" font-size="7">\u00d6ffentlich</text><rect x="470" y="185" width="80" height="55" rx="6" fill="#c084fc"/><text x="510" y="208" text-anchor="middle" fill="#581c87" font-size="9" font-weight="bold">Kino</text><text x="510" y="225" text-anchor="middle" fill="#6b21a8" font-size="7">Aufmerksamkeit</text><text x="510" y="235" text-anchor="middle" fill="#6b21a8" font-size="7">Jung</text><rect x="60" y="260" width="480" height="45" rx="8" fill="#faf5ff" stroke="#9333ea" stroke-width="1"/><text x="300" y="280" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">6 Parameter: Reichweite | Kontakte | Intensit\u00e4t | Frequenz | Dominanz | Impact</text><text x="300" y="296" text-anchor="middle" fill="#78716c" font-size="9">Optimal: 3 Kontakte in 4 Wochen, 12 Kontakte in 3 Monaten</text></svg>' },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      id: 'ch3', pageStart: 61, pageEnd: 86, num: 'Teil A – Kapitel 3', title: 'Verkaufsförderung',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Zielgruppen der Verkaufsförderung', svg: '<svg viewBox="0 0 700 260" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">4 Zielgruppen der Verkaufsf\u00f6rderung</text><rect x="20" y="50" width="155" height="190" rx="10" fill="#9333ea"/><text x="97" y="78" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Staff</text><text x="97" y="95" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Promotion</text><line x1="40" y1="105" x2="155" y2="105" stroke="#e9d5ff" stroke-width="0.5"/><text x="97" y="125" text-anchor="middle" fill="#e9d5ff" font-size="9">Eigene Mitarbeitende</text><text x="97" y="140" text-anchor="middle" fill="#e9d5ff" font-size="9">Aussendienst</text><text x="97" y="155" text-anchor="middle" fill="#e9d5ff" font-size="9">Innendienst</text><text x="97" y="170" text-anchor="middle" fill="#e9d5ff" font-size="9">Key Account Mgr</text><text x="97" y="190" text-anchor="middle" fill="#e9d5ff" font-size="8" font-style="italic">Schulung, Pr\u00e4mien</text><rect x="190" y="50" width="155" height="190" rx="10" fill="#7e22ce"/><text x="267" y="78" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Dealer/Trade</text><text x="267" y="95" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Promotion</text><line x1="210" y1="105" x2="325" y2="105" stroke="#e9d5ff" stroke-width="0.5"/><text x="267" y="125" text-anchor="middle" fill="#e9d5ff" font-size="9">Grosshandel</text><text x="267" y="140" text-anchor="middle" fill="#e9d5ff" font-size="9">Detailhandel</text><text x="267" y="155" text-anchor="middle" fill="#e9d5ff" font-size="9">Fachhandel</text><text x="267" y="170" text-anchor="middle" fill="#e9d5ff" font-size="9">ABC-Analyse</text><text x="267" y="190" text-anchor="middle" fill="#e9d5ff" font-size="8" font-style="italic">Displays, Listung</text><rect x="360" y="50" width="155" height="190" rx="10" fill="#6b21a8"/><text x="437" y="78" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Consumer</text><text x="437" y="95" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Promotion</text><line x1="380" y1="105" x2="495" y2="105" stroke="#e9d5ff" stroke-width="0.5"/><text x="437" y="125" text-anchor="middle" fill="#e9d5ff" font-size="9">Endverbraucher</text><text x="437" y="140" text-anchor="middle" fill="#e9d5ff" font-size="9">Produktk\u00e4ufer</text><text x="437" y="155" text-anchor="middle" fill="#e9d5ff" font-size="9">Impulsk\u00e4ufer</text><text x="437" y="170" text-anchor="middle" fill="#e9d5ff" font-size="9">Stammkunden</text><text x="437" y="190" text-anchor="middle" fill="#e9d5ff" font-size="8" font-style="italic">Coupons, Sampling</text><rect x="530" y="50" width="155" height="190" rx="10" fill="#581c87"/><text x="607" y="78" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Externe</text><text x="607" y="95" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Beeinflusser</text><line x1="550" y1="105" x2="665" y2="105" stroke="#e9d5ff" stroke-width="0.5"/><text x="607" y="125" text-anchor="middle" fill="#e9d5ff" font-size="9">Influencer</text><text x="607" y="140" text-anchor="middle" fill="#e9d5ff" font-size="9">Meinungsf\u00fchrer</text><text x="607" y="155" text-anchor="middle" fill="#e9d5ff" font-size="9">Experten</text><text x="607" y="170" text-anchor="middle" fill="#e9d5ff" font-size="9">Berater</text><text x="607" y="190" text-anchor="middle" fill="#e9d5ff" font-size="8" font-style="italic">Info, Testprodukte</text></svg>' },
          {
            type: 'table',
          ...
          { type: 'svg', title: 'Push- vs. Pull-Strategie', svg: '<svg viewBox="0 0 700 250" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="vkf-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#9333ea"/></marker><marker id="vkf-arr2" markerWidth="8" markerHeight="6" refX="0" refY="3" orient="auto"><path d="M8,0 L0,3 L8,6" fill="#581c87"/></marker></defs><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Push- vs. Pull-Strategie</text><text x="350" y="68" text-anchor="middle" fill="#9333ea" font-size="13" font-weight="bold">PUSH-Strategie (VKF = Push-Instrument)</text><rect x="30" y="80" width="160" height="50" rx="8" fill="#9333ea"/><text x="110" y="108" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Hersteller</text><line x1="190" y1="105" x2="258" y2="105" stroke="#9333ea" stroke-width="2.5" marker-end="url(#vkf-arr)"/><text x="224" y="98" text-anchor="middle" fill="#7e22ce" font-size="8">VKF, Rabatte</text><rect x="260" y="80" width="160" height="50" rx="8" fill="#7e22ce"/><text x="340" y="108" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Handel</text><line x1="420" y1="105" x2="488" y2="105" stroke="#9333ea" stroke-width="2.5" marker-end="url(#vkf-arr)"/><text x="454" y="98" text-anchor="middle" fill="#7e22ce" font-size="8">Platzierung</text><rect x="490" y="80" width="160" height="50" rx="8" fill="#581c87"/><text x="570" y="108" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Konsument</text><text x="350" y="162" text-anchor="middle" fill="#581c87" font-size="13" font-weight="bold">PULL-Strategie (erg\u00e4nzend)</text><rect x="30" y="174" width="160" height="50" rx="8" fill="#581c87"/><text x="110" y="202" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Hersteller</text><text x="224" y="192" text-anchor="middle" fill="#581c87" font-size="8">Werbung, PR</text><rect x="260" y="174" width="160" height="50" rx="8" fill="#7e22ce"/><text x="340" y="202" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Handel</text><rect x="490" y="174" width="160" height="50" rx="8" fill="#9333ea"/><text x="570" y="202" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Konsument</text><line x1="488" y1="199" x2="420" y2="199" stroke="#581c87" stroke-width="2.5" marker-end="url(#vkf-arr2)"/><text x="454" y="192" text-anchor="middle" fill="#581c87" font-size="8">Nachfrage</text><path d="M110,174 Q110,155 350,155 Q570,155 570,174" fill="none" stroke="#581c87" stroke-width="1.5" stroke-dasharray="4,3"/><text x="350" y="148" text-anchor="middle" fill="#581c87" font-size="8">Mediawerbung erzeugt Nachfrage-Sog</text></svg>' },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      id: 'ch4', pageStart: 87, pageEnd: 104, num: 'Teil A – Kapitel 4', title: 'Event-Marketing',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Event-Marketing: 3 Phasen der Massnahmenplanung', svg: '<svg viewBox="0 0 700 260" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="ev-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#9333ea"/></marker></defs><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Event-Marketing: 3 Phasen der Massnahmenplanung</text><rect x="20" y="50" width="200" height="150" rx="10" fill="#9333ea"/><text x="120" y="78" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">VOR dem Event</text><line x1="40" y1="90" x2="200" y2="90" stroke="#e9d5ff" stroke-width="0.5"/><text x="120" y="110" text-anchor="middle" fill="#e9d5ff" font-size="9">Programmplanung</text><text x="120" y="125" text-anchor="middle" fill="#e9d5ff" font-size="9">Einladungen &amp; Mailings</text><text x="120" y="140" text-anchor="middle" fill="#e9d5ff" font-size="9">Schulung Personal</text><text x="120" y="155" text-anchor="middle" fill="#e9d5ff" font-size="9">Infrastruktur</text><text x="120" y="170" text-anchor="middle" fill="#e9d5ff" font-size="9">Werbemittel</text><line x1="220" y1="125" x2="248" y2="125" stroke="#9333ea" stroke-width="2.5" marker-end="url(#ev-arr)"/><rect x="250" y="50" width="200" height="150" rx="10" fill="#7e22ce"/><text x="350" y="78" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">W\u00c4HREND des Events</text><line x1="270" y1="90" x2="430" y2="90" stroke="#e9d5ff" stroke-width="0.5"/><text x="350" y="110" text-anchor="middle" fill="#e9d5ff" font-size="9">Attraktionen</text><text x="350" y="125" text-anchor="middle" fill="#e9d5ff" font-size="9">G\u00e4steempfang</text><text x="350" y="140" text-anchor="middle" fill="#e9d5ff" font-size="9">VIP-Lounge</text><text x="350" y="155" text-anchor="middle" fill="#e9d5ff" font-size="9">Medienbetreuung</text><text x="350" y="170" text-anchor="middle" fill="#e9d5ff" font-size="9">Dokumentation</text><line x1="450" y1="125" x2="478" y2="125" stroke="#9333ea" stroke-width="2.5" marker-end="url(#ev-arr)"/><rect x="480" y="50" width="200" height="150" rx="10" fill="#581c87"/><text x="580" y="78" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">NACH dem Event</text><line x1="500" y1="90" x2="660" y2="90" stroke="#e9d5ff" stroke-width="0.5"/><text x="580" y="110" text-anchor="middle" fill="#e9d5ff" font-size="9">Nachbearbeitung</text><text x="580" y="125" text-anchor="middle" fill="#e9d5ff" font-size="9">Wirkungskontrolle</text><text x="580" y="140" text-anchor="middle" fill="#e9d5ff" font-size="9">Kontaktaufnahme</text><text x="580" y="155" text-anchor="middle" fill="#e9d5ff" font-size="9">Schlussrechnung</text><text x="580" y="170" text-anchor="middle" fill="#e9d5ff" font-size="9">Debriefing</text><rect x="20" y="215" width="660" height="30" rx="6" fill="#faf5ff" stroke="#9333ea" stroke-width="1"/><text x="350" y="235" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Die Nachbearbeitung ist essenziell f\u00fcr den Erfolg des Events</text></svg>' },
          {
            type: 'table',
          ...
          { type: 'svg', title: '4 Event-Strategie-Typen', svg: '<svg viewBox="0 0 700 210" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">4 Event-Strategie-Typen</text><rect x="20" y="50" width="155" height="140" rx="8" fill="#9333ea"/><text x="97" y="78" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Einf\u00fchrungs-</text><text x="97" y="94" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">strategie</text><line x1="40" y1="104" x2="155" y2="104" stroke="#e9d5ff" stroke-width="0.5"/><text x="97" y="122" text-anchor="middle" fill="#e9d5ff" font-size="9">Neues Produkt</text><text x="97" y="137" text-anchor="middle" fill="#e9d5ff" font-size="9">live einf\u00fchren bei</text><text x="97" y="152" text-anchor="middle" fill="#e9d5ff" font-size="9">bestimmten</text><text x="97" y="167" text-anchor="middle" fill="#e9d5ff" font-size="9">Zielgruppen</text><rect x="190" y="50" width="155" height="140" rx="8" fill="#7e22ce"/><text x="267" y="78" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Zielgruppen-</text><text x="267" y="94" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">erschliessung</text><line x1="210" y1="104" x2="325" y2="104" stroke="#e9d5ff" stroke-width="0.5"/><text x="267" y="122" text-anchor="middle" fill="#e9d5ff" font-size="9">Neue Zielgruppen</text><text x="267" y="137" text-anchor="middle" fill="#e9d5ff" font-size="9">ansprechen und</text><text x="267" y="152" text-anchor="middle" fill="#e9d5ff" font-size="9">mit Produkten</text><text x="267" y="167" text-anchor="middle" fill="#e9d5ff" font-size="9">vertraut machen</text><rect x="360" y="50" width="155" height="140" rx="8" fill="#6b21a8"/><text x="437" y="78" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Imageprofil-</text><text x="437" y="94" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">ierung</text><line x1="380" y1="104" x2="495" y2="104" stroke="#e9d5ff" stroke-width="0.5"/><text x="437" y="122" text-anchor="middle" fill="#e9d5ff" font-size="9">Marke st\u00e4rker</text><text x="437" y="137" text-anchor="middle" fill="#e9d5ff" font-size="9">positionieren</text><text x="437" y="152" text-anchor="middle" fill="#e9d5ff" font-size="9">gegen\u00fcber</text><text x="437" y="167" text-anchor="middle" fill="#e9d5ff" font-size="9">Mitbewerbern</text><rect x="530" y="50" width="155" height="140" rx="8" fill="#581c87"/><text x="607" y="78" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Erlebnis-</text><text x="607" y="94" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">strategie</text><line x1="550" y1="104" x2="665" y2="104" stroke="#e9d5ff" stroke-width="0.5"/><text x="607" y="122" text-anchor="middle" fill="#e9d5ff" font-size="9">Zielgruppen live</text><text x="607" y="137" text-anchor="middle" fill="#e9d5ff" font-size="9">mit Produkt</text><text x="607" y="152" text-anchor="middle" fill="#e9d5ff" font-size="9">konfrontieren,</text><text x="607" y="167" text-anchor="middle" fill="#e9d5ff" font-size="9">hoher Erlebniswert</text></svg>' },
          {
            type: 'concept',
          ...
          },
          {
            ...
            title: 'Zusammenfassung',
            content: [
              '<strong>Event-Marketing</strong> (Live-Communication) ist die zielgerichtete und systematische Planung von Veranstaltungen als Kommunikationsinstrument. Im Zentrum steht die Erlebnisorientierung.',
              'Vier <strong>Event-Arten</strong>: arbeitsorientierte Veranstaltungen, Infotainment, Unternehmensveranstaltungen und freizeitorientierte Aktivitäten.',
              'Die <strong>Ziele</strong> unterteilen sich in kognitiv (Bekanntmachung), affektiv (emotionales Erleben) und konativ (Kundenbindung, Direktverkauf).',
              'Vier <strong>Strategie-Typen</strong>: Einführung, Zielgruppenerschliessung, Imageprofilierung und Erlebnisstrategie.',
              'Die <strong>Massnahmenplanung</strong> umfasst drei Phasen: vor dem Event (Planung, Einladungen), während des Events (Attraktionen, Medienbetreuung) und nach dem Event (Nachbearbeitung, Wirkungskontrolle).',
              '<strong>Abgrenzung zum Sponsoring:</strong> Beim Event-Marketing inszeniert das Unternehmen ein eigenes Ereignis, beim Sponsoring findet das Ereignis auch ohne den Sponsor statt.'
            ]
          },
          {
            type: 'keyterms',
    ...
    // ============================================================
    {
      id: 'ch5', pageStart: 105, pageEnd: 123, num: 'Teil A – Kapitel 5', title: 'Messen und Ausstellungen',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Messe vs. Ausstellung vs. Kongress', svg: '<svg viewBox="0 0 700 230" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Drei Veranstaltungsformen im Vergleich</text><rect x="20" y="50" width="210" height="160" rx="10" fill="#9333ea"/><text x="125" y="80" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">Messe</text><line x1="40" y1="92" x2="210" y2="92" stroke="#e9d5ff" stroke-width="0.5"/><text x="125" y="112" text-anchor="middle" fill="#e9d5ff" font-size="10">Schwerpunkt:</text><text x="125" y="128" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Handeln &amp; Verkaufen</text><text x="125" y="150" text-anchor="middle" fill="#e9d5ff" font-size="9">Fachpublikum</text><text x="125" y="165" text-anchor="middle" fill="#e9d5ff" font-size="9">Gesch\u00e4ftsabschl\u00fcsse</text><text x="125" y="180" text-anchor="middle" fill="#e9d5ff" font-size="9">Branchentreffpunkt</text><rect x="245" y="50" width="210" height="160" rx="10" fill="#7e22ce"/><text x="350" y="80" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">Ausstellung</text><line x1="265" y1="92" x2="435" y2="92" stroke="#e9d5ff" stroke-width="0.5"/><text x="350" y="112" text-anchor="middle" fill="#e9d5ff" font-size="10">Schwerpunkt:</text><text x="350" y="128" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Pr\u00e4sentation &amp; Werben</text><text x="350" y="150" text-anchor="middle" fill="#e9d5ff" font-size="9">Breites Publikum</text><text x="350" y="165" text-anchor="middle" fill="#e9d5ff" font-size="9">Visuelle Darstellung</text><text x="350" y="180" text-anchor="middle" fill="#e9d5ff" font-size="9">Produktinformation</text><rect x="470" y="50" width="210" height="160" rx="10" fill="#581c87"/><text x="575" y="80" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">Kongress</text><line x1="490" y1="92" x2="660" y2="92" stroke="#e9d5ff" stroke-width="0.5"/><text x="575" y="112" text-anchor="middle" fill="#e9d5ff" font-size="10">Schwerpunkt:</text><text x="575" y="128" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Debatten &amp; Austausch</text><text x="575" y="150" text-anchor="middle" fill="#e9d5ff" font-size="9">Hohes Niveau</text><text x="575" y="165" text-anchor="middle" fill="#e9d5ff" font-size="9">Fachvortr\u00e4ge</text><text x="575" y="180" text-anchor="middle" fill="#e9d5ff" font-size="9">Networking</text></svg>' },
          {
            type: 'concept',
          ...
          { type: 'svg', title: 'Messe-Regelkreis: 3 Phasen', svg: '<svg viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="ms-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#9333ea"/></marker></defs><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Messe-Regelkreis: 3 Phasen der Ausstelleraktivit\u00e4t</text><rect x="230" y="48" width="240" height="55" rx="8" fill="#9333ea"/><text x="350" y="72" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">Phase 1: Vorbereiten</text><text x="350" y="90" text-anchor="middle" fill="#e9d5ff" font-size="9">Messeziele, Strategie, Standkonzept, Personal</text><line x1="470" y1="75" x2="530" y2="130" stroke="#9333ea" stroke-width="2" marker-end="url(#ms-arr)"/><rect x="400" y="135" width="240" height="55" rx="8" fill="#7e22ce"/><text x="520" y="159" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">Phase 2: Ausstellen</text><text x="520" y="177" text-anchor="middle" fill="#e9d5ff" font-size="9">F\u00fchrung Messestand, Kundenkontakte, Follow-up</text><line x1="400" y1="162" x2="340" y2="210" stroke="#9333ea" stroke-width="2" marker-end="url(#ms-arr)"/><rect x="60" y="135" width="240" height="55" rx="8" fill="#581c87"/><text x="180" y="159" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">Phase 3: Auswerten</text><text x="180" y="177" text-anchor="middle" fill="#e9d5ff" font-size="9">Controlling, Ergebnisse, Vorbereitung n\u00e4chste Messe</text><line x1="230" y1="135" x2="230" y2="103" stroke="#9333ea" stroke-width="2" marker-end="url(#ms-arr)"/><rect x="120" y="220" width="460" height="35" rx="6" fill="#faf5ff" stroke="#9333ea" stroke-width="1"/><text x="350" y="242" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Regelkreis: Unternehmen mit Menschen und M\u00e4rkten zusammenf\u00fchren und verbinden</text></svg>' },
          {
            type: 'table',
          ...
          },
          {
            ...
            title: 'Zusammenfassung',
            content: [
              '<strong>Messen</strong> (Handeln/Verkaufen), <strong>Ausstellungen</strong> (Präsentation/Werben) und <strong>Kongresse</strong> (Debatten/Austausch) sind wichtige Kommunikationsinstrumente mit direktem Kundenkontakt.',
              'Der <strong>Messe-Regelkreis</strong> umfasst drei Phasen: Vorbereiten (Messeziele, Strategie, Standkonzept), Ausstellen (Führung Messestand, Kundenkontakte) und Auswerten (Controlling, Nachbearbeitung).',
              'Die <strong>Dreiminutenerklärung</strong> ist ein kurzer Überblick über Unternehmen und Marktleistungen für den Erstkontakt. Das <strong>Gesprächsprotokoll</strong> dient der systematischen Erfassung aller Messekontakte.',
              'Messen bieten entscheidende <strong>Vorteile</strong>: direkter Kontakt zu vielen potenziellen Kunden, Feedback, Selbstdarstellung und Konkurrenzbeobachtung.',
              'Die <strong>Nachbearbeitung</strong> ist essenziell: Kontakte kurzfristig aufarbeiten, Ausstellernachbesprechung durchführen und Verbesserungen für die nächste Messe planen.'
            ]
          },
          {
            type: 'keyterms',
    ...
    // ============================================================
    {
      id: 'ch6', pageStart: 124, pageEnd: 137, num: 'Teil A – Kapitel 6', title: 'Sponsoring',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Sponsor-Status: Hierarchie und Rechte', svg: '<svg viewBox="0 0 700 260" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Sponsor-Status: Hierarchie der Rechte</text><rect x="175" y="48" width="350" height="45" rx="8" fill="#581c87"/><text x="350" y="68" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Exklusiv-Sponsor</text><text x="350" y="83" text-anchor="middle" fill="#e9d5ff" font-size="9">Einziger Sponsor \u2013 Ownership-Ansatz \u2013 Alle Rechte</text><rect x="125" y="100" width="450" height="45" rx="8" fill="#6b21a8"/><text x="350" y="120" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Hauptsponsor</text><text x="350" y="135" text-anchor="middle" fill="#e9d5ff" font-size="9">Umfangreiche Rechte \u2013 Hoher finanzieller Beitrag \u2013 Prominente Platzierung</text><rect x="75" y="152" width="550" height="45" rx="8" fill="#7e22ce"/><text x="350" y="172" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Co-Sponsor</text><text x="350" y="187" text-anchor="middle" fill="#e9d5ff" font-size="9">Geringerer Beitrag \u2013 Branchenexklusivrecht \u2013 Subsidiary Sponsor</text><rect x="25" y="204" width="650" height="45" rx="8" fill="#9333ea"/><text x="350" y="224" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Official Supplier</text><text x="350" y="239" text-anchor="middle" fill="#e9d5ff" font-size="9">Exklusivrechte innerhalb einer Produktkategorie \u2013 Sachleistungen statt Geld</text></svg>' },
          {
            type: 'table',
          ...
          { type: 'svg', title: 'Sponsoring-Formen nach Verbreitung', svg: '<svg viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Sponsoring-Formen nach Verbreitung</text><rect x="50" y="50" width="480" height="60" rx="8" fill="#581c87"/><text x="290" y="75" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">Sportsponsoring</text><text x="290" y="95" text-anchor="middle" fill="#e9d5ff" font-size="10">Events, Mannschaften, Einzelsportler \u2013 Massenpublikum</text><text x="555" y="80" fill="#581c87" font-size="20" font-weight="bold">~80%</text><rect x="50" y="120" width="360" height="60" rx="8" fill="#6b21a8"/><text x="230" y="145" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold">Kultursponsoring</text><text x="230" y="165" text-anchor="middle" fill="#e9d5ff" font-size="10">Kunst, Theater, Konzerte, Museen</text><text x="435" y="150" fill="#6b21a8" font-size="20" font-weight="bold">~15%</text><rect x="50" y="190" width="120" height="60" rx="8" fill="#7e22ce"/><text x="110" y="215" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Umwelt</text><text x="110" y="235" text-anchor="middle" fill="#e9d5ff" font-size="9">~2.5%</text><rect x="180" y="190" width="120" height="60" rx="8" fill="#9333ea"/><text x="240" y="215" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Sozial</text><text x="240" y="235" text-anchor="middle" fill="#e9d5ff" font-size="9">~2.5%</text><rect x="310" y="190" width="160" height="60" rx="8" fill="#a855f7"/><text x="390" y="212" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Medien/Programm</text><text x="390" y="229" text-anchor="middle" fill="#e9d5ff" font-size="9">TV, Radio, Presse</text><text x="390" y="243" text-anchor="middle" fill="#e9d5ff" font-size="8">Randform, nicht separat ausgewiesen</text></svg>' },
          {
            type: 'merke',
            title: 'Merke dir!',
            items: [
          ...
          },
          {
            ...
            title: 'Zusammenfassung',
            content: [
              '<strong>Sponsoring</strong> ist ein Kommunikationsinstrument, bei dem ein Sponsor Geld, Sachmittel oder Dienstleistungen bereitstellt und dafür kommunikative Nutzungsrechte erhält. Es basiert auf dem Prinzip von Leistung und Gegenleistung.',
              'Die wichtigsten <strong>Formen</strong> sind Sportsponsoring (~80%), Kultursponsoring (~15%), Umwelt- und Soziosponsoring (~5%) sowie Medien-/Programmsponsoring.',
              'Der <strong>Sponsor-Status</strong> reicht vom Exklusiv-Sponsor (einziger Sponsor) über Hauptsponsor und Co-Sponsor bis zum Official Supplier.',
              'Drei <strong>Hauptzielsetzungen</strong>: Unternehmenskommunikationsziele (Bekanntheit, Image), Produkt-/Markenziele (Umsatz) und Beziehungsziele (Kundenloyalität).',
              'Sponsoring braucht <strong>flankierende Massnahmen</strong> (Mediawerbung, VKF, PR) und eine sorgfältige <strong>Kontrolle</strong> von Exposition, Erinnerung, Image und Verhaltenswirkung.',
              'Im Gegensatz zum <strong>Mäzenatentum</strong> erwartet der Sponsor eine Gegenleistung für sein Engagement.'
            ]
          },
          {
            type: 'keyterms',
    ...
    // ============================================================
    {
      id: 'ch7', pageStart: 138, pageEnd: 147, num: 'Teil A – Kapitel 7', title: 'Dialogmarketing',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Die 3R des Dialogmarketings', svg: '<svg viewBox="0 0 700 250" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="dm-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#9333ea"/></marker></defs><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Die 3R-Funktionen des Dialogmarketings</text><rect x="20" y="55" width="200" height="120" rx="10" fill="#9333ea"/><text x="120" y="85" text-anchor="middle" fill="#fff" font-size="22" font-weight="bold">R</text><text x="120" y="108" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Recruitment</text><text x="120" y="128" text-anchor="middle" fill="#e9d5ff" font-size="9">Kundengewinnung</text><text x="120" y="143" text-anchor="middle" fill="#e9d5ff" font-size="9">Interessenten ansprechen</text><text x="120" y="158" text-anchor="middle" fill="#e9d5ff" font-size="9">Neukunden akquirieren</text><line x1="220" y1="115" x2="248" y2="115" stroke="#9333ea" stroke-width="2.5" marker-end="url(#dm-arr)"/><rect x="250" y="55" width="200" height="120" rx="10" fill="#7e22ce"/><text x="350" y="85" text-anchor="middle" fill="#fff" font-size="22" font-weight="bold">R</text><text x="350" y="108" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Retention</text><text x="350" y="128" text-anchor="middle" fill="#e9d5ff" font-size="9">Kundenbindung</text><text x="350" y="143" text-anchor="middle" fill="#e9d5ff" font-size="9">Stammkunden aktivieren</text><text x="350" y="158" text-anchor="middle" fill="#e9d5ff" font-size="9">Cross-Selling nutzen</text><line x1="450" y1="115" x2="478" y2="115" stroke="#9333ea" stroke-width="2.5" marker-end="url(#dm-arr)"/><rect x="480" y="55" width="200" height="120" rx="10" fill="#581c87"/><text x="580" y="85" text-anchor="middle" fill="#fff" font-size="22" font-weight="bold">R</text><text x="580" y="108" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Recovery</text><text x="580" y="128" text-anchor="middle" fill="#e9d5ff" font-size="9">Kundenr\u00fcckgewinnung</text><text x="580" y="143" text-anchor="middle" fill="#e9d5ff" font-size="9">Ehemalige reaktivieren</text><text x="580" y="158" text-anchor="middle" fill="#e9d5ff" font-size="9">Neue Begeisterung</text><rect x="20" y="195" width="660" height="35" rx="6" fill="#faf5ff" stroke="#9333ea" stroke-width="1"/><text x="350" y="217" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Es ist ca. 7\u00d7 leichter, einen Stammkunden zum Kauf zu bewegen als einen Neukunden zu gewinnen</text></svg>' },
          {
            type: 'table',
          ...
          { type: 'svg', title: '4 Strategien des Dialogmarketings', svg: '<svg viewBox="0 0 700 220" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">4 Strategien des Dialogmarketings</text><rect x="20" y="50" width="155" height="150" rx="8" fill="#9333ea"/><text x="97" y="80" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Akquisition</text><line x1="40" y1="92" x2="155" y2="92" stroke="#e9d5ff" stroke-width="0.5"/><text x="97" y="112" text-anchor="middle" fill="#e9d5ff" font-size="9">Neukunden</text><text x="97" y="127" text-anchor="middle" fill="#e9d5ff" font-size="9">gewinnen</text><text x="97" y="147" text-anchor="middle" fill="#e9d5ff" font-size="9">Kontakt herstellen</text><text x="97" y="162" text-anchor="middle" fill="#e9d5ff" font-size="9">Interesse wecken</text><rect x="190" y="50" width="155" height="150" rx="8" fill="#7e22ce"/><text x="267" y="80" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Information</text><line x1="210" y1="92" x2="325" y2="92" stroke="#e9d5ff" stroke-width="0.5"/><text x="267" y="112" text-anchor="middle" fill="#e9d5ff" font-size="9">Kunden \u00fcber neue</text><text x="267" y="127" text-anchor="middle" fill="#e9d5ff" font-size="9">Produkte informieren</text><text x="267" y="147" text-anchor="middle" fill="#e9d5ff" font-size="9">Preisinfos</text><text x="267" y="162" text-anchor="middle" fill="#e9d5ff" font-size="9">vermitteln</text><rect x="360" y="50" width="155" height="150" rx="8" fill="#6b21a8"/><text x="437" y="80" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Betreuung</text><line x1="380" y1="92" x2="495" y2="92" stroke="#e9d5ff" stroke-width="0.5"/><text x="437" y="112" text-anchor="middle" fill="#e9d5ff" font-size="9">Kontakte pflegen</text><text x="437" y="127" text-anchor="middle" fill="#e9d5ff" font-size="9">Kundenbindung</text><text x="437" y="147" text-anchor="middle" fill="#e9d5ff" font-size="9">erh\u00f6hen</text><text x="437" y="162" text-anchor="middle" fill="#e9d5ff" font-size="9">Cross-Selling</text><rect x="530" y="50" width="155" height="150" rx="8" fill="#581c87"/><text x="607" y="80" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Abverkauf</text><line x1="550" y1="92" x2="665" y2="92" stroke="#e9d5ff" stroke-width="0.5"/><text x="607" y="112" text-anchor="middle" fill="#e9d5ff" font-size="9">Direkt zum Kauf</text><text x="607" y="127" text-anchor="middle" fill="#e9d5ff" font-size="9">bewegen</text><text x="607" y="147" text-anchor="middle" fill="#e9d5ff" font-size="9">Kataloge, E-Mail</text><text x="607" y="162" text-anchor="middle" fill="#e9d5ff" font-size="9">mit Bestell-Option</text></svg>' },
          {
            type: 'merke',
            title: 'Merke dir!',
            items: [
          ...
          },
          {
            ...
            title: 'Zusammenfassung',
            content: [
              '<strong>Dialogmarketing</strong> umfasst sämtliche Kommunikationsmassnahmen zur gezielten Einzelansprache und zum Aufbau eines direkten Dialogs mit dem Kunden. Es entwickelte sich aus dem klassischen Direktmarketing zum modernen CRM-Instrument.',
    ...
    // ============================================================
    {
      id: 'ch8', pageStart: 148, pageEnd: 160, num: 'Teil A – Kapitel 8', title: 'Social Media',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: '6 Formen der digitalen Kommunikation', svg: '<svg viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">6 Formen der digitalen Kommunikation</text><rect x="20" y="50" width="210" height="90" rx="8" fill="#9333ea"/><text x="35" y="75" fill="#fff" font-size="22" font-weight="bold">1</text><text x="60" y="78" fill="#fff" font-size="12" font-weight="bold">Eigene Website</text><text x="60" y="95" fill="#e9d5ff" font-size="9">Kern aller Online-Aktivit\u00e4ten</text><text x="60" y="110" fill="#e9d5ff" font-size="9">Usability im Vordergrund</text><rect x="245" y="50" width="210" height="90" rx="8" fill="#7e22ce"/><text x="260" y="75" fill="#fff" font-size="22" font-weight="bold">2</text><text x="285" y="78" fill="#fff" font-size="12" font-weight="bold">Suchmaschinenmarketing</text><text x="285" y="95" fill="#e9d5ff" font-size="9">SEO (organisch)</text><text x="285" y="110" fill="#e9d5ff" font-size="9">SEA (bezahlte Anzeigen)</text><rect x="470" y="50" width="210" height="90" rx="8" fill="#6b21a8"/><text x="485" y="75" fill="#fff" font-size="22" font-weight="bold">3</text><text x="510" y="78" fill="#fff" font-size="12" font-weight="bold">Social Media</text><text x="510" y="95" fill="#e9d5ff" font-size="9">Instagram, Facebook, TikTok</text><text x="510" y="110" fill="#e9d5ff" font-size="9">LinkedIn, YouTube</text><rect x="20" y="160" width="210" height="90" rx="8" fill="#581c87"/><text x="35" y="185" fill="#fff" font-size="22" font-weight="bold">4</text><text x="60" y="188" fill="#fff" font-size="12" font-weight="bold">E-Mail-Marketing</text><text x="60" y="205" fill="#e9d5ff" font-size="9">Individuelle Ansprache</text><text x="60" y="220" fill="#e9d5ff" font-size="9">Messbare Response</text><rect x="245" y="160" width="210" height="90" rx="8" fill="#6b21a8"/><text x="260" y="185" fill="#fff" font-size="22" font-weight="bold">5</text><text x="285" y="188" fill="#fff" font-size="12" font-weight="bold">Newsletter</text><text x="285" y="205" fill="#e9d5ff" font-size="9">Regelm\u00e4ssige Information</text><text x="285" y="220" fill="#e9d5ff" font-size="9">Kundenbindung</text><rect x="470" y="160" width="210" height="90" rx="8" fill="#7e22ce"/><text x="485" y="185" fill="#fff" font-size="22" font-weight="bold">6</text><text x="510" y="188" fill="#fff" font-size="12" font-weight="bold">Display-Werbung</text><text x="510" y="205" fill="#e9d5ff" font-size="9">Banner, Pop-ups</text><text x="510" y="220" fill="#e9d5ff" font-size="9">Visuelle Formate</text></svg>' },
          {
            type: 'concept',
          ...
          { type: 'svg', title: 'SEO vs. SEA im Vergleich', svg: '<svg viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">SEO vs. SEA im Vergleich</text><rect x="20" y="50" width="320" height="210" rx="10" fill="#9333ea"/><text x="180" y="80" text-anchor="middle" fill="#fff" font-size="15" font-weight="bold">SEO</text><text x="180" y="98" text-anchor="middle" fill="#e9d5ff" font-size="10">Search Engine Optimization</text><rect x="35" y="112" width="290" height="28" rx="5" fill="rgba(255,255,255,.15)"/><text x="180" y="131" text-anchor="middle" fill="#fff" font-size="10">Organische Suchresultate</text><rect x="35" y="148" width="290" height="28" rx="5" fill="rgba(255,255,255,.15)"/><text x="180" y="167" text-anchor="middle" fill="#fff" font-size="10">Fixkosten (Optimierung, Agentur)</text><rect x="35" y="184" width="290" height="28" rx="5" fill="rgba(255,255,255,.15)"/><text x="180" y="203" text-anchor="middle" fill="#fff" font-size="10">Keywords in Titeln, Texten, Bildern</text><rect x="35" y="220" width="290" height="28" rx="5" fill="rgba(255,255,255,.15)"/><text x="180" y="239" text-anchor="middle" fill="#fff" font-size="10">Langfristige, nachhaltige Wirkung</text><rect x="360" y="50" width="320" height="210" rx="10" fill="#581c87"/><text x="520" y="80" text-anchor="middle" fill="#fff" font-size="15" font-weight="bold">SEA</text><text x="520" y="98" text-anchor="middle" fill="#e9d5ff" font-size="10">Search Engine Advertising</text><rect x="375" y="112" width="290" height="28" rx="5" fill="rgba(255,255,255,.15)"/><text x="520" y="131" text-anchor="middle" fill="#fff" font-size="10">Bezahlte Anzeigen (Adwords)</text><rect x="375" y="148" width="290" height="28" rx="5" fill="rgba(255,255,255,.15)"/><text x="520" y="167" text-anchor="middle" fill="#fff" font-size="10">Variable Kosten (pro Klick)</text><rect x="375" y="184" width="290" height="28" rx="5" fill="rgba(255,255,255,.15)"/><text x="520" y="203" text-anchor="middle" fill="#fff" font-size="10">Anzeigen auf Suchergebnis-Seiten</text><rect x="375" y="220" width="290" height="28" rx="5" fill="rgba(255,255,255,.15)"/><text x="520" y="239" text-anchor="middle" fill="#fff" font-size="10">Sofortige Sichtbarkeit, kurzfristig</text></svg>' },
          {
            type: 'merke',
            title: 'Merke dir!',
            items: [
          ...
          },
          {
            ...
            title: 'Zusammenfassung',
            content: [
              'Die <strong>eigene Website</strong> ist der Kern der meisten Online-Marketing-Aktivitäten. Usability, Content und Suchmaschinenfreundlichkeit sind entscheidend.',
              '<strong>Suchmaschinenmarketing</strong> umfasst SEO (organische Optimierung) und SEA (bezahlte Anzeigen/Adwords). Beide sollten kombiniert werden.',
              '<strong>Social-Media-Kommunikation</strong> ermöglicht den direkten Austausch mit Zielgruppen über Plattformen wie Instagram, Facebook, TikTok, LinkedIn und YouTube.',
              'Eine <strong>Social-Media-Strategie</strong> erfordert klare Ziele, die richtige Plattformwahl, regelmässigen Content und aktive Interaktion.',
              'Wichtige <strong>Kennzahlen</strong> sind Interaktion, Reichweite, Follower, Impressionen, Mentions und Shares. Google Analytics bietet umfassende Kontrollmöglichkeiten.',
              'Bei <strong>Shitstorms</strong> ist transparente, ehrliche Kommunikation gefragt — Kommentare löschen oder den Kanal schliessen sind keine Lösung.'
            ]
          },
          {
            type: 'keyterms',
    ...
    // ============================================================
    {
      id: 'ch9', pageStart: 162, pageEnd: 179, num: 'Teil B – Kapitel 9', title: 'Kommunikationsforschung',
      exercises: [
        {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Kommunikationsforschung: Pre-Test und Post-Test', svg: '<svg viewBox="0 0 700 250" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="kf-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#9333ea"/></marker></defs><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Kommunikationsforschung im Zeitverlauf</text><rect x="20" y="55" width="200" height="80" rx="8" fill="#9333ea"/><text x="120" y="85" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Pre-Test</text><text x="120" y="103" text-anchor="middle" fill="#e9d5ff" font-size="9">Vor der Schaltung</text><text x="120" y="118" text-anchor="middle" fill="#e9d5ff" font-size="9">Optimierung der Werbemittel</text><line x1="220" y1="95" x2="248" y2="95" stroke="#9333ea" stroke-width="2" marker-end="url(#kf-arr)"/><rect x="250" y="55" width="200" height="80" rx="8" fill="#7e22ce"/><text x="350" y="85" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Tracking-Studie</text><text x="350" y="103" text-anchor="middle" fill="#e9d5ff" font-size="9">W\u00e4hrend der Schaltung</text><text x="350" y="118" text-anchor="middle" fill="#e9d5ff" font-size="9">Fortlaufende Befragungen</text><line x1="450" y1="95" x2="478" y2="95" stroke="#9333ea" stroke-width="2" marker-end="url(#kf-arr)"/><rect x="480" y="55" width="200" height="80" rx="8" fill="#581c87"/><text x="580" y="85" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Post-Test</text><text x="580" y="103" text-anchor="middle" fill="#e9d5ff" font-size="9">Nach der Schaltung</text><text x="580" y="118" text-anchor="middle" fill="#e9d5ff" font-size="9">Erfolgskontrolle</text><rect x="20" y="155" width="660" height="35" rx="6" fill="#faf5ff" stroke="#9333ea" stroke-width="1"/><text x="350" y="177" text-anchor="middle" fill="#581c87" font-size="10" font-weight="bold">Messfaktoren: Stimulationsleistung \u00b7 Informationsleistung \u00b7 Persuasionsleistung</text><rect x="20" y="200" width="320" height="30" rx="6" fill="#ede9fe"/><text x="180" y="220" text-anchor="middle" fill="#6b21a8" font-size="10">Werbewirkung = kommunikative Wirkung</text><rect x="360" y="200" width="320" height="30" rx="6" fill="#ede9fe"/><text x="520" y="220" text-anchor="middle" fill="#6b21a8" font-size="10">Werbeerfolg = \u00f6konomische Wirkung</text></svg>' },
          {
            type: 'concept',
          ...
          { type: 'svg', title: 'Recall-Stufen: Von spontan bis gestützt', svg: '<svg viewBox="0 0 700 300" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="28" text-anchor="middle" fill="#581c87" font-size="16" font-weight="bold">Recall-Stufen der Erinnerungsmessung</text><rect x="50" y="50" width="600" height="50" rx="8" fill="#581c87"/><text x="350" y="72" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Spontaneous Recall – Spontane Erinnerung</text><text x="350" y="88" text-anchor="middle" fill="#e9d5ff" font-size="9">Ohne jede Hilfestellung, rein aus dem Ged\u00e4chtnis</text><rect x="100" y="110" width="500" height="50" rx="8" fill="#6b21a8"/><text x="350" y="132" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Unaided Recall – Nicht unterst\u00fctzte Erinnerung</text><text x="350" y="148" text-anchor="middle" fill="#e9d5ff" font-size="9">Produktkategorie wird genannt, keine weiteren Hilfen</text><rect x="150" y="170" width="400" height="50" rx="8" fill="#7e22ce"/><text x="350" y="192" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Prompted Recall – Angest\u00fctzte Erinnerung</text><text x="350" y="208" text-anchor="middle" fill="#e9d5ff" font-size="9">Hinweise auf Marke oder Medium werden gegeben</text><rect x="200" y="230" width="300" height="50" rx="8" fill="#9333ea"/><text x="350" y="252" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Aided Recall – Gest\u00fctzte Erinnerung</text><text x="350" y="268" text-anchor="middle" fill="#e9d5ff" font-size="9">Vorlage von Marken-/Anzeigenlisten</text><text x="30" y="160" fill="#581c87" font-size="10" font-weight="bold" transform="rotate(-90,30,160)">H\u00f6here Erinnerungsleistung</text><text x="680" y="160" fill="#9333ea" font-size="10" font-weight="bold" transform="rotate(90,680,160)">Mehr Unterst\u00fctzung</text></svg>' },
          {
            type: 'table',
          ...
          },
          {
            ...
            title: 'Zusammenfassung',
            content: [
              'Die <strong>Kommunikationsforschung</strong> liefert die Grundlage für den Effizienznachweis des Kommunikationsbudgets. Sie unterteilt sich in Pretesting (vor der Schaltung) und Posttesting (nach der Schaltung).',
              '<strong>Recall</strong> (aktive Erinnerung) und <strong>Recognition</strong> (passives Wiedererkennen) sind die zentralen Messgrössen. Die Recall-Stufen reichen von spontaner bis zur gestützten Erinnerung.',
              'Wichtige <strong>Verfahren</strong> sind Folder Tests, Studiotests, Tachistoskop-Tests, Attention Tracking, Copy Tests und Trackingstudien.',
              '<strong>Mediastudien</strong> wie MACH Basic, MACH Consumer und MA Leader erforschen die Mediennutzung und das Konsumverhalten der Schweizer Bevölkerung.',
              'Die <strong>Werbewirkung</strong> (kommunikative Wirkung: Wahrnehmung, Erinnerung) ist die Voraussetzung für den <strong>Werbeerfolg</strong> (ökonomische Wirkung: Umsatz, Absatz, Marktanteil).'
            ]
          },
          {
            type: 'keyterms',
