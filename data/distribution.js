    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Die drei Instrumente der Distribution',
            svg: '<svg viewBox="0 0 700 200" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Die drei Instrumente der Distribution</text><rect x="20" y="45" width="200" height="90" rx="10" fill="#ea580c"/><text x="120" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Strategische</text><text x="120" y="90" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Distribution</text><text x="120" y="112" text-anchor="middle" fill="#fed7aa" font-size="9">Bestimmung des</text><text x="120" y="124" text-anchor="middle" fill="#fed7aa" font-size="9">Absatzwegs</text><rect x="250" y="45" width="200" height="90" rx="10" fill="#ea580c"/><text x="350" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Physische</text><text x="350" y="90" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Distribution</text><text x="350" y="112" text-anchor="middle" fill="#fed7aa" font-size="9">Festlegung der</text><text x="350" y="124" text-anchor="middle" fill="#fed7aa" font-size="9">Logistik-Infrastruktur</text><rect x="480" y="45" width="200" height="90" rx="10" fill="#ea580c"/><text x="580" y="80" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Standortwahl</text><text x="580" y="102" text-anchor="middle" fill="#fed7aa" font-size="9">Evaluation des Orts</text><text x="580" y="114" text-anchor="middle" fill="#fed7aa" font-size="9">der Warenübergabe</text><rect x="150" y="155" width="400" height="30" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="350" y="175" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="600">Übergreifend: Serviceniveau als verbindendes Element</text></svg>'
          },
          {
            type: 'concept',
          ...
          {
            type: 'svg',
            title: 'Die 5 Distributionsflüsse (Ströme)',
            svg: '<svg viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="df-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#ea580c"/></marker></defs><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Die 5 Distributionsflüsse</text><rect x="20" y="50" width="120" height="200" rx="10" fill="#ea580c"/><text x="80" y="140" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Produktion</text><text x="80" y="158" text-anchor="middle" fill="#fed7aa" font-size="9">(Hersteller)</text><rect x="560" y="50" width="120" height="200" rx="10" fill="#ea580c"/><text x="620" y="140" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Konsumation</text><text x="620" y="158" text-anchor="middle" fill="#fed7aa" font-size="9">(Endkunde)</text><line x1="145" y1="75" x2="555" y2="75" stroke="#ea580c" stroke-width="2" marker-end="url(#df-arr)"/><rect x="250" y="62" width="200" height="26" rx="5" fill="#fff7ed" stroke="#ea580c" stroke-width="1"/><text x="350" y="80" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="600">1. Warenfluss</text><line x1="145" y1="115" x2="555" y2="115" stroke="#f97316" stroke-width="2" marker-end="url(#df-arr)"/><rect x="250" y="102" width="200" height="26" rx="5" fill="#fff7ed" stroke="#f97316" stroke-width="1"/><text x="350" y="120" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="600">2. Geldfluss</text><line x1="145" y1="155" x2="555" y2="155" stroke="#fb923c" stroke-width="2" marker-end="url(#df-arr)"/><rect x="250" y="142" width="200" height="26" rx="5" fill="#fff7ed" stroke="#fb923c" stroke-width="1"/><text x="350" y="160" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="600">3. Informationsfluss</text><line x1="145" y1="195" x2="555" y2="195" stroke="#fdba74" stroke-width="2" marker-end="url(#df-arr)"/><rect x="250" y="182" width="200" height="26" rx="5" fill="#fff7ed" stroke="#fdba74" stroke-width="1"/><text x="350" y="200" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="600">4. Eigentumsfluss</text><line x1="145" y1="235" x2="555" y2="235" stroke="#fed7aa" stroke-width="2" marker-end="url(#df-arr)"/><rect x="250" y="222" width="200" height="26" rx="5" fill="#fff7ed" stroke="#fed7aa" stroke-width="1"/><text x="350" y="240" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="600">5. Kommunikationsfluss</text><text x="350" y="272" text-anchor="middle" fill="#78716c" font-size="10">Alle Flüsse verlaufen bidirektional zwischen Produktion und Konsumation</text></svg>'
          },
          {
            type: 'merke',
            title: 'Merke dir!',
    ...
    // ============================================================
    {
      ...
      exercises: [
        ...
        // Ex 20 — Distributionsgrad berechnen (Rep 12, S.61)
        {
          ...
          instruction: 'Berechnen Sie die numerische und gewichtete Distribution anhand folgender Angaben:\n\n• Kanal: Coop (Schweiz)\n• Verkaufsstellen (VS) insgesamt: 900\n• VS, die «Cementit» führen: 360\n• Umsatz aller VS mit Leim (Warengruppe): CHF 12 Mio.\n• Umsatz der VS mit «Cementit» in der Warengruppe Leim: CHF 6 Mio.\n• Umsatz «Cementit» in der Schweiz: CHF 3 Mio.',
          fields: [
            {label:'Numerische Distribution (in %)', answer:40, tolerance:1},
            {label:'Gewichtete Distribution (in %)', answer:50, tolerance:1}
          ],
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Die 12 Strategieschritte des Distributionskonzepts',
            svg: '<svg viewBox="0 0 700 340" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Die 12 Strategieschritte des Distributionskonzepts</text><rect x="20" y="45" width="155" height="55" rx="8" fill="#ea580c"/><text x="97" y="67" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">1. Distributionsweg</text><text x="97" y="82" text-anchor="middle" fill="#fed7aa" font-size="8">direkt / indirekt</text><rect x="185" y="45" width="155" height="55" rx="8" fill="#ea580c"/><text x="262" y="67" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">2. Distributionsorgane</text><text x="262" y="82" text-anchor="middle" fill="#fed7aa" font-size="8">intern / extern</text><rect x="350" y="45" width="155" height="55" rx="8" fill="#ea580c"/><text x="427" y="67" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">3. Distributionstechniken</text><text x="427" y="82" text-anchor="middle" fill="#fed7aa" font-size="8">AD / ID / Internet</text><rect x="515" y="45" width="165" height="55" rx="8" fill="#ea580c"/><text x="597" y="67" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">4. Distributionsfeld</text><text x="597" y="82" text-anchor="middle" fill="#fed7aa" font-size="8">geografisch</text><rect x="20" y="115" width="155" height="55" rx="8" fill="#f97316"/><text x="97" y="137" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">5. Dezentralisierung</text><text x="97" y="152" text-anchor="middle" fill="#fed7aa" font-size="8">Anzahl Stufen</text><rect x="185" y="115" width="155" height="55" rx="8" fill="#f97316"/><text x="262" y="137" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">6. Kanalwahl</text><text x="262" y="152" text-anchor="middle" fill="#fed7aa" font-size="8">Absatz-/Handelskanäle</text><rect x="350" y="115" width="155" height="55" rx="8" fill="#f97316"/><text x="427" y="137" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">7. Differenzierung</text><text x="427" y="152" text-anchor="middle" fill="#fed7aa" font-size="8">int. / sel. / exkl.</text><rect x="515" y="115" width="165" height="55" rx="8" fill="#f97316"/><text x="597" y="137" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">8. Distributionsziele</text><text x="597" y="152" text-anchor="middle" fill="#fed7aa" font-size="8">operativ</text><rect x="20" y="185" width="155" height="55" rx="8" fill="#fb923c"/><text x="97" y="207" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">9. Rationalisierung</text><text x="97" y="222" text-anchor="middle" fill="#fff" font-size="8">Logistik</text><rect x="185" y="185" width="155" height="55" rx="8" fill="#fb923c"/><text x="262" y="207" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">10. Bindung</text><text x="262" y="222" text-anchor="middle" fill="#fff" font-size="8">Kundenbindung</text><rect x="350" y="185" width="155" height="55" rx="8" fill="#fb923c"/><text x="427" y="207" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">11. POS-Massnahmen</text><text x="427" y="222" text-anchor="middle" fill="#fff" font-size="8">Einführung am POS</text><rect x="515" y="185" width="165" height="55" rx="8" fill="#fb923c"/><text x="597" y="207" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">12. Konkurrenzierung</text><text x="597" y="222" text-anchor="middle" fill="#fff" font-size="8">Wettbewerbsumfeld</text><rect x="100" y="265" width="500" height="50" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="350" y="285" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="bold">Strategieansatz = Herzstück des Distributionskonzepts</text><text x="350" y="302" text-anchor="middle" fill="#78716c" font-size="9">Alle 12 Schritte decken sämtliche strategischen Entscheidungen der Distribution ab</text></svg>'
          },
          {
            type: 'concept',
          ...
          {
            type: 'svg',
            title: 'Distributionsgrad: ND vs. GD',
            svg: '<svg viewBox="0 0 700 180" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Distributionsgrad: Numerisch (ND) vs. Gewichtet (GD)</text><rect x="30" y="50" width="300" height="55" rx="8" fill="#ea580c"/><text x="180" y="72" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">ND = Anzahl VS mit Produkt / Gesamt-VS × 100</text><text x="180" y="90" text-anchor="middle" fill="#fed7aa" font-size="9">= Präsenz (in wie vielen Läden?)</text><rect x="370" y="50" width="300" height="55" rx="8" fill="#f97316"/><text x="520" y="72" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">GD = Umsatz VS mit Prod. / Gesamt-Umsatz × 100</text><text x="520" y="90" text-anchor="middle" fill="#fed7aa" font-size="9">= Umsatzbedeutung (wie wichtig?)</text><rect x="130" y="125" width="200" height="35" rx="6" fill="#dcfce7" stroke="#16a34a" stroke-width="1.5"/><text x="230" y="147" text-anchor="middle" fill="#166534" font-size="10" font-weight="bold">GD > ND → umsatzstark</text><rect x="370" y="125" width="200" height="35" rx="6" fill="#fef2f2" stroke="#dc2626" stroke-width="1.5"/><text x="470" y="147" text-anchor="middle" fill="#991b1b" font-size="10" font-weight="bold">GD &lt; ND → umsatzschwach</text></svg>'
          },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Funktionen des Handels',
            svg: '<svg viewBox="0 0 700 200" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Funktionen des Handels</text><text x="200" y="55" text-anchor="middle" fill="#ea580c" font-size="11" font-weight="bold">Hauptfunktionen</text><rect x="30" y="70" width="130" height="50" rx="8" fill="#ea580c"/><text x="95" y="92" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Warenbündelung</text><text x="95" y="107" text-anchor="middle" fill="#fed7aa" font-size="8">Sortimentsbildung</text><rect x="170" y="70" width="130" height="50" rx="8" fill="#ea580c"/><text x="235" y="87" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Raum-</text><text x="235" y="100" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">überbrückung</text><text x="235" y="113" text-anchor="middle" fill="#fed7aa" font-size="8">Transport</text><rect x="310" y="70" width="130" height="50" rx="8" fill="#f97316"/><text x="375" y="87" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Zeit-</text><text x="375" y="100" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">überbrückung</text><text x="375" y="113" text-anchor="middle" fill="#fed7aa" font-size="8">Lagerhaltung</text><text x="595" y="55" text-anchor="middle" fill="#fb923c" font-size="11" font-weight="bold">Zusatzfunktionen</text><rect x="490" y="70" width="100" height="50" rx="8" fill="#fb923c"/><text x="540" y="100" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Beratung</text><rect x="600" y="70" width="80" height="50" rx="8" fill="#fdba74"/><text x="640" y="92" text-anchor="middle" fill="#7c2d12" font-size="9" font-weight="bold">Finanzierung</text><text x="640" y="107" text-anchor="middle" fill="#7c2d12" font-size="8">+ Werbung</text><rect x="100" y="145" width="500" height="35" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="350" y="168" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="bold">Handel überbrückt räumliche, zeitliche und quantitative Spannungen</text></svg>'
          },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Bereiche der physischen Distribution (Marketinglogistik)',
            svg: '<svg viewBox="0 0 700 220" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="pd-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#ea580c"/></marker></defs><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Bereiche der Marketinglogistik</text><rect x="20" y="50" width="120" height="70" rx="8" fill="#ea580c"/><text x="80" y="80" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Auftragswesen</text><text x="80" y="95" text-anchor="middle" fill="#fed7aa" font-size="8">Informationsfluss</text><text x="80" y="108" text-anchor="middle" fill="#fed7aa" font-size="8">Steuerung</text><line x1="145" y1="85" x2="165" y2="85" stroke="#ea580c" stroke-width="2" marker-end="url(#pd-arr)"/><rect x="170" y="50" width="120" height="70" rx="8" fill="#f97316"/><text x="230" y="80" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Fertiglager</text><text x="230" y="95" text-anchor="middle" fill="#fed7aa" font-size="8">Lagerhaltung</text><text x="230" y="108" text-anchor="middle" fill="#fed7aa" font-size="8">Kommissionierung</text><line x1="295" y1="85" x2="315" y2="85" stroke="#ea580c" stroke-width="2" marker-end="url(#pd-arr)"/><rect x="320" y="50" width="120" height="70" rx="8" fill="#fb923c"/><text x="380" y="80" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Transport</text><text x="380" y="95" text-anchor="middle" fill="#fff" font-size="8">Auslieferung</text><text x="380" y="108" text-anchor="middle" fill="#fff" font-size="8">Strasse/Schiene/Luft</text><line x1="445" y1="85" x2="465" y2="85" stroke="#ea580c" stroke-width="2" marker-end="url(#pd-arr)"/><rect x="470" y="50" width="100" height="70" rx="8" fill="#fdba74"/><text x="520" y="80" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Verpackung</text><text x="520" y="95" text-anchor="middle" fill="#7c2d12" font-size="8">Palettierung</text><text x="520" y="108" text-anchor="middle" fill="#7c2d12" font-size="8">Stapelbarkeit</text><line x1="575" y1="85" x2="595" y2="85" stroke="#ea580c" stroke-width="2" marker-end="url(#pd-arr)"/><rect x="600" y="50" width="80" height="70" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="640" y="80" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Entsorgung</text><text x="640" y="95" text-anchor="middle" fill="#7c2d12" font-size="8">Recycling</text><text x="640" y="108" text-anchor="middle" fill="#7c2d12" font-size="8">Rücknahme</text><rect x="80" y="150" width="250" height="50" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="205" y="172" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="bold">Ziel Unternehmen</text><text x="205" y="188" text-anchor="middle" fill="#78716c" font-size="9">Tiefe Kosten</text><rect x="370" y="150" width="250" height="50" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="495" y="172" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="bold">Ziel Markt</text><text x="495" y="188" text-anchor="middle" fill="#78716c" font-size="9">Hohes Serviceniveau</text><text x="350" y="215" text-anchor="middle" fill="#dc2626" font-size="10" font-weight="bold">= Zielkonflikt</text></svg>'
          },
          {
            type: 'concept',
          ...
          {
            type: 'svg',
            title: 'Logistikkonzepte: Cross Docking, JIT, VMI, Outsourcing',
            svg: '<svg viewBox="0 0 700 250" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Moderne Logistikkonzepte</text><rect x="20" y="50" width="155" height="80" rx="10" fill="#ea580c"/><text x="97" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Cross Docking</text><text x="97" y="93" text-anchor="middle" fill="#fed7aa" font-size="8">Umschlag ohne</text><text x="97" y="105" text-anchor="middle" fill="#fed7aa" font-size="8">Einlagerung</text><text x="97" y="120" text-anchor="middle" fill="#fff" font-size="8">WE → direkt → WA</text><rect x="190" y="50" width="155" height="80" rx="10" fill="#f97316"/><text x="267" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Just in Time (JIT)</text><text x="267" y="93" text-anchor="middle" fill="#fed7aa" font-size="8">Lieferung zum</text><text x="267" y="105" text-anchor="middle" fill="#fed7aa" font-size="8">richtigen Zeitpunkt</text><text x="267" y="120" text-anchor="middle" fill="#fff" font-size="8">Minimale Lagerhaltung</text><rect x="360" y="50" width="155" height="80" rx="10" fill="#fb923c"/><text x="437" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">VMI</text><text x="437" y="93" text-anchor="middle" fill="#fff" font-size="8">Vendor Managed</text><text x="437" y="105" text-anchor="middle" fill="#fff" font-size="8">Inventory</text><text x="437" y="120" text-anchor="middle" fill="#fff" font-size="8">Lieferant verwaltet</text><rect x="530" y="50" width="150" height="80" rx="10" fill="#fdba74" stroke="#ea580c" stroke-width="1.5"/><text x="605" y="75" text-anchor="middle" fill="#7c2d12" font-size="11" font-weight="bold">Outsourcing</text><text x="605" y="93" text-anchor="middle" fill="#7c2d12" font-size="8">Auslagerung an</text><text x="605" y="105" text-anchor="middle" fill="#7c2d12" font-size="8">Dritte (3PL)</text><text x="605" y="120" text-anchor="middle" fill="#7c2d12" font-size="8">Variable Kosten</text><rect x="60" y="155" width="280" height="35" rx="6" fill="#dcfce7" stroke="#16a34a" stroke-width="1.5"/><text x="200" y="177" text-anchor="middle" fill="#166534" font-size="10" font-weight="600">Vorteile: Effizienz, tiefere Kosten, Flexibilität</text><rect x="360" y="155" width="280" height="35" rx="6" fill="#fef2f2" stroke="#dc2626" stroke-width="1.5"/><text x="500" y="177" text-anchor="middle" fill="#991b1b" font-size="10" font-weight="600">Risiken: Abhängigkeit, Kontrollverlust</text><text x="350" y="225" text-anchor="middle" fill="#78716c" font-size="10">Alle Konzepte zielen auf Optimierung des Zielkonflikts Kosten vs. Serviceniveau</text></svg>'
          },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Digitale Technologien in der Distribution',
            svg: '<svg viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Digitale Technologien in der Distribution</text><rect x="20" y="50" width="125" height="90" rx="10" fill="#ea580c"/><text x="82" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">GTIN / EAN</text><text x="82" y="93" text-anchor="middle" fill="#fed7aa" font-size="8">Strichcode</text><text x="82" y="106" text-anchor="middle" fill="#fed7aa" font-size="8">Warenidentifikation</text><text x="82" y="130" text-anchor="middle" fill="#fff" font-size="8">Lager + Kasse</text><rect x="155" y="50" width="125" height="90" rx="10" fill="#f97316"/><text x="217" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">QR-Code</text><text x="217" y="93" text-anchor="middle" fill="#fed7aa" font-size="8">2D-Code</text><text x="217" y="106" text-anchor="middle" fill="#fed7aa" font-size="8">Mehr Infos als EAN</text><text x="217" y="130" text-anchor="middle" fill="#fff" font-size="8">Marketing + Info</text><rect x="290" y="50" width="125" height="90" rx="10" fill="#fb923c"/><text x="352" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">EDI</text><text x="352" y="93" text-anchor="middle" fill="#fff" font-size="8">Electronic Data</text><text x="352" y="106" text-anchor="middle" fill="#fff" font-size="8">Interchange</text><text x="352" y="130" text-anchor="middle" fill="#fff" font-size="8">Automatisierung</text><rect x="425" y="50" width="125" height="90" rx="10" fill="#fdba74"/><text x="487" y="75" text-anchor="middle" fill="#7c2d12" font-size="11" font-weight="bold">ECR</text><text x="487" y="93" text-anchor="middle" fill="#7c2d12" font-size="8">Efficient Consumer</text><text x="487" y="106" text-anchor="middle" fill="#7c2d12" font-size="8">Response</text><text x="487" y="130" text-anchor="middle" fill="#7c2d12" font-size="8">Sortimentsoptimierung</text><rect x="560" y="50" width="120" height="90" rx="10" fill="#ea580c"/><text x="620" y="75" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">RFID</text><text x="620" y="93" text-anchor="middle" fill="#fed7aa" font-size="8">Funk-Chip</text><text x="620" y="106" text-anchor="middle" fill="#fed7aa" font-size="8">Kontaktlose Erfassung</text><text x="620" y="130" text-anchor="middle" fill="#fff" font-size="8">Warenflusssteuerung</text><rect x="80" y="170" width="540" height="40" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="350" y="195" text-anchor="middle" fill="#9a3412" font-size="11" font-weight="bold">Ziel: Automatisierung → Effizienzsteigerung → tiefere Fehlerquote → Kostensenkung</text><rect x="80" y="230" width="250" height="35" rx="6" fill="#dcfce7" stroke="#16a34a" stroke-width="1.5"/><text x="205" y="252" text-anchor="middle" fill="#166534" font-size="9" font-weight="600">Heute Standard: GTIN, QR, EDI</text><rect x="370" y="230" width="250" height="35" rx="6" fill="#fef9c3" stroke="#ca8a04" stroke-width="1.5"/><text x="495" y="252" text-anchor="middle" fill="#854d0e" font-size="9" font-weight="600">Zukunft: RFID (noch hohe Kosten)</text></svg>'
          },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Standortkonzept – Strategieansatz',
            svg: '<svg viewBox="0 0 700 300" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="st-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#ea580c"/></marker></defs><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Standortkonzept – Strategieansatz</text><rect x="200" y="45" width="300" height="45" rx="8" fill="#ea580c"/><text x="350" y="72" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">1. Standortziele (operativ)</text><line x1="350" y1="90" x2="350" y2="108" stroke="#ea580c" stroke-width="2" marker-end="url(#st-arr)"/><rect x="200" y="112" width="300" height="45" rx="8" fill="#f97316"/><text x="350" y="139" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">2. Standorte: Anzahl (zentral/dezentral)</text><line x1="350" y1="157" x2="350" y2="175" stroke="#ea580c" stroke-width="2" marker-end="url(#st-arr)"/><rect x="200" y="179" width="300" height="45" rx="8" fill="#fb923c"/><text x="350" y="206" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">3. Sicht bestimmen (Marketing/Logistik)</text><line x1="350" y1="224" x2="350" y2="242" stroke="#ea580c" stroke-width="2" marker-end="url(#st-arr)"/><rect x="200" y="246" width="300" height="45" rx="8" fill="#fdba74" stroke="#ea580c" stroke-width="1.5"/><text x="350" y="273" text-anchor="middle" fill="#7c2d12" font-size="11" font-weight="bold">4. Definition Kriterien (Sollvorstellungen)</text><rect x="20" y="120" width="150" height="100" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1"/><text x="95" y="145" text-anchor="middle" fill="#9a3412" font-size="9" font-weight="bold">Kriterien B2C</text><text x="95" y="162" text-anchor="middle" fill="#78716c" font-size="8">Frequenz</text><text x="95" y="175" text-anchor="middle" fill="#78716c" font-size="8">Erreichbarkeit</text><text x="95" y="188" text-anchor="middle" fill="#78716c" font-size="8">Konkurrenzsituation</text><text x="95" y="201" text-anchor="middle" fill="#78716c" font-size="8">Psycholog. Marktnähe</text><rect x="530" y="120" width="150" height="100" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1"/><text x="605" y="145" text-anchor="middle" fill="#9a3412" font-size="9" font-weight="bold">Schnittstelle</text><text x="605" y="162" text-anchor="middle" fill="#78716c" font-size="8">Logistikkonzept</text><text x="605" y="175" text-anchor="middle" fill="#78716c" font-size="8">Serviceniveau</text><text x="605" y="188" text-anchor="middle" fill="#78716c" font-size="8">Kosten</text><text x="605" y="201" text-anchor="middle" fill="#78716c" font-size="8">Kundennähe</text></svg>'
          },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Direkter vs. indirekter Export',
            svg: '<svg viewBox="0 0 700 320" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="ex-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#ea580c"/></marker></defs><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Direkter vs. indirekter Export</text><text x="350" y="60" text-anchor="middle" fill="#ea580c" font-size="12" font-weight="bold">Direkter Export</text><rect x="40" y="75" width="120" height="45" rx="8" fill="#ea580c"/><text x="100" y="102" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Anbieter (CH)</text><line x1="165" y1="97" x2="285" y2="97" stroke="#ea580c" stroke-width="2" marker-end="url(#ex-arr)"/><text x="225" y="90" text-anchor="middle" fill="#ea580c" font-size="8" font-weight="600">Fakturierung</text><line x1="310" y1="75" x2="310" y2="120" stroke="#dc2626" stroke-width="2" stroke-dasharray="6,3"/><text x="310" y="68" text-anchor="middle" fill="#dc2626" font-size="9" font-weight="bold">GRENZE</text><rect x="330" y="75" width="140" height="45" rx="8" fill="#f97316"/><text x="400" y="95" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Kunde Ausland</text><text x="400" y="110" text-anchor="middle" fill="#fed7aa" font-size="8">(Importeur/Handel)</text><line x1="475" y1="97" x2="555" y2="97" stroke="#ea580c" stroke-width="2" marker-end="url(#ex-arr)"/><rect x="560" y="75" width="110" height="45" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="615" y="102" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Konsument</text><text x="260" y="140" text-anchor="middle" fill="#166534" font-size="9">Eigentum wechselt NACH der Grenze</text><text x="350" y="175" text-anchor="middle" fill="#ea580c" font-size="12" font-weight="bold">Indirekter Export</text><rect x="40" y="190" width="120" height="45" rx="8" fill="#ea580c"/><text x="100" y="217" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Anbieter (CH)</text><line x1="165" y1="212" x2="215" y2="212" stroke="#ea580c" stroke-width="2" marker-end="url(#ex-arr)"/><rect x="220" y="190" width="140" height="45" rx="8" fill="#f97316"/><text x="290" y="210" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Exporteur (CH)</text><text x="290" y="225" text-anchor="middle" fill="#fed7aa" font-size="8">(Inland-Kunde)</text><line x1="365" y1="212" x2="395" y2="212" stroke="#ea580c" stroke-width="2" marker-end="url(#ex-arr)"/><line x1="410" y1="190" x2="410" y2="235" stroke="#dc2626" stroke-width="2" stroke-dasharray="6,3"/><text x="410" y="183" text-anchor="middle" fill="#dc2626" font-size="9" font-weight="bold">GRENZE</text><rect x="430" y="190" width="120" height="45" rx="8" fill="#fb923c"/><text x="490" y="217" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Importeur</text><line x1="555" y1="212" x2="585" y2="212" stroke="#ea580c" stroke-width="2" marker-end="url(#ex-arr)"/><rect x="590" y="190" width="80" height="45" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="630" y="217" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Konsument</text><text x="310" y="256" text-anchor="middle" fill="#166534" font-size="9">Eigentum wechselt VOR der Grenze</text><rect x="100" y="275" width="500" height="32" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="350" y="296" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="600">Incoterms regeln Konditionen: Transportkosten, Risiko, Steuern</text></svg>'
          },
          {
            type: 'keyterms',
            title: 'Schlüsselbegriffe',
          ...
          {
            type: 'svg',
            title: 'Einflussfaktoren im Export',
            svg: '<svg viewBox="0 0 700 200" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Zusätzliche Einflussfaktoren im Export</text><rect x="250" y="40" width="200" height="35" rx="8" fill="#ea580c"/><text x="350" y="63" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Export-Projekt</text><rect x="20" y="95" width="95" height="50" rx="6" fill="#f97316"/><text x="67" y="115" text-anchor="middle" fill="#fff" font-size="8" font-weight="bold">Marktzugang</text><text x="67" y="128" text-anchor="middle" fill="#fed7aa" font-size="7">Eintritt fremdes Land</text><rect x="125" y="95" width="95" height="50" rx="6" fill="#f97316"/><text x="172" y="115" text-anchor="middle" fill="#fff" font-size="8" font-weight="bold">Administration</text><text x="172" y="128" text-anchor="middle" fill="#fed7aa" font-size="7">Zoll, Dokumente</text><rect x="230" y="95" width="95" height="50" rx="6" fill="#fb923c"/><text x="277" y="115" text-anchor="middle" fill="#fff" font-size="8" font-weight="bold">Recht / Gesetze</text><text x="277" y="128" text-anchor="middle" fill="#fff" font-size="7">LMG, Normen, Zoll</text><rect x="335" y="95" width="95" height="50" rx="6" fill="#fb923c"/><text x="382" y="115" text-anchor="middle" fill="#fff" font-size="8" font-weight="bold">Kosten</text><text x="382" y="128" text-anchor="middle" fill="#fff" font-size="7">Zölle, Steuern</text><rect x="440" y="95" width="80" height="50" rx="6" fill="#fdba74"/><text x="480" y="115" text-anchor="middle" fill="#7c2d12" font-size="8" font-weight="bold">Finanzen</text><text x="480" y="128" text-anchor="middle" fill="#7c2d12" font-size="7">Währungsrisiko</text><rect x="530" y="95" width="75" height="50" rx="6" fill="#fdba74"/><text x="567" y="115" text-anchor="middle" fill="#7c2d12" font-size="8" font-weight="bold">Kultur</text><text x="567" y="128" text-anchor="middle" fill="#7c2d12" font-size="7">Sprache, Mentalität</text><rect x="615" y="95" width="65" height="50" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1"/><text x="647" y="115" text-anchor="middle" fill="#7c2d12" font-size="8" font-weight="bold">Distanz</text><text x="647" y="128" text-anchor="middle" fill="#7c2d12" font-size="7">Reaktionszeit</text><line x1="350" y1="75" x2="67" y2="92" stroke="#ea580c" stroke-width="1"/><line x1="350" y1="75" x2="172" y2="92" stroke="#ea580c" stroke-width="1"/><line x1="350" y1="75" x2="277" y2="92" stroke="#ea580c" stroke-width="1"/><line x1="350" y1="75" x2="382" y2="92" stroke="#ea580c" stroke-width="1"/><line x1="350" y1="75" x2="480" y2="92" stroke="#ea580c" stroke-width="1"/><line x1="350" y1="75" x2="567" y2="92" stroke="#ea580c" stroke-width="1"/><line x1="350" y1="75" x2="647" y2="92" stroke="#ea580c" stroke-width="1"/><text x="350" y="175" text-anchor="middle" fill="#78716c" font-size="10">Diese Faktoren kommen zu den üblichen Anforderungen an die Logistik hinzu</text></svg>'
          },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      exercises: [
        ...
        // Ex 72
        {
          ...
          statements: [
            ...
            {s:'Formulardruck (Lieferscheine auf Papier) ist ein Investitionsgut.', c:false, feedback:'Formulardruck wird im Betrieb verbraucht (nicht langfristig genutzt) und ist deshalb ein Verbrauchsgut/Betriebsstoff, kein Investitionsgut. Investitionsgüter sind langlebige Anlagegüter wie Maschinen.'}
          ],
          tips: ['KG = indirekt, IG = direkt, DL = häufig direkt.','Dienstleistungen = immateriell.','Investitionsgüter sind langlebige Anlagegüter, Formulardruck wird verbraucht.'],
          reveal: ['Aussage 1: Richtig.','Aussage 2: Richtig.','Aussage 3: Falsch - immateriell.','Aussage 4: Falsch - Formulardruck ist ein Verbrauchsgut/Betriebsstoff, kein Investitionsgut (wird verbraucht statt langfristig genutzt).']
        },
        // Ex 73
        {
          id: 73, type: 'mc',
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Güterarten-Hierarchie',
            svg: '<svg viewBox="0 0 700 320" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Güterarten – Hierarchische Einteilung</text><rect x="250" y="45" width="200" height="40" rx="8" fill="#ea580c"/><text x="350" y="70" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">Güter des Markts</text><line x1="280" y1="85" x2="200" y2="108" stroke="#ea580c" stroke-width="1.5"/><line x1="420" y1="85" x2="500" y2="108" stroke="#ea580c" stroke-width="1.5"/><rect x="100" y="110" width="200" height="35" rx="6" fill="#f97316"/><text x="200" y="132" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Wirtschaftliche Güter</text><rect x="400" y="110" width="200" height="35" rx="6" fill="#d4d4d4"/><text x="500" y="132" text-anchor="middle" fill="#525252" font-size="10" font-weight="bold">Freie Güter</text><line x1="150" y1="145" x2="110" y2="168" stroke="#ea580c" stroke-width="1.5"/><line x1="250" y1="145" x2="370" y2="168" stroke="#ea580c" stroke-width="1.5"/><rect x="20" y="170" width="180" height="35" rx="6" fill="#fb923c"/><text x="110" y="192" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Materielle Güter</text><rect x="280" y="170" width="180" height="35" rx="6" fill="#fb923c"/><text x="370" y="192" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Immaterielle Güter</text><line x1="60" y1="205" x2="60" y2="228" stroke="#ea580c" stroke-width="1.5"/><line x1="160" y1="205" x2="160" y2="228" stroke="#ea580c" stroke-width="1.5"/><line x1="310" y1="205" x2="310" y2="228" stroke="#ea580c" stroke-width="1.5"/><line x1="410" y1="205" x2="410" y2="228" stroke="#ea580c" stroke-width="1.5"/><rect x="5" y="230" width="110" height="65" rx="6" fill="#fdba74"/><text x="60" y="250" text-anchor="middle" fill="#7c2d12" font-size="9" font-weight="bold">Konsumgüter</text><text x="60" y="265" text-anchor="middle" fill="#7c2d12" font-size="7">Gebrauch + Verbrauch</text><text x="60" y="280" text-anchor="middle" fill="#7c2d12" font-size="7">Indirekt (B2C)</text><rect x="125" y="230" width="110" height="65" rx="6" fill="#fdba74"/><text x="180" y="250" text-anchor="middle" fill="#7c2d12" font-size="9" font-weight="bold">Investitionsgüter</text><text x="180" y="265" text-anchor="middle" fill="#7c2d12" font-size="7">Gebrauch + Verbrauch</text><text x="180" y="280" text-anchor="middle" fill="#7c2d12" font-size="7">Direkt (B2B)</text><rect x="255" y="230" width="110" height="65" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1"/><text x="310" y="250" text-anchor="middle" fill="#7c2d12" font-size="9" font-weight="bold">Dienstleistungen</text><text x="310" y="265" text-anchor="middle" fill="#7c2d12" font-size="7">Persönl. / unpersönl.</text><text x="310" y="280" text-anchor="middle" fill="#7c2d12" font-size="7">Meist direkt</text><rect x="375" y="230" width="85" height="65" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1"/><text x="417" y="255" text-anchor="middle" fill="#7c2d12" font-size="9" font-weight="bold">Rechte</text><text x="417" y="270" text-anchor="middle" fill="#7c2d12" font-size="7">+ Know-how</text><text x="350" y="315" text-anchor="middle" fill="#78716c" font-size="10">Nicht das Gut selbst, sondern dessen Verwendung bestimmt die Klassifizierung</text></svg>'
          },
          {
            type: 'concept',
          ...
          {
            type: 'svg',
            title: 'Vertriebswege nach Güterart',
            svg: '<svg viewBox="0 0 700 250" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><defs><marker id="gv-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#ea580c"/></marker></defs><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Vertriebswege nach Güterart</text><rect x="20" y="50" width="140" height="50" rx="8" fill="#ea580c"/><text x="90" y="72" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Konsumgüter</text><text x="90" y="87" text-anchor="middle" fill="#fed7aa" font-size="8">Massengüter, B2C</text><line x1="165" y1="75" x2="300" y2="75" stroke="#ea580c" stroke-width="2" marker-end="url(#gv-arr)"/><text x="230" y="68" text-anchor="middle" fill="#ea580c" font-size="8" font-weight="600">INDIREKT</text><rect x="305" y="50" width="140" height="50" rx="8" fill="#f97316"/><text x="375" y="72" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Handel</text><text x="375" y="87" text-anchor="middle" fill="#fed7aa" font-size="8">Gross-/Detailhandel</text><line x1="450" y1="75" x2="540" y2="75" stroke="#ea580c" stroke-width="2" marker-end="url(#gv-arr)"/><rect x="545" y="50" width="135" height="50" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="612" y="80" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Konsument</text><rect x="20" y="120" width="140" height="50" rx="8" fill="#ea580c"/><text x="90" y="142" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Investitionsgüter</text><text x="90" y="157" text-anchor="middle" fill="#fed7aa" font-size="8">Spezifisch, B2B</text><line x1="165" y1="145" x2="540" y2="145" stroke="#ea580c" stroke-width="2" marker-end="url(#gv-arr)"/><text x="350" y="138" text-anchor="middle" fill="#ea580c" font-size="8" font-weight="600">DIREKT (persönlicher Verkauf)</text><rect x="545" y="120" width="135" height="50" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="612" y="150" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Firma (Kunde)</text><rect x="20" y="190" width="140" height="50" rx="8" fill="#ea580c"/><text x="90" y="212" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Dienstleistungen</text><text x="90" y="227" text-anchor="middle" fill="#fed7aa" font-size="8">Immateriell, persönlich</text><line x1="165" y1="215" x2="540" y2="215" stroke="#ea580c" stroke-width="2" marker-end="url(#gv-arr)"/><text x="350" y="208" text-anchor="middle" fill="#ea580c" font-size="8" font-weight="600">DIREKT (Imagekomponenten)</text><rect x="545" y="190" width="135" height="50" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="612" y="220" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Nachfrager</text></svg>'
          },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          {
            type: 'svg',
            title: 'Zukunftstechnologien der Distribution',
            svg: '<svg viewBox="0 0 700 200" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif"><text x="350" y="25" text-anchor="middle" fill="#9a3412" font-size="14" font-weight="bold">Zukunftstechnologien der Distribution</text><rect x="20" y="50" width="125" height="70" rx="10" fill="#ea580c"/><text x="82" y="75" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Cargo sous</text><text x="82" y="89" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">terrain (CST)</text><text x="82" y="108" text-anchor="middle" fill="#fed7aa" font-size="8">Unterird. Tunnel</text><rect x="155" y="50" width="125" height="70" rx="10" fill="#f97316"/><text x="217" y="80" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Drohnen</text><text x="217" y="108" text-anchor="middle" fill="#fed7aa" font-size="8">Flexibler Transport</text><rect x="290" y="50" width="125" height="70" rx="10" fill="#fb923c"/><text x="352" y="75" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Roboter-</text><text x="352" y="89" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">fahrzeuge</text><text x="352" y="108" text-anchor="middle" fill="#fff" font-size="8">Autonome Logistik</text><rect x="425" y="50" width="125" height="70" rx="10" fill="#fdba74"/><text x="487" y="80" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">3-D-Printer</text><text x="487" y="108" text-anchor="middle" fill="#7c2d12" font-size="8">Vor-Ort-Produktion</text><rect x="560" y="50" width="120" height="70" rx="10" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="620" y="75" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Neue</text><text x="620" y="89" text-anchor="middle" fill="#7c2d12" font-size="10" font-weight="bold">Energieträger</text><text x="620" y="108" text-anchor="middle" fill="#7c2d12" font-size="8">E / H₂ / LNG</text><rect x="100" y="145" width="500" height="35" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="350" y="168" text-anchor="middle" fill="#9a3412" font-size="10" font-weight="bold">Gemeinsames Ziel: Effizienter, ökologischer, schneller, kostengünstiger</text></svg>'
          },
          {
            type: 'concept',
