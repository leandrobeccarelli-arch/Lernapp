    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Kommunikationsmodell (Sender \u2192 Empf\u00e4nger)', svg: '<svg viewBox="0 0 600 180" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><defs><marker id="kg-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#be185d"/></marker></defs><rect x="10" y="40" width="100" height="55" rx="10" fill="#be185d"/><text x="60" y="65" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Sender</text><text x="60" y="82" text-anchor="middle" fill="#fce7f3" font-size="9">Absicht</text><rect x="140" y="48" width="80" height="38" rx="6" fill="#fce7f3" stroke="#be185d" stroke-width="1.5"/><text x="180" y="65" text-anchor="middle" fill="#831843" font-size="9" font-weight="bold">Codierung</text><text x="180" y="78" text-anchor="middle" fill="#9d174d" font-size="8">Signal</text><rect x="250" y="40" width="100" height="55" rx="8" fill="#fce7f3" stroke="#be185d" stroke-width="2"/><text x="300" y="62" text-anchor="middle" fill="#831843" font-size="11" font-weight="bold">Kanal</text><text x="300" y="78" text-anchor="middle" fill="#9d174d" font-size="8">Medium/\u00dcbertragung</text><rect x="380" y="48" width="80" height="38" rx="6" fill="#fce7f3" stroke="#be185d" stroke-width="1.5"/><text x="420" y="65" text-anchor="middle" fill="#831843" font-size="9" font-weight="bold">Decodierung</text><text x="420" y="78" text-anchor="middle" fill="#9d174d" font-size="8">Interpretation</text><rect x="490" y="40" width="100" height="55" rx="10" fill="#be185d"/><text x="540" y="65" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Empf\u00e4nger</text><text x="540" y="82" text-anchor="middle" fill="#fce7f3" font-size="9">Wirkung</text><line x1="110" y1="67" x2="138" y2="67" stroke="#be185d" stroke-width="2" marker-end="url(#kg-arr)"/><line x1="220" y1="67" x2="248" y2="67" stroke="#be185d" stroke-width="2" marker-end="url(#kg-arr)"/><line x1="350" y1="67" x2="378" y2="67" stroke="#be185d" stroke-width="2" marker-end="url(#kg-arr)"/><line x1="460" y1="67" x2="488" y2="67" stroke="#be185d" stroke-width="2" marker-end="url(#kg-arr)"/><path d="M490,115 Q300,155 110,115" fill="none" stroke="#be185d" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#kg-arr)"/><text x="300" y="145" text-anchor="middle" fill="#be185d" font-size="10" font-weight="bold">Feedback / R\u00fcckmeldung</text><text x="300" y="30" text-anchor="middle" fill="#f472b6" font-size="9" font-style="italic">St\u00f6rungen / Rauschen</text><text x="300" y="170" text-anchor="middle" fill="#78716c" font-size="9">Bezugsrahmen von Sender und Empf\u00e4nger beeinflussen die Interpretation</text></svg>' },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Kommunikationskonzept – 5-Phasen-Prozess', svg: '<svg viewBox="0 0 650 130" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><defs><marker id="kk-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#be185d"/></marker></defs><rect x="5" y="30" width="110" height="55" rx="8" fill="#be185d"/><text x="60" y="52" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">1. Analyse</text><text x="60" y="68" text-anchor="middle" fill="#fce7f3" font-size="8">SWOT, Problem-</text><text x="60" y="78" text-anchor="middle" fill="#fce7f3" font-size="8">stellung</text><line x1="115" y1="57" x2="133" y2="57" stroke="#be185d" stroke-width="2" marker-end="url(#kk-arr)"/><rect x="135" y="30" width="110" height="55" rx="8" fill="#db2777"/><text x="190" y="52" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">2. Ziele</text><text x="190" y="68" text-anchor="middle" fill="#fce7f3" font-size="8">Zielgruppen,</text><text x="190" y="78" text-anchor="middle" fill="#fce7f3" font-size="8">Positionierung</text><line x1="245" y1="57" x2="263" y2="57" stroke="#be185d" stroke-width="2" marker-end="url(#kk-arr)"/><rect x="265" y="30" width="110" height="55" rx="8" fill="#e11d73"/><text x="320" y="52" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">3. Massnahmen</text><text x="320" y="68" text-anchor="middle" fill="#fce7f3" font-size="8">Instrumente,</text><text x="320" y="78" text-anchor="middle" fill="#fce7f3" font-size="8">CI/CD-Regeln</text><line x1="375" y1="57" x2="393" y2="57" stroke="#be185d" stroke-width="2" marker-end="url(#kk-arr)"/><rect x="395" y="30" width="110" height="55" rx="8" fill="#f472b6"/><text x="450" y="52" text-anchor="middle" fill="#831843" font-size="10" font-weight="bold">4. Realisation</text><text x="450" y="68" text-anchor="middle" fill="#831843" font-size="8">Budget,</text><text x="450" y="78" text-anchor="middle" fill="#831843" font-size="8">Umsetzung</text><line x1="505" y1="57" x2="523" y2="57" stroke="#be185d" stroke-width="2" marker-end="url(#kk-arr)"/><rect x="525" y="30" width="110" height="55" rx="8" fill="#fce7f3" stroke="#be185d" stroke-width="2"/><text x="580" y="52" text-anchor="middle" fill="#831843" font-size="10" font-weight="bold">5. Kontrolle</text><text x="580" y="68" text-anchor="middle" fill="#9d174d" font-size="8">Wirkungs- und</text><text x="580" y="78" text-anchor="middle" fill="#9d174d" font-size="8">Effizienzanalyse</text><text x="325" y="115" text-anchor="middle" fill="#78716c" font-size="10">Integrierte Kommunikation: inhaltliche, formale und zeitliche Abstimmung</text></svg>' },
          {
            type: 'concept',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'PR-Instrumente \u00dcbersicht', svg: '<svg viewBox="0 0 600 290" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><text x="300" y="22" text-anchor="middle" fill="#831843" font-size="14" font-weight="bold">PR-Instrumente im \u00dcberblick</text><rect x="200" y="35" width="200" height="35" rx="8" fill="#be185d"/><text x="300" y="57" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Public Relations</text><line x1="200" y1="70" x2="100" y2="95" stroke="#be185d" stroke-width="1.5"/><line x1="300" y1="70" x2="300" y2="95" stroke="#be185d" stroke-width="1.5"/><line x1="400" y1="70" x2="500" y2="95" stroke="#be185d" stroke-width="1.5"/><rect x="20" y="95" width="160" height="30" rx="6" fill="#db2777"/><text x="100" y="115" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">M\u00fcndlich</text><rect x="220" y="95" width="160" height="30" rx="6" fill="#db2777"/><text x="300" y="115" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Schriftlich</text><rect x="420" y="95" width="160" height="30" rx="6" fill="#db2777"/><text x="500" y="115" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">Visuell / Digital</text><rect x="20" y="135" width="160" height="100" rx="6" fill="#fce7f3" stroke="#be185d" stroke-width="1"/><text x="100" y="155" text-anchor="middle" fill="#831843" font-size="9">\u2022 Pressekonferenzen</text><text x="100" y="170" text-anchor="middle" fill="#831843" font-size="9">\u2022 Pers\u00f6nliche Gespr\u00e4che</text><text x="100" y="185" text-anchor="middle" fill="#831843" font-size="9">\u2022 Veranstaltungen / Events</text><text x="100" y="200" text-anchor="middle" fill="#831843" font-size="9">\u2022 Reden / Vortr\u00e4ge</text><text x="100" y="215" text-anchor="middle" fill="#831843" font-size="9">\u2022 Tag der offenen T\u00fcr</text><rect x="220" y="135" width="160" height="100" rx="6" fill="#fce7f3" stroke="#be185d" stroke-width="1"/><text x="300" y="155" text-anchor="middle" fill="#831843" font-size="9">\u2022 Medienmitteilungen</text><text x="300" y="170" text-anchor="middle" fill="#831843" font-size="9">\u2022 Gesch\u00e4ftsberichte</text><text x="300" y="185" text-anchor="middle" fill="#831843" font-size="9">\u2022 Brosch\u00fcren</text><text x="300" y="200" text-anchor="middle" fill="#831843" font-size="9">\u2022 Newsletter / Blog</text><text x="300" y="215" text-anchor="middle" fill="#831843" font-size="9">\u2022 Intranet-Beitr\u00e4ge</text><rect x="420" y="135" width="160" height="100" rx="6" fill="#fce7f3" stroke="#be185d" stroke-width="1"/><text x="500" y="155" text-anchor="middle" fill="#831843" font-size="9">\u2022 Imagefilme</text><text x="500" y="170" text-anchor="middle" fill="#831843" font-size="9">\u2022 Social Media</text><text x="500" y="185" text-anchor="middle" fill="#831843" font-size="9">\u2022 Podcasts</text><text x="500" y="200" text-anchor="middle" fill="#831843" font-size="9">\u2022 Fotos / Infografiken</text><text x="500" y="215" text-anchor="middle" fill="#831843" font-size="9">\u2022 Corporate TV</text><rect x="60" y="250" width="480" height="30" rx="6" fill="#fce7f3" stroke="#be185d" stroke-width="1"/><text x="300" y="270" text-anchor="middle" fill="#831843" font-size="10" font-weight="bold">Intern (Mitarbeitende) und Extern (\u00d6ffentlichkeit, Medien, Stakeholder)</text></svg>' },
          {
            type: 'table',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'Markenstrategien im \u00dcberblick', svg: '<svg viewBox="0 0 600 300" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><text x="300" y="25" text-anchor="middle" fill="#831843" font-size="14" font-weight="bold">Markenstrategien</text><rect x="200" y="45" width="200" height="40" rx="8" fill="#be185d"/><text x="300" y="70" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Unternehmen</text><line x1="200" y1="85" x2="100" y2="115" stroke="#be185d" stroke-width="2"/><line x1="300" y1="85" x2="300" y2="115" stroke="#be185d" stroke-width="2"/><line x1="400" y1="85" x2="500" y2="115" stroke="#be185d" stroke-width="2"/><rect x="30" y="115" width="140" height="50" rx="8" fill="#fce7f3" stroke="#be185d" stroke-width="2"/><text x="100" y="137" text-anchor="middle" fill="#831843" font-size="11" font-weight="bold">Einzelmarke</text><text x="100" y="155" text-anchor="middle" fill="#9d174d" font-size="9">je Produkt eine Marke</text><rect x="230" y="115" width="140" height="50" rx="8" fill="#fce7f3" stroke="#be185d" stroke-width="2"/><text x="300" y="137" text-anchor="middle" fill="#831843" font-size="11" font-weight="bold">Familienmarke</text><text x="300" y="155" text-anchor="middle" fill="#9d174d" font-size="9">Produktgruppen-Marke</text><rect x="430" y="115" width="140" height="50" rx="8" fill="#fce7f3" stroke="#be185d" stroke-width="2"/><text x="500" y="137" text-anchor="middle" fill="#831843" font-size="11" font-weight="bold">Dachmarke</text><text x="500" y="155" text-anchor="middle" fill="#9d174d" font-size="9">eine Marke f\u00fcr alles</text><line x1="100" y1="165" x2="100" y2="185" stroke="#be185d" stroke-width="1"/><line x1="300" y1="165" x2="300" y2="185" stroke="#be185d" stroke-width="1"/><line x1="500" y1="165" x2="500" y2="185" stroke="#be185d" stroke-width="1"/><rect x="30" y="185" width="140" height="30" rx="4" fill="#fff" stroke="#be185d" stroke-width="1"/><text x="100" y="204" text-anchor="middle" fill="#78716c" font-size="8">Bsp: Persil, Pril, Pritt</text><rect x="230" y="185" width="140" height="30" rx="4" fill="#fff" stroke="#be185d" stroke-width="1"/><text x="300" y="204" text-anchor="middle" fill="#78716c" font-size="8">Bsp: Nivea, Tesa</text><rect x="430" y="185" width="140" height="30" rx="4" fill="#fff" stroke="#be185d" stroke-width="1"/><text x="500" y="204" text-anchor="middle" fill="#78716c" font-size="8">Bsp: Migros, Siemens</text><text x="300" y="245" text-anchor="middle" fill="#831843" font-size="11" font-weight="bold">Markendehnungsstrategien</text><rect x="30" y="255" width="160" height="30" rx="6" fill="#db2777"/><text x="110" y="275" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Line Extension</text><rect x="220" y="255" width="160" height="30" rx="6" fill="#db2777"/><text x="300" y="275" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Brand Extension</text><rect x="410" y="255" width="160" height="30" rx="6" fill="#db2777"/><text x="490" y="275" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">Multibrands / New Brand</text></svg>' },
          {
            type: 'table',
    ...
    // ============================================================
    {
      ...
      learningData: {
        ...
        sections: [
          ...
          { type: 'svg', title: 'PESO-Modell \u2013 4 Content-Arten', svg: '<svg viewBox="0 0 500 350" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif"><text x="250" y="25" text-anchor="middle" fill="#831843" font-size="14" font-weight="bold">PESO-Modell</text><rect x="30" y="50" width="200" height="120" rx="12" fill="#be185d"/><text x="130" y="80" text-anchor="middle" fill="#fff" font-size="18" font-weight="bold">P</text><text x="130" y="100" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Paid</text><text x="130" y="118" text-anchor="middle" fill="#fce7f3" font-size="9">Bezahlte Inhalte</text><text x="130" y="132" text-anchor="middle" fill="#fce7f3" font-size="8">Banner, Display, Ads</text><text x="130" y="148" text-anchor="middle" fill="#fce7f3" font-size="8">Volle Kontrolle \u00fcber Reichweite</text><rect x="270" y="50" width="200" height="120" rx="12" fill="#db2777"/><text x="370" y="80" text-anchor="middle" fill="#fff" font-size="18" font-weight="bold">E</text><text x="370" y="100" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold">Earned</text><text x="370" y="118" text-anchor="middle" fill="#fce7f3" font-size="9">Verdiente Inhalte</text><text x="370" y="132" text-anchor="middle" fill="#fce7f3" font-size="8">Redaktionelle PR, Interviews</text><text x="370" y="148" text-anchor="middle" fill="#fce7f3" font-size="8">Muss verdient werden</text><rect x="30" y="190" width="200" height="120" rx="12" fill="#f472b6"/><text x="130" y="220" text-anchor="middle" fill="#831843" font-size="18" font-weight="bold">S</text><text x="130" y="240" text-anchor="middle" fill="#831843" font-size="12" font-weight="bold">Social / Shared</text><text x="130" y="258" text-anchor="middle" fill="#9d174d" font-size="9">Geteilte Inhalte</text><text x="130" y="272" text-anchor="middle" fill="#9d174d" font-size="8">Postings, Kommentare</text><text x="130" y="288" text-anchor="middle" fill="#9d174d" font-size="8">Mit \u00d6ffentlichkeit gestaltet</text><rect x="270" y="190" width="200" height="120" rx="12" fill="#fce7f3" stroke="#be185d" stroke-width="2"/><text x="370" y="220" text-anchor="middle" fill="#831843" font-size="18" font-weight="bold">O</text><text x="370" y="240" text-anchor="middle" fill="#831843" font-size="12" font-weight="bold">Owned</text><text x="370" y="258" text-anchor="middle" fill="#9d174d" font-size="9">Eigene Inhalte</text><text x="370" y="272" text-anchor="middle" fill="#9d174d" font-size="8">Blog, Website, Newsroom</text><text x="370" y="288" text-anchor="middle" fill="#9d174d" font-size="8">Volle Kontrolle \u00fcber Inhalt</text><text x="250" y="340" text-anchor="middle" fill="#78716c" font-size="10">Optimale Strategie: alle 4 Content-Arten kombinieren</text></svg>' },
          {
            type: 'concept',
