  ...
  chapters: [
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 31, type: 'text', q: 'Erfolgsrechnung aus einem Geschäftsbericht (Meyer Burger)', tips: ['Zeitraumrechnung: ER zeigt Aufwand/Ertrag über eine Periode.','EBITDA = vor Abschreibungen. EBIT = vor Zinsen und Steuern.'], reveal: ['A) Ja, Zeitraumrechnung (1.1.–31.12.). Warum? Die ER zeigt Aufwand und Ertrag über eine Periode, nicht an einem Stichtag. Die Prozentzahlen zeigen den Anteil am Nettoerlös (= 100 %) – das ist eine Serviceleistung, nicht obligatorisch.','Die Lage verbessert sich: Der Verlust wird von Jahr zu Jahr kleiner. EBITDA = vor Abschreibungen, EBIT = vor Zinsen und Steuern. Prüfungstipp: EBITDA und EBIT sind wichtige Vergleichskennzahlen. Warum? Sie eliminieren Einflüsse der Finanzierungsstruktur und ermöglichen so einen fairen Branchenvergleich.'], questions: [{id:'a',label:'Zeitpunkt- oder Zeitraumrechnung?',keywords:['zeitraum','1.1','31.12']},{id:'b',label:'Prozentzahlen: Serviceleistung oder obligatorisch?',keywords:['serviceleistung','nicht obligatorisch']},{id:'c',label:'Wie sind die Prozentzahlen zu lesen?',keywords:['anteil','nettoerlös','100%']},{id:'d',label:'Erläuterung sonstiger Betriebsaufwand',keywords:['sonstiger betriebsaufwand']},{id:'e',label:'Zwischenergebnisse den KHG zuordnen',keywords:['brutto','personal','ebitda','ebit']},{id:'f',label:'Verschlimmert oder verbessert sich die Lage?',keywords:['verbessert','kleiner']}] }
      ],
      learningData: {
        sections: [
          { type: 'intro', title: 'Lernziele', items: [
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 33, type: 'text', q: 'Geldflussrechnung aus einem Geschäftsbericht', tips: ['Die GFR ist eine Zeitraumrechnung.','Praxis-Cashflow = Gewinn + Abschreibungen.'], reveal: ['A) Zeitraumrechnung (wie die ER). B) Ja, drei Bereiche erkennbar: Geschäftstätigkeit (operativ), Investitionstätigkeit, Finanzierungstätigkeit. C) Der operative CF 2015 ist negativ – das Unternehmen verbrennt im Kerngeschäft Geld.','D) Flüssige Mittel haben abgenommen. E) Massnahme: Kapitalerhöhung oder neue Finanzierung. F) Praxis-Cashflow (Gewinn + Abschreibungen) ist eine vereinfachte Schätzung. Der echte CF berücksichtigt auch Working-Capital-Veränderungen. Prüfungstipp: Praxis-CF ≠ echter CF – der Praxis-CF ignoriert Veränderungen bei Forderungen, Vorräten und Verbindlichkeiten.'], questions: [{id:'a',label:'Zeitpunkt- oder Zeitraumrechnung?',keywords:['zeitraum']},{id:'b',label:'Drei Bereiche erkennbar?',keywords:['geschäftstätigkeit','investition','finanzierung']},{id:'c',label:'Was fällt am CF 2015 auf?',keywords:['negativ','verbrennt']},{id:'d',label:'Flüssige Mittel zu- oder abgenommen?',keywords:['abgenommen']},{id:'e',label:'Massnahme gegen Finanzlage?',keywords:['kapitalerhöhung','finanzierung']},{id:'f',label:'Praxis-Cashflow vs. echter CF?',keywords:['working capital','abschreibung']}] },
        {
          id: 34,
          type: 'tf',
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 85, type: 'calc', q: 'Bilanzgleichung und stille Reserven', tips: ['Stille Reserven = Unterbewertung Aktiven + Überbewertung FK.','Aktiven − FK = EK.','Wertunterschied: Intern − Extern.'], reveal: ['Externe Bilanz: Aktiven extern − FK extern = EK extern. Der Wertunterschied bei Aktiven ist negativ (extern tiefer als intern), bei FK positiv (extern höher als intern). Die Summe aller Wertunterschiede = stille Reserven.','Interne Bilanz: Aktiven intern = Aktiven extern + Unterbewertung. FK intern = FK extern − Überbewertung. EK intern = EK extern + alle stillen Reserven.','Prüfungstipp: Bei der Umrechnung immer die Vorzeichen beachten! Unterbewertung Aktiven = negative Differenz (extern tiefer). Überbewertung FK = positive Differenz (extern höher). Stille Reserve auf EK = Summe beider Differenzen.'], fieldsA: [{label:'Externe Bilanz: Aktiven',answer:1000},{label:'Wertunterschied: Aktiven',answer:-100},{label:'Wertunterschied: FK',answer:40},{label:'Wertunterschied: EK',answer:-140},{label:'Interne Bilanz: FK',answer:360},{label:'Interne Bilanz: EK',answer:740}], fieldsB: [{label:'Interne Bilanz: Aktiven',answer:910},{label:'Interne Bilanz: FK',answer:440},{label:'Wertunterschied: Aktiven',answer:-70},{label:'Wertunterschied: FK',answer:20},{label:'Externe Bilanz: FK',answer:460},{label:'Externe Bilanz: EK',answer:380}] },
        { id: 86, type: 'mc', q: 'Wählen Sie die Antwort: Stille Reserven bei einer AG', tips: ['Mobiliar CHF 1.– = Erinnerungsfranken.','Bildung stiller Reserven verkleinert den ausgewiesenen Gewinn.','Kasse, Post, Bank: keine stillen Reserven möglich.'], reveal: ['Mobiliar zu CHF 1.– = Erinnerungsfranken. Das Mobiliar ist noch vorhanden und hat einen Wert, wird aber nur zu CHF 1.– bilanziert. Die stille Reserve = tatsächlicher Wert − CHF 1.–. Warum CHF 1.–? Damit das Aktivum noch in der Bilanz erscheint.','EK einer AG besteht aus Aktienkapital, gesetzlichen Reserven, freiwilligen Reserven und Gewinnvortrag. Stille Reserven sind NICHT Teil des ausgewiesenen EK – sie sind ja «still» (versteckt).','Die Bildung stiller Reserven ist eine Form der Selbstfinanzierung. Warum? Das Unternehmen behält mehr Substanz, als es ausweist. Prüfungstipp: Wo keine stillen Reserven möglich sind: Kasse, Post, Bank (fester Wert).'], questions: [{id:'a',q:'Mobiliar CHF 1.– ?',answer:2},{id:'b',q:'Was gehört zum EK?',answer:2},{id:'c',q:'Wo keine stillen Reserven?',answer:2},{id:'d',q:'Welche Aussage ist richtig?',answer:3},{id:'e',q:'Warum Selbstfinanzierung?',answer:1}] },
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          reveal: ['Einkaufskalkulationen: Immer Bruttokreditankauf → Rabatt → Nettokreditankauf → Skonto → Nettobarankauf → Bezugskosten → Einstand. Rabatt wird VOR Skonto abgezogen. Rabatt bezieht sich auf den Listenpreis, Skonto auf den bereits rabattierten Preis.','Nr.1: 1800 − 25% = 1350 − 2% = 1323. Nr.2: 2600 × 15% = 390. Nr.3: 9400 − 20% = 7520, Skonto ergibt 7332. Nr.4: 3000 − Rabatt − 2% = 2293.20. Häufiger Fehler: Skonto VOR dem Rabatt abziehen ergibt falsche Werte!','Verkaufskalkulation rückwärts: Vom Nettobarverkauf über Skonto und Rabatt zum Bruttokreditverkauf. Prüfungstipp: Bei Rückwärtsrechnung Division statt Multiplikation. Z.B. Nettobarverkauf / (1 − Skonto%) = Nettokreditverkauf.'],
          calcs: [
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          reveal: ['Bilanzsumme = UV (260+3100+3700=7060) + AV (2000+600+5700=8300) = 15360. AI = 8300/15360 = 54.04% (korrigiert). FK = 2900+600+3900+900+460=8760, EK = 5000+1600=6600. EFG = 6600/15360 = 42.97%, FFG = 57.03%.','LG 2 = (260+3100)/(2900+600) = 3360/3500 = 96%. LG 3 = (260+3100+3700)/3500 = 7060/3500 = 201.71%. NWC = UV − kurzfr. FK = 7060 − 3500 = 3560. Prüfungstipp: LG 2 unter 100% = kritisch! Die kurzfristigen Schulden können nicht vollständig mit FM + Forderungen gedeckt werden.'],
          calcs: [
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          reveal: ['Kapitalwert = Summe der abgezinsten Einzahlungen − Auszahlung. Alt. A: Einzahlungen über 5 Jahre abzinsen mit 8% → KW = ca. 15\'578. Alt. B: Einzahlungen über 3 Jahre → KW = ca. 5\'731. Alternative A ist vorzuziehen (höherer KW).','Warum abzinsen? Geld heute ist mehr wert als Geld morgen (Zeitwert des Geldes). Abzinsungsfaktor Jahr n = 1/(1+i)^n. Prüfungstipp: Kapitalwert > 0 → Investition lohnt sich. Bei mehreren Alternativen: höchster KW = beste Wahl.'],
          calcs: [
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          reveal: ['Prod. O: Ist-Preis = 45\'750 / 1\'500 = 30.50 CHF/Stk. Plan-Umsatz = 1\'400 × 32.00 = 44\'800. Ist-Umsatz = 45\'750. Mengenabweichung positiv (+100 Stk), aber Preisabweichung negativ (30.50 statt 32.00). Warum beides analysieren? So sieht man, WO die Abweichung entsteht.','Prod. P: Plan-Umsatz = 15\'000 × 5.25 = 78\'750. Ist-Umsatz = 15\'000 × 5.00 = 75\'000 → Abweichung −3\'750 (ungünstig, tieferer Preis). Ist var.K = 2.80. Gesamt-DB Ist = Ist-Umsatz − Ist var.K total. Prüfungstipp: Abweichungsanalyse immer in Menge × Preis aufteilen!'],
          calcs: [
