  ...
  chapters: [
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 26, type: 'text', q: 'Das Geschäft eines Unternehmens abbilden. Ertrags- und Aufwandsposten pro Branche.', tips: ['Der wichtigste Ertrag zeigt, was das Unternehmen verkauft.','Handel: Warenertrag. Industrie: Produktionserlöse.'], reveal: ['Handel: Warenertrag/Handelserlöse als Hauptertrag, Warenaufwand als grösster Aufwand. Industrie: Produktionserlöse, Material- und Energieaufwand. Warum unterschiedlich? Der Hauptertrag zeigt, was das Unternehmen verkauft – und der Hauptaufwand, was es dafür einsetzt.','Dienstleistung/Beratung: Dienstleistungs- bzw. Honorarertrag, Personalaufwand dominant (weil Menschen die «Maschinen» sind). Transport: Transportertrag, Treibstoff-/Fahrzeugaufwand. Banken: Zins- und Kommissionsertrag. Versicherungen: Prämienertrag, Schadenaufwand.','Prüfungstipp: An den typischen Erträgen und Aufwänden erkennt man die Branche. Wenn «Materialaufwand» und «Produktionserlös» auftauchen → Industrie. Wenn nur «Personalaufwand» und «Honorarertrag» → Beratung/DL.'], questions: [{label:'A',text:'Nennen Sie den Hauptertrag und die wichtigsten Aufwandposten eines Handelsunternehmens.',answers:['Ertrag: Warenertrag/Handelserlöse; Aufwand: Warenaufwand, Personalaufwand, Raumaufwand'],keywords:['Warenertrag','Handelserlöse','Warenaufwand','Personalaufwand']},{label:'B',text:'Nennen Sie den Hauptertrag und die wichtigsten Aufwandposten eines Industrieunternehmens.',answers:['Ertrag: Produktionserlöse; Aufwand: Materialaufwand, Personalaufwand, Energieaufwand'],keywords:['Produktionserlöse','Materialaufwand','Energieaufwand']},{label:'C',text:'Nennen Sie den Hauptertrag und die wichtigsten Aufwandposten eines Dienstleistungsunternehmens.',answers:['Ertrag: Dienstleistungserlöse; Aufwand: Personalaufwand, Raumaufwand'],keywords:['Dienstleistungserlöse','Personalaufwand']},{label:'D',text:'Nennen Sie den Hauptertrag und die wichtigsten Aufwandposten eines Transportunternehmens.',answers:['Ertrag: Transportertrag; Aufwand: Treibstoffaufwand, Fahrzeugaufwand'],keywords:['Transportertrag','Treibstoffaufwand','Fahrzeugaufwand']},{label:'E',text:'Nennen Sie den Hauptertrag und die wichtigsten Aufwandposten eines Beratungsunternehmens.',answers:['Ertrag: Honorarertrag; Aufwand: Personalaufwand, Raumaufwand'],keywords:['Honorarertrag','Personalaufwand']},{label:'F',text:'Nennen Sie den Hauptertrag und die wichtigsten Aufwandposten im Gastgewerbe.',answers:['Ertrag: Dienstleistungserlöse; Aufwand: Warenaufwand, Personalaufwand'],keywords:['Dienstleistungserlöse','Warenaufwand']},{label:'G',text:'Nennen Sie den Hauptertrag und die wichtigsten Aufwandposten von Banken.',answers:['Ertrag: Zinsertrag, Kommissionsertrag; Aufwand: Zinsaufwand, Personalaufwand'],keywords:['Zinsertrag','Kommissionsertrag','Zinsaufwand']},{label:'H',text:'Nennen Sie den Hauptertrag und die wichtigsten Aufwandposten von Versicherungen.',answers:['Ertrag: Prämienertrag; Aufwand: Schadenaufwand, Personalaufwand'],keywords:['Prämienertrag','Schadenaufwand']}] },
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 53, type: 'text', q: 'Einzelfragen zum Thema Buchungstechnik', tips: ['Die Bilanz wird in Konten aufgelöst.','Journal = chronologisch. Hauptbuch = sachlich.'], reveal: ['A) Doppelte Buchhaltung: Jeder Geschäftsfall wird auf mindestens zwei Konten gebucht (Soll und Haben). B) Journal = chronologische Aufzeichnung (nach Datum). Hauptbuch = sachliche Ordnung (nach Konten). Warum beides? Das Journal zeigt «was passierte wann», das Hauptbuch zeigt «wie steht jedes Konto».','C) Ablauf: Eröffnungsbilanz → Konten eröffnen → Geschäftsfälle buchen → Konten abschliessen → ER erstellen → Erfolg verbuchen → Schlussbilanz. D) Doppelter Erfolgsnachweis: Gleicher Betrag in Bilanz (EK-Veränderung) und ER (Ertrag−Aufwand). E) Ohne Beleg keine Buchung! Prüfungstipp: Der Beleg ist das «Beweismittel» der Buchhaltung – er legitimiert jede Buchung.'], questions: [{label:'A',text:'Was bedeutet "doppelte Buchhaltung"?',answers:['Jeder Geschäftsfall wird auf mindestens zwei Konten gebucht (Soll und Haben)'],keywords:['zwei konten','soll','haben']},{label:'B',text:'Journal vs. Hauptbuch?',answers:['Journal = chronologisch, Hauptbuch = sachlich geordnet'],keywords:['chronolog','sachlich']},{label:'C',text:'Ablauf Eröffnung bis Schlussbilanz?',answers:['Eröffnungsbilanz, Konten eröffnen, Geschäftsfälle buchen, Konten abschliessen, Schlussbilanz'],keywords:['eröffnung','geschäftsf','abschluss']},{label:'D',text:'Was ist der doppelte Erfolgsnachweis?',answers:['Gleicher Erfolg in Bilanz (EK-Veränderung) und Erfolgsrechnung (Ertrag minus Aufwand)'],keywords:['bilanz','erfolgsrechnung','beide']},{label:'E',text:'Rolle des Belegs?',answers:['Ohne Beleg keine Buchung – der Beleg ist die Grundlage jeder Buchung'],keywords:['beleg','grundlage','keine buchung']}] },
        {
          id: 54,
          type: 'sort',
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 68, type: 'text', q: 'Theoriefragen zur Abschreibung', tips: ['Indirekte Methode ist aufschlussreicher.','Abschreibungen sind nicht zahlungswirksam.','Bei direkter Abschreibung sind Anschaffungskosten nicht mehr ersichtlich.'], reveal: ['Die indirekte Methode ist aufschlussreicher, weil Anschaffungskosten und kumulierte Abschreibungen separat ersichtlich sind. Man sieht sofort, wie alt eine Anlage ist.','Linear = von Anschaffungskosten (konstanter Betrag). Degressiv = vom Buchwert (abnehmender Betrag). Prüfungstipp: «Linear» und «Anschaffungskosten» gehören zusammen.','Abschreibungen sind nicht zahlungswirksam – es fliesst kein Geld ab. Sie vermindern den Gewinn, aber nicht die Liquidität. Bei direkter Abschreibung sind Anschaffungskosten nicht mehr ermittelbar.'], questions: [{label:'A',text:'Welches Verfahren ist aufschlussreicher?',answers:['Indirekte Methode'],keywords:['indirekte','aufschlussreich']},{label:'B',text:'Abschreibung von Anschaffungskosten vs. Buchwert?',answers:['Linear = von Anschaffungskosten (konstant), Degressiv = vom Buchwert (abnehmend)'],keywords:['konstant','linear','degressiv']},{label:'C',text:'Unterschied zu anderem Aufwand?',answers:['Abschreibungen sind nicht zahlungswirksam'],keywords:['nicht zahlungswirksam']},{label:'D',text:'Buchwert bei indirekter Abschreibung ermittelbar?',answers:['Ja, als Differenz von Anschaffungskosten und Wertberichtigung'],keywords:['ja','WB','Differenz']},{label:'E',text:'Anschaffungskosten bei direkter Abschreibung ermittelbar?',answers:['Nein, bei direkter Abschreibung nicht mehr ersichtlich'],keywords:['nein','nicht','direkt']}] },
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 77, type: 'check', q: 'Geschäftsfälle betragsmässig zwischen zwei Jahren abgrenzen', tips: ['Prüfen: Buchung ins laufende oder nächste Jahr?','Verursachung im selben Jahr → keine Abgrenzung.','Vorausbezahlt = ARA, noch nicht bezahlt = PRA.'], reveal: ['Mietzins Nov.–Jan.: 2 Monate betreffen das laufende Jahr (Nov., Dez.), 1 Monat das nächste Jahr. Die Abgrenzung: ARA / Mietaufwand für CHF 4 000 (1 Monat vorausbezahlt). Warum ARA? Wir haben zu viel Aufwand verbucht.','Maschinenreparatur in Woche 50: Der Aufwand betrifft das laufende Jahr, aber die Rechnung fehlt. Lösung: PRA buchen (Reparaturaufwand / PRA). Warum? Der Aufwand ist entstanden, aber noch nicht bezahlt.','Warenbestellung ohne Lieferung: Keine Abgrenzung nötig! Warum? Solange die Ware nicht geliefert ist, ist kein Geschäftsvorfall entstanden. Prüfungstipp: Immer fragen – wann ist der Aufwand/Ertrag wirtschaftlich verursacht worden?'], statements: [{s:'Mietzins 12 000.– für Nov. bis Jan. im Voraus bezahlt. → Abgrenzung nötig',c:true},{s:'Maschinenreparatur in Woche 50, Rechnung fehlt noch. → Abgrenzung nötig',c:true},{s:'Warenbestellung vor Jahresende, Lieferung im Jan. → Abgrenzung nötig',c:false,reason:'Keine Abgrenzung nötig – solange die Ware nicht geliefert ist, ist kein Geschäftsvorfall entstanden.'},{s:'Zeitschriftenabos im Voraus, 6 000.– laufen noch ins 04. → Abgrenzung nötig',c:true},{s:'Säumige Mieter zahlen Dezembermieten. → Abgrenzung nötig',c:false,reason:'Keine Abgrenzung nötig – die Zahlung betrifft den laufenden Monat im laufenden Jahr.'},{s:'Darlehen ab 01.08., Zinszahlung Ende Jan. fällig. → Abgrenzung nötig',c:true}] },
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 94, type: 'text', q: 'Einzelfragen zum Thema Kostenrechnung', tips: ['Einzelkosten können einem Kostenträger direkt zugeordnet werden.','Drei Hauptkostenstellen: Material, Fertigung, V+V.','Sachliche Abgrenzung: Differenz FIBU-Aufwand und BEBU-Kosten.'], reveal: ['Einzelkosten sind direkt einem Kostenträger zurechenbar (z.B. Rohmaterial für ein bestimmtes Produkt). Die BEBU baut auf der FIBU auf – sie übernimmt die Aufwandpositionen und rechnet sie in Kosten um.','Die sachliche Abgrenzung ist die Differenz zwischen FIBU-Aufwand und BEBU-Kosten. Beispiele: Kalkulatorischer Unternehmerlohn (nur BEBU), ausserordentlicher Aufwand (nur FIBU). Die Kostenträgerrechnung zeigt die Stückkosten und den Gewinn/Verlust pro Produkt.','Die drei Hauptkostenstellen sind Material, Fertigung und Verwaltung/Vertrieb. Eine Bezugsgrösse ist der Verteilschlüssel für die Umlage der Gemeinkosten (z.B. Arbeitsstunden, Maschinenstunden, Material-Einzelkosten).'], questions: [{label:'A',text:'Merkmal von Einzelkosten?',answers:['Direkt einem Kostenträger zuordenbar'],keywords:['direkt','zugeordnet','Kostenträger']},{label:'B',text:'Worauf baut die BEBU auf?',answers:['Auf der Finanzbuchhaltung (FIBU)'],keywords:['Finanzbuchhaltung','FIBU']},{label:'C',text:'Was ist eine sachliche Abgrenzung?',answers:['Differenz zwischen FIBU-Aufwand und BEBU-Kosten'],keywords:['Differenz','Aufwand','Kosten']},{label:'D',text:'Was besagt die Kostenträgerrechnung?',answers:['Zeigt die Stückkosten und den Gewinn/Verlust pro Produkt'],keywords:['Kosten','Produkt','Stückkosten']},{label:'E',text:'Drei Hauptkostenstellen?',answers:['Material, Fertigung, Verwaltung und Vertrieb'],keywords:['Material','Fertigung','Verwaltung']},{label:'F',text:'Was ist eine Bezugsgrösse?',answers:['Verteilschlüssel für die Umlage der Gemeinkosten'],keywords:['Verteilschlüssel','Umlage','Gemeinkosten']}] },
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        { id: 102, type: 'text', q: 'Umschreibung von Fachbegriffen der Kostenrechnung', tips: ['Variable Kosten ändern sich mit der Beschäftigung.','Fixe Kosten bleiben bei Beschäftigungsänderung gleich.','Break-even = Gewinnschwelle = DB deckt genau die Fixkosten.'], reveal: ['Variable Kosten ändern sich proportional zur Beschäftigung (Produktionsmenge). Beispiele: Rohmaterial, Akkordlöhne, Energiekosten. Fixe Kosten bleiben bei Beschäftigungsänderung gleich. Beispiele: Miete, Versicherungen, Gehälter.','Der Deckungsbeitrag (DB) = Nettoerlös − variable Kosten. Er zeigt, wie viel ein Produkt zur Deckung der Fixkosten beiträgt. Solange der DB positiv ist, lohnt sich die Produktion (auch wenn der Vollkosten-Gewinn negativ wäre!).','Break-even (Gewinnschwelle/Nutzschwelle) = der Punkt, an dem der Gesamt-DB genau die Fixkosten deckt. Formel: Break-even-Menge = Fixkosten / DB pro Stück. Ab dieser Menge wird Gewinn erzielt.'], questions: [{label:'A',text:'Variable Kosten?',answers:['Kosten, die sich proportional zur Beschäftigung verändern'],keywords:['proportional','Beschäftigung','veränderlich']},{label:'B',text:'Fixe Kosten?',answers:['Kosten, die bei Beschäftigungsänderung gleich bleiben'],keywords:['gleich','unverändert','konstant']},{label:'C',text:'Deckungsbeitrag?',answers:['Nettoerlös minus variable Kosten'],keywords:['Erlös','variable','Kosten']},{label:'D',text:'Break-even?',answers:['Gewinnschwelle bzw. Nutzschwelle, wo DB die Fixkosten deckt'],keywords:['Gewinnschwelle','Nutzschwelle','Nullpunkt']}] },
        { id: 103, type: 'text', q: 'Kostenverläufe aufzeichnen', tips: ['Fixe Kosten: waagrechte Linie.','Variable Kosten: steigende Gerade durch Nullpunkt.','Gesamtkosten = fixe + variable Kosten.'], reveal: ['Fixe Kosten verlaufen als waagrechte (horizontale) Linie – unabhängig von der Produktionsmenge. Warum? Miete, Versicherung etc. fallen an, auch wenn nichts produziert wird.','Variable Kosten verlaufen als steigende Gerade durch den Nullpunkt. Bei null Produktion = null variable Kosten. Je mehr produziert wird, desto höher die variablen Kosten. Die Steigung entspricht den variablen Kosten pro Stück.','Gesamtkosten = fixe + variable Kosten. Im Diagramm: Die Gesamtkostenlinie beginnt auf Höhe der Fixkosten und steigt parallel zur variablen Kostenlinie. Der Break-even liegt dort, wo die Erlöslinie die Gesamtkostenlinie schneidet.'], questions: [{label:'A',text:'Beschreiben Sie den Verlauf fixer Kosten.',answers:['Waagrechte (horizontale) Linie, unabhängig von der Produktionsmenge'],keywords:['waagrecht','konstant','horizontal']},{label:'B',text:'Beschreiben Sie den Verlauf variabler Kosten.',answers:['Steigende Gerade durch den Nullpunkt, proportional zur Menge'],keywords:['steigend','proportional','Gerade']}] },
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          questions: [
            {label:'A',text:'Gemeinaufwand des Handelsbetriebs',answers:['Alle Kosten ausser Warenaufwand (Personal, Miete, Versicherungen)'],keywords:['Kosten','Warenaufwand','Gemein','Personal','Miete','indirekt']},
            {label:'B',text:'= Bruttogewinn − Gemeinaufwand + sonstige Erträge',answers:['Reingewinn'],keywords:['Reingewinn','Betriebsgewinn','Nettoergebnis']},
            {label:'C',text:'Einstandswert',answers:['Einkaufspreis minus Rabatt minus Skonto plus Bezugskosten'],keywords:['Einkaufspreis','Bezugskosten','Rabatt','Beschaffung','Lieferant']},
            {label:'D',text:'= Einstand + Bruttogewinn',answers:['Nettoerlös'],keywords:['Nettoerlös','Verkaufspreis','Umsatz']},
            {label:'E',text:'= Nettoerlös − Handelsmarge',answers:['Einstandswert'],keywords:['Einstand','Warenaufwand','Einstandswert']}
          ]
        },
        {
          id: 114, type: 'calc',
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          questions: [
            {label:'A',text:'Was zeigt Punkt S im Diagramm (oberhalb der Nutzschwelle)?',answers:['Gewinnzone – Nettoerlös ist grösser als Gesamtkosten'],keywords:['Gewinn','Nettoerlös','grösser','Kosten','positiv']},
            {label:'B',text:'Was zeigt Punkt T im Diagramm (unterhalb der Nutzschwelle)?',answers:['Verlustzone – Gesamtkosten sind grösser als Nettoerlös'],keywords:['Verlust','Kosten','grösser','Nettoerlös','negativ']},
            {label:'C',text:'Welche 7 Bezeichnungen gehören ins Nutzschwellendiagramm?',answers:['Fixkosten, variable Kosten, Gesamtkosten, Nettoerlös, Nutzschwelle, Gewinn, Verlust'],keywords:['Fixkosten','variable','Gesamtkosten','Nettoerlös','Nutzschwelle','Gewinn','Verlust']}
          ]
        },
        {
          id: 125, type: 'calc',
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          questions: [
            {label:'A',text:'Aktiven wurden unterbewertet.',answers:['Stille Reserven'],keywords:['Stille Reserven','stille','Reserven']},
            {label:'B',text:'Jahresertrag in Prozent einer Anlage.',answers:['Abschreibungssatz'],keywords:['Abschreibungssatz','Abschreibung']},
            {label:'C',text:'Bilanz, die die effektiven Werte zeigt.',answers:['Bereinigte Bilanz'],keywords:['Bereinigte Bilanz','bereinigt']},
            {label:'D',text:'Grösse, die Abschreibungen und Reingewinn darstellt.',answers:['Cashflow'],keywords:['Cashflow','Cash-flow','Cash Flow']}
          ]
        },
        {
          id: 136, type: 'text',
          ...
          questions: [
            {label:'A',text:'Welche 2 wesentliche Nachteile hat ein zu hoher Fremdfinanzierungsgrad?',answers:['Hohe Zinslast und Abhängigkeit von Gläubigern (schlechte Bonität)'],keywords:['Zinslast','Abhängigkeit','Gläubiger','Risiko','Verschuldung','Bonität']},
            {label:'B',text:'Was sagt der Liquiditätsgrad 2 aus und wie hoch sollte er sein?',answers:['Kurzfristige Zahlungsbereitschaft, sollte mindestens 100% betragen'],keywords:['Zahlungsbereitschaft','100%','kurzfristig','Forderungen','flüssige Mittel']},
            {label:'C',text:'Wie kann ein tiefer Liquiditätsgrad 2 kurzfristig verbessert werden? Nennen Sie 2 Massnahmen.',answers:['Forderungen schneller einziehen, kurzfristiges FK in langfristiges umwandeln'],keywords:['Forderungen','einziehen','kurzfristig','Darlehen','langfristig','Verkauf','Aktiven']},
            {label:'D',text:'Welchen Einfluss hat eine Dividendenausschüttung auf die Liquidität?',answers:['Liquidität sinkt, da Mittelabfluss die flüssigen Mittel reduziert'],keywords:['sinkt','reduziert','Abfluss','negativ','Mittelabfluss','tiefere']}
          ]
        },
        {
          id: 137, type: 'tf',
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          questions: [
            {label:'A',text:'Welches Instrument wird bevorzugtermassen für die strategische Entwicklung eingesetzt?',answers:['Businessplan','Businesspläne'],keywords:['Businessplan','Businesspläne','strategisch','Mehrjahresplan']},
            {label:'B',text:'Welches ist in der strategischen Planung der andere Aspekt neben der strategischen Entwicklung? Welche Instrumente werden dabei eingesetzt?',answers:['Strategische Analyse mit SWOT-Analyse und Mehrjahres-Finanzplan'],keywords:['Analyse','Mehrjahresplan','Budget','Kontrolle','Planung','Finanzplan']},
            {label:'C',text:'Welche Gestaltungsaspekte gibt es bei einem Budgetsystem? Nennen Sie mind. 1 Aspekt mit einer stichwortartigen Erläuterung.',answers:['Zeithorizont, Detaillierungsgrad, Erstellungsverfahren (Top-down, Bottom-up, Gegenstrom)'],keywords:['Zeithorizont','Detaillierungsgrad','Top-down','Bottom-up','Gegenstrom','rollierend','Erstellungsverfahren']}
          ]
        },
        {
          id: 153, type: 'calc',
        ...
        },
        {
          ...
          questions: [
            {label:'A', text:'Was bedeutet Top-down-Budgetierung?', answers:['Geschäftsleitung gibt Budgetziele von oben vor'], keywords:['Geschäftsleitung','GL','oben','Vorgaben','Ziele','vorgeben']},
            {label:'B', text:'Was bedeutet Bottom-up-Budgetierung?', answers:['Abteilungen und Mitarbeiter erstellen Budgets von unten'], keywords:['Abteilungen','unten','Mitarbeiter','planen','erstellen']},
            {label:'C', text:'Was ist das Gegenstromverfahren und warum gilt es als optimal?', answers:['Kombination von Top-down und Bottom-up, verbindet Vorgaben mit Erfahrung'], keywords:['Kombination','beide','Top-down','Bottom-up','Vorgaben','Erfahrung','optimal']}
          ],
